...
export class DocumentTypePurchaseComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/document-type-purchase'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInDocumentTypePurchases() {
        this.eventSubscriber = this.eventManager.subscribe('documentTypePurchaseListModification', response => this.loadAll());
    }
    ...
    private paginateDocumentTypePurchases(data: IDocumentTypePurchase[], headers: HttpHeaders) {
        ...
        this.documentTypePurchases = data;
    }
