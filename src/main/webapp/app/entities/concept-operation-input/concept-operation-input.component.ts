...
export class ConceptOperationInputComponent implements OnInit, OnDestroy {
    ...
    transition() {
        this.router.navigate(['/concept-operation-input'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    registerChangeInConceptOperationInputs() {
        this.eventSubscriber = this.eventManager.subscribe('conceptOperationInputListModification', response => this.loadAll());
    }
    ...
    private paginateConceptOperationInputs(data: IConceptOperationInput[], headers: HttpHeaders) {
        ...
        this.conceptOperationInputs = data;
    }
