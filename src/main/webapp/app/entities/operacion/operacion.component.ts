...
export class OperacionComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        if (this.currentSearch) {
            this.operacionService
                ...
                .subscribe(
                    (res: HttpResponse<IOperacion[]>) => this.paginateOperacions(res.body, res.headers),
    ...
    registerChangeInOperacions() {
        this.eventSubscriber = this.eventManager.subscribe('operacionListModification', response => this.reset());
    }
    ...
    private paginateOperacions(data: IOperacion[], headers: HttpHeaders) {
