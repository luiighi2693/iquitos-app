 ...
 */
@Mapper(componentModel = "spring", uses = {ProviderMapper.class, DocumentTypePurchaseMapper.class, PurchaseStatusMapper.class, BoxMapper.class, ProductMapper.class})
