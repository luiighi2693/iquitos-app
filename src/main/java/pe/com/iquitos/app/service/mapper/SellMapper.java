 ...
 */
@Mapper(componentModel = "spring", uses = {ClientMapper.class, EmployeeMapper.class, BoxMapper.class, DocumentTypeSellMapper.class, PaymentTypeMapper.class, ProductsDeliveredStatusMapper.class, ProductMapper.class})
