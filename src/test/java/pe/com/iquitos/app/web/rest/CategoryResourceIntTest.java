...
import pe.com.iquitos.app.repository.CategoryRepository;
import pe.com.iquitos.app.repository.search.CategorySearchRepository;
import pe.com.iquitos.app.service.CategoryService;
import pe.com.iquitos.app.service.dto.CategoryDTO;
import pe.com.iquitos.app.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    private static final Integer DEFAULT_COUNT_PRODUCTS = 1;
    private static final Integer UPDATED_COUNT_PRODUCTS = 2;
     ...
     *
     * @see pe.com.iquitos.app.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category()
            .name(DEFAULT_NAME)
            .countProducts(DEFAULT_COUNT_PRODUCTS);
        return category;
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCountProducts()).isEqualTo(DEFAULT_COUNT_PRODUCTS);
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].countProducts").value(hasItem(DEFAULT_COUNT_PRODUCTS)));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.countProducts").value(DEFAULT_COUNT_PRODUCTS));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory
            .name(UPDATED_NAME)
            .countProducts(UPDATED_COUNT_PRODUCTS);
        ...
        assertThat(testCategory.getCountProducts()).isEqualTo(UPDATED_COUNT_PRODUCTS);
