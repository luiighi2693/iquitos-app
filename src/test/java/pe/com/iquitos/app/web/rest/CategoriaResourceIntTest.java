...
import pe.com.iquitos.app.repository.CategoriaRepository;
import pe.com.iquitos.app.repository.search.CategoriaSearchRepository;
import pe.com.iquitos.app.service.CategoriaService;
import pe.com.iquitos.app.service.dto.CategoriaDTO;
import pe.com.iquitos.app.service.mapper.CategoriaMapper;
...
public class CategoriaResourceIntTest {
    ...
    private static final Integer DEFAULT_NUMERO_PRODUCTOS = 1;
    private static final Integer UPDATED_NUMERO_PRODUCTOS = 2;
     ...
     *
     * @see pe.com.iquitos.app.repository.search.CategoriaSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Categoria createEntity(EntityManager em) {
        Categoria categoria = new Categoria()
            ...
            .numeroProductos(DEFAULT_NUMERO_PRODUCTOS);
        return categoria;
    }
    ...
    public void createCategoria() throws Exception {
        ...
        assertThat(testCategoria.getNumeroProductos()).isEqualTo(DEFAULT_NUMERO_PRODUCTOS);
    ...
    public void getCategoria() throws Exception {
        ...
        restCategoriaMockMvc.perform(get("/api/categorias/{id}", categoria.getId()))
            ...
            .andExpect(jsonPath("$.numeroProductos").value(DEFAULT_NUMERO_PRODUCTOS));
    }
    ...
    public void updateCategoria() throws Exception {
        ...
        updatedCategoria
            ...
            .numeroProductos(UPDATED_NUMERO_PRODUCTOS);
        ...
        assertThat(testCategoria.getNumeroProductos()).isEqualTo(UPDATED_NUMERO_PRODUCTOS);
