...
public class ProductResourceIntTest {
    ...
    private static final Boolean DEFAULT_VISIBLE_TO_SELL = false;
    private static final Boolean UPDATED_VISIBLE_TO_SELL = true;
    ...
    private static final Integer DEFAULT_STOCK_LIMIT_NOTIFICATION = 1;
    private static final Integer UPDATED_STOCK_LIMIT_NOTIFICATION = 2;

    private static final ProductType DEFAULT_PRODUCT_TYPE = ProductType.BIENES;
    private static final ProductType UPDATED_PRODUCT_TYPE = ProductType.SERVICIOS;
     ...
     *
     * @see pe.com.iquitos.app.repository.search.ProductSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Product createEntity(EntityManager em) {
        Product product = new Product()
            ...
            .visibleToSell(DEFAULT_VISIBLE_TO_SELL)
            .image(DEFAULT_IMAGE)
            .imageContentType(DEFAULT_IMAGE_CONTENT_TYPE)
            .stock(DEFAULT_STOCK)
            .stockLimitNotification(DEFAULT_STOCK_LIMIT_NOTIFICATION)
    ...
    public void createProduct() throws Exception {
        ...
        assertThat(testProduct.getDni()).isEqualTo(DEFAULT_DNI);
        assertThat(testProduct.getExpirationDate()).isEqualTo(DEFAULT_EXPIRATION_DATE);
        assertThat(testProduct.isIsFavorite()).isEqualTo(DEFAULT_IS_FAVORITE);
        assertThat(testProduct.isVisibleToSell()).isEqualTo(DEFAULT_VISIBLE_TO_SELL);
        ...
        assertThat(testProduct.getStockLimitNotification()).isEqualTo(DEFAULT_STOCK_LIMIT_NOTIFICATION);
    ...
    public void getAllProducts() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].visibleToSell").value(hasItem(DEFAULT_VISIBLE_TO_SELL.booleanValue())))
            .andExpect(jsonPath("$.[*].imageContentType").value(hasItem(DEFAULT_IMAGE_CONTENT_TYPE)))
            .andExpect(jsonPath("$.[*].image").value(hasItem(Base64Utils.encodeToString(DEFAULT_IMAGE))))
            .andExpect(jsonPath("$.[*].stock").value(hasItem(DEFAULT_STOCK)))
            .andExpect(jsonPath("$.[*].stockLimitNotification").value(hasItem(DEFAULT_STOCK_LIMIT_NOTIFICATION)))
    ...
    public void getProduct() throws Exception {
        ...
        restProductMockMvc.perform(get("/api/products/{id}", product.getId()))
            ...
            .andExpect(jsonPath("$.visibleToSell").value(DEFAULT_VISIBLE_TO_SELL.booleanValue()))
            .andExpect(jsonPath("$.imageContentType").value(DEFAULT_IMAGE_CONTENT_TYPE))
            .andExpect(jsonPath("$.image").value(Base64Utils.encodeToString(DEFAULT_IMAGE)))
            .andExpect(jsonPath("$.stock").value(DEFAULT_STOCK))
            .andExpect(jsonPath("$.stockLimitNotification").value(DEFAULT_STOCK_LIMIT_NOTIFICATION))
    ...
    public void updateProduct() throws Exception {
        ...
        updatedProduct
            ...
            .visibleToSell(UPDATED_VISIBLE_TO_SELL)
            .image(UPDATED_IMAGE)
            .imageContentType(UPDATED_IMAGE_CONTENT_TYPE)
            .stock(UPDATED_STOCK)
            .stockLimitNotification(UPDATED_STOCK_LIMIT_NOTIFICATION)
        ...
        assertThat(testProduct.getDni()).isEqualTo(UPDATED_DNI);
        assertThat(testProduct.getExpirationDate()).isEqualTo(UPDATED_EXPIRATION_DATE);
        assertThat(testProduct.isIsFavorite()).isEqualTo(UPDATED_IS_FAVORITE);
        assertThat(testProduct.isVisibleToSell()).isEqualTo(UPDATED_VISIBLE_TO_SELL);
        ...
        assertThat(testProduct.getStockLimitNotification()).isEqualTo(UPDATED_STOCK_LIMIT_NOTIFICATION);
