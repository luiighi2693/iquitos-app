...
export class CategoryUpdatePage {
    ...
    countProductsInput = element(by.id('field_countProducts'));
    ...
    async setCountProductsInput(countProducts) {
        await this.countProductsInput.sendKeys(countProducts);
    }

    async getCountProductsInput() {
        return this.countProductsInput.getAttribute('value');
    }
