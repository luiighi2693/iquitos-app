...
describe('Category e2e test', () => {
    ...
    it('should create and save Categories', async () => {
        ...
        await categoryComponentsPage.clickOnCreateButton();
        await promise.all([categoryUpdatePage.setNameInput('name'), categoryUpdatePage.setCountProductsInput('5')]);
        expect(await categoryUpdatePage.getNameInput()).to.eq('name');
        expect(await categoryUpdatePage.getCountProductsInput()).to.eq('5');
