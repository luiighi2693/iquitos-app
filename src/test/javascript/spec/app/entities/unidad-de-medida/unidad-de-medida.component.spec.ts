...
import { UnidadDeMedidaComponent } from 'app/entities/unidad-de-medida/unidad-de-medida.component';
...
describe('Component Tests', () => {
    describe('UnidadDeMedida Management Component', () => {
        let comp: UnidadDeMedidaComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UnidadDeMedidaComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.unidadDeMedidas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
