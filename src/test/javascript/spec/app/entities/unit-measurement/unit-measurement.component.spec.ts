...
import { UnitMeasurementComponent } from 'app/entities/unit-measurement/unit-measurement.component';
...
describe('Component Tests', () => {
    describe('UnitMeasurement Management Component', () => {
        let comp: UnitMeasurementComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UnitMeasurementComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.unitMeasurements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
