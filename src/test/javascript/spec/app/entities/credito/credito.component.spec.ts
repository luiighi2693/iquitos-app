...
import { CreditoComponent } from 'app/entities/credito/credito.component';
import { CreditoService } from 'app/entities/credito/credito.service';
import { Credito } from 'app/shared/model/credito.model';

describe('Component Tests', () => {
    describe('Credito Management Component', () => {
        let comp: CreditoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CreditoComponent, '')
                .compileComponents();
