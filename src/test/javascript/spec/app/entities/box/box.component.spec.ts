...
import { BoxComponent } from 'app/entities/box/box.component';
import { BoxService } from 'app/entities/box/box.service';
import { Box } from 'app/shared/model/box.model';

describe('Component Tests', () => {
    describe('Box Management Component', () => {
        let comp: BoxComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.boxes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
