...
import { ContactoProveedorComponent } from 'app/entities/contacto-proveedor/contacto-proveedor.component';
...
describe('Component Tests', () => {
    describe('ContactoProveedor Management Component', () => {
        let comp: ContactoProveedorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ContactoProveedorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new ContactoProveedor(123)],
                        headers
                    })
                )
            );
            ...
            expect(comp.contactoProveedors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
