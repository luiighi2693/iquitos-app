...
import { ProviderPaymentComponent } from 'app/entities/provider-payment/provider-payment.component';
...
describe('Component Tests', () => {
    describe('ProviderPayment Management Component', () => {
        let comp: ProviderPaymentComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProviderPaymentComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.providerPayments[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
