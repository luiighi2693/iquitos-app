...
import { PurchaseStatusComponent } from 'app/entities/purchase-status/purchase-status.component';
...
describe('Component Tests', () => {
    describe('PurchaseStatus Management Component', () => {
        let comp: PurchaseStatusComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(PurchaseStatusComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.purchaseStatuses[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
