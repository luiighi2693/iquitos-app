...
import { CuentaProveedorComponent } from 'app/entities/cuenta-proveedor/cuenta-proveedor.component';
...
describe('Component Tests', () => {
    describe('CuentaProveedor Management Component', () => {
        let comp: CuentaProveedorComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CuentaProveedorComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.cuentaProveedors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
