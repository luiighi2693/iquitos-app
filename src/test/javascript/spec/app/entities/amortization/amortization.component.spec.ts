...
import { AmortizationComponent } from 'app/entities/amortization/amortization.component';
...
describe('Component Tests', () => {
    describe('Amortization Management Component', () => {
        let comp: AmortizationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AmortizationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.amortizations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
