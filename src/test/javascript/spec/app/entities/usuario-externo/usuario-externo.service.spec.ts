...
describe('Service Tests', () => {
    describe('UsuarioExterno Service', () => {
        ...
        let elemDefault: IUsuarioExterno;
        beforeEach(() => {
            ...
            elemDefault = new UsuarioExterno(0, 0, 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a UsuarioExterno', async () => {
                ...
                service
                    .create(new UsuarioExterno(null))
                    .pipe(take(1))
            ...
            it('should update a UsuarioExterno', async () => {
                const returnedFromService = Object.assign(
                    {
                        dni: 1,
                        pin: 1
            ...
            it('should return a list of UsuarioExterno', async () => {
                const returnedFromService = Object.assign(
                    {
                        dni: 1,
                        pin: 1
            ...
            it('should delete a UsuarioExterno', async () => {
