...
import { UsuarioExternoComponent } from 'app/entities/usuario-externo/usuario-externo.component';
...
describe('Component Tests', () => {
    describe('UsuarioExterno Management Component', () => {
        let comp: UsuarioExternoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UsuarioExternoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.usuarioExternos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
