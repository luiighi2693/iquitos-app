...
import { ProviderAccountComponent } from 'app/entities/provider-account/provider-account.component';
...
describe('Component Tests', () => {
    describe('ProviderAccount Management Component', () => {
        let comp: ProviderAccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ProviderAccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.providerAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
