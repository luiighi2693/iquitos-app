...
import { AmortizacionComponent } from 'app/entities/amortizacion/amortizacion.component';
...
describe('Component Tests', () => {
    describe('Amortizacion Management Component', () => {
        let comp: AmortizacionComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(AmortizacionComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.amortizacions[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
