...
import { UserLoginComponent } from 'app/entities/user-login/user-login.component';
...
describe('Component Tests', () => {
    describe('UserLogin Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userLogins[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
