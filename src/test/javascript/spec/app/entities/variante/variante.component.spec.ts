...
import { VarianteComponent } from 'app/entities/variante/variante.component';
...
describe('Component Tests', () => {
    describe('Variante Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.variantes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
