...
import { ParametroSistemaComponent } from 'app/entities/parametro-sistema/parametro-sistema.component';
    ...
    describe('ParametroSistema Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [ParametroSistemaComponent],
                providers: [
                    {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.parametroSistemas[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
