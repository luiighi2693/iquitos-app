...
import { TipoDeDocumentoDeleteDialogComponent } from 'app/entities/tipo-de-documento/tipo-de-documento-delete-dialog.component';
import { TipoDeDocumentoService } from 'app/entities/tipo-de-documento/tipo-de-documento.service';

describe('Component Tests', () => {
    describe('TipoDeDocumento Management Delete Component', () => {
        let comp: TipoDeDocumentoDeleteDialogComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TipoDeDocumentoDeleteDialogComponent, '')
                .compileComponents();
