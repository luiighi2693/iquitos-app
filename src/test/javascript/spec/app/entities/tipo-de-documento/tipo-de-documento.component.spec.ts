...
import { TipoDeDocumentoComponent } from 'app/entities/tipo-de-documento/tipo-de-documento.component';
...
describe('Component Tests', () => {
    describe('TipoDeDocumento Management Component', () => {
        let comp: TipoDeDocumentoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [TipoDeDocumentoComponent],
                providers: [
                    {
                ...
                .overrideTemplate(TipoDeDocumentoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tipoDeDocumentos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
