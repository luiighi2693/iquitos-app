...
import { ITipoDeDocumento, TipoDeDocumento } from 'app/shared/model/tipo-de-documento.model';

describe('Service Tests', () => {
    describe('TipoDeDocumento Service', () => {
        let injector: TestBed;
        let service: TipoDeDocumentoService;
        let httpMock: HttpTestingController;
        let elemDefault: ITipoDeDocumento;
        beforeEach(() => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a TipoDeDocumento', async () => {
                ...
                service
                    .create(new TipoDeDocumento(null))
                    .pipe(take(1))
            ...
            it('should delete a TipoDeDocumento', async () => {
