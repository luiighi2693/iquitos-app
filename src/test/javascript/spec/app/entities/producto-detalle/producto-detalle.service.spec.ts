...
describe('Service Tests', () => {
    describe('ProductoDetalle Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ProductoDetalle(0, 0, 'AAAAAAA', 0);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProductoDetalle', async () => {
                ...
                service
                    .create(new ProductoDetalle(null))
                    .pipe(take(1))
            ...
            it('should update a ProductoDetalle', async () => {
                const returnedFromService = Object.assign(
                    {
                        cantidad: 1,
                        productoLabel: 'BBBBBB',
                        precioVenta: 1
                    },
                    elemDefault
                );
            ...
            it('should return a list of ProductoDetalle', async () => {
                const returnedFromService = Object.assign(
                    {
                        cantidad: 1,
                        productoLabel: 'BBBBBB',
            ...
            it('should delete a ProductoDetalle', async () => {
