...
import { VariantComponent } from 'app/entities/variant/variant.component';
    ...
    describe('Variant Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VariantComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.variants[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
