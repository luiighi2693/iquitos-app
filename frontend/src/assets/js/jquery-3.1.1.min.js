...
!(function(a, b) {
  ...
  var E,
    ...
    G = (r.fn.init = function(a, b, c) {
      ...
      if (((c = c || E), 'string' == typeof a)) {
        if (
          ((e = '<' === a[0] && '>' === a[a.length - 1] && a.length >= 3 ? [null, a, null] : F.exec(a)),
          !e || (!e[1] && b))
        )
  ...
  function Z(a) {
    return (
      'true' === a || ('false' !== a && ('null' === a ? null : a === +a + '' ? +a : X.test(a) ? JSON.parse(a) : a))
    );
  }
  function $(a, b, c) {
    var d;
        ...
        ? (a && a.type
            ? ((this.originalEvent = a),
              ...
              (this.isDefaultPrevented =
                a.defaultPrevented || (void 0 === a.defaultPrevented && a.returnValue === !1) ? ua : va),
  ...
  function Ia(a, b, c, d) {
    ...
    if (
      m &&
      ((e = pa(b, a[0].ownerDocument, !1, a, d)), (f = e.firstChild), 1 === e.childNodes.length && (e = f), f || d)
    ) {
      ...
      return (
        r.fx.off || d.hidden
          ...
          : 'number' != typeof e.duration &&
            (e.duration in r.fx.speeds ? (e.duration = r.fx.speeds[e.duration]) : (e.duration = r.fx.speeds._default)),
      ...
      (l = r.event && o.global),
        ...
        o.hasContent
          ...
          : ((n = o.url.slice(f.length)),
            ...
            o.cache === !1 && ((f = f.replace(Ab, '$1')), (n = (sb.test(f) ? '&' : '?') + '_=' + rb++ + n)),
            (o.url = f + n)),
        o.ifModified &&
