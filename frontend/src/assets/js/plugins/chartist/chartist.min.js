  ...
  return (
    (function(a, b, c) {
      ...
      (c.noop = function(a) {
        ...
        (c.extend = function(a) {
          ...
          return (
            b.forEach(function(b) {
              for (var d in b)
                'object' != typeof b[d] || null === b[d] || b[d] instanceof Array
                  ? (a[d] = b[d])
        ...
        (c.getDataArray = function(a, b) {
          function d(a) {
            return void 0 === a || null === a || ('number' == typeof a && isNaN(a))
              ? void 0
              : (a.data || a) instanceof Array
                ? (a.data || a).map(d)
          ...
          return (
            ((b && !a.reversed) || (!b && a.reversed)) && (c.reverseData(a), (a.reversed = !a.reversed)),
            a.series.map(d)
          );
        }),
        ...
        (c.normalizeDataArray = function(a, b) {
          for (var c = 0; c < a.length; c++)
            if (a[c].length !== b) for (var d = a[c].length; b > d; d++) a[c][d] = void 0;
          return a;
        }),
        ...
        (c.getAvailableHeight = function(a, b) {
          return Math.max(
            (c.stripUnit(b.height) || a.height()) - (b.chartPadding.top + b.chartPadding.bottom) - b.axisX.offset,
            0
          );
        }),
        (c.getHighLow = function(a, b) {
          function c(a) {
            if (a instanceof Array) for (var b = 0; b < a.length; b++) c(a[b]);
            else e && a > d.high && (d.high = a), f && a < d.low && (d.low = a);
          }
          var d = {
            ...
            e = void 0 === b.high,
            f = void 0 === b.low;
          return c(a), d.high <= d.low && (0 === d.low ? (d.high = 1) : d.low < 0 ? (d.high = 0) : (d.low = 0)), d;
        }),
        (c.rho = function(a) {
          function b(a, c) {
        ...
        (c.getBounds = function(a, b, d, e, f) {
          var g,
            h,
            i,
            j = { high: b.high, low: b.low };
          (e || 0 === e) && ((j.high = Math.max(e, j.high)), (j.low = Math.min(e, j.low))),
          ...
          var k = c.projectLength(a, j.step, j),
            l = d > k,
            m = f ? c.rho(j.range) : 0;
          if (f && c.projectLength(a, 1, j) >= d) j.step = 1;
          else if (f && m < j.step && c.projectLength(a, m, j) >= d) j.step = m;
          else
            for (;;)
              if (l && c.projectLength(a, j.step, j) <= d) j.step *= 2;
              else {
                if (l || !(c.projectLength(a, j.step / 2, j) >= d)) break;
                if (((j.step /= 2), f && j.step % 1 !== 0)) {
                  j.step *= 2;
                  break;
                }
              }
          for (h = j.min, i = j.max; h + j.step <= j.low; ) h += j.step;
          for (; i - j.step >= j.high; ) i -= j.step;
          for (j.min = h, j.max = i, j.range = j.max - j.min, j.values = [], g = j.min; g <= j.max; g += j.step)
            j.values.push(c.roundWithPrecision(g));
          return j;
        }),
        ...
        (c.createChartRect = function(a, b, d) {
          ...
          (h = Math.max(h, g + j.left + j.right)), (i = Math.max(i, f + j.top + j.bottom));
          var k = {
            padding: j,
            width: function() {
        ...
        (c.createGrid = function(a, b, d, e, f, g, h, i) {
          var j = {};
          (j[d.units.pos + '1'] = a.pos),
            (j[d.units.pos + '2'] = a.pos),
        ...
        (c.createLabel = function(a, b, d, e, f, g, h, i, j, k) {
          var l,
            m = {};
          if (
            ((m[e.units.pos] = a.pos + g[e.units.pos]),
            (m[e.counterUnits.pos] = g[e.counterUnits.pos]),
            (m[e.units.len] = a.len),
            (m[e.counterUnits.len] = f - 10),
            j)
          ) {
            var n =
              '<span class="' +
              ...
              e.units.len +
              ': ' +
              Math.round(m[e.units.len]) +
              'px; ' +
              e.counterUnits.len +
              ': ' +
              Math.round(m[e.counterUnits.len]) +
              'px">' +
              d[b] +
              '</span>';
            l = h.foreignObject(n, c.extend({ style: 'overflow: visible;' }, m));
          } else l = h.elem('text', m, i.join(' ')).text(d[b]);
          k.emit('draw', c.extend({ type: 'label', axis: e, index: b, group: h, element: l, text: d[b] }, m));
        }),
        (c.createAxis = function(a, b, d, e, f, g, h, i) {
          var j = h['axis' + a.units.pos.toUpperCase()],
            k = b.map(a.projectValue.bind(a)),
            l = b.map(j.labelInterpolationFnc);
          k.forEach(function(b, k) {
            var m = { x: 0, y: 0 };
            (l[k] || 0 === l[k]) &&
              ('x' === a.units.pos
                ? ((b.pos = d.x1 + b.pos),
                  (m.x = h.axisX.labelOffset.x),
                  'start' === h.axisX.position
                    ? (m.y = d.padding.top + h.axisX.labelOffset.y + (g ? 5 : 20))
                    : (m.y = d.y1 + h.axisX.labelOffset.y + (g ? 5 : 20)))
                : ((b.pos = d.y1 - b.pos),
                  (m.y = h.axisY.labelOffset.y - (g ? b.len : 0)),
                  'start' === h.axisY.position
                    ? (m.x = g ? d.padding.left + h.axisY.labelOffset.x : d.x1 - 10)
                    : (m.x = d.x2 + h.axisY.labelOffset.x + 10)),
              j.showGrid &&
                c.createGrid(
                  b,
                  k,
                  a,
                  a.gridOffset,
                  d[a.counterUnits.len](),
                  e,
                  [h.classNames.grid, h.classNames[a.units.dir]],
                  i
                ),
              j.showLabel &&
                c.createLabel(
                  ...
                  m,
                  f,
                  [h.classNames.label, h.classNames[a.units.dir], h.classNames[j.position]],
                  g,
                  i
                ));
          });
          ...
          return function(a, b) {
            for (var e = new c.Svg.Path(), f = !0, g = 2; g < a.length; g += 2) {
              ...
              void 0 === m.value
                ? (f = !0)
                : (f && e.move(h, i, !1, m),
                  void 0 !== n.value && (e.curve(h + l, i, j - l, k, j, k, !1, n), (f = !1)));
            }
            return e;
          };
        }),
        (c.Interpolation.cardinal = function(a) {
          function b(a, b) {
            for (var c = [], d = !0, e = 0; e < a.length; e += 2)
              void 0 === b[e / 2].value
                ? (d = !0)
                : (d && (c.push({ pathCoordinates: [], valueData: [] }), (d = !1)),
            ...
            function(b, d) {
              for (var e = new c.Svg.Path(), f = !0, g = 2; g < b.length; g += 2) {
                ...
                void 0 === l.value
                  ...
                  : (f && e.move(h, i, !1, l),
                    void 0 !== m.value &&
                      (a.postpone ? e.line(j, i, !1, l) : e.line(h, k, !1, m), e.line(j, k, !1, m), (f = !1)));
              }
              return e;
            }
          );
    ...
    (function(a, b, c) {
      ...
      function d(a, d, e, f, g) {
        a instanceof Element
          ...
          : ((this._node = b.createElementNS(z, a)),
            'svg' === a && this._node.setAttributeNS(A, c.xmlNs.qualifiedName, c.xmlNs.uri),
            d && this.attr(d),
            e && this.addClass(e),
            f &&
        ...
        return 'string' == typeof a
          ...
          : (Object.keys(a).forEach(
              function(d) {
                void 0 !== a[d] &&
                  (b
                    ? this._node.setAttributeNS(b, [c.xmlNs.prefix, ':', d].join(''), a[d])
      ...
      (c.xmlNs = { qualifiedName: 'xmlns:ct', prefix: 'ct', uri: 'http://gionkunz.github.com/chartist-js/ct' }),
    ...
    (function(a, b, c) {
      'use strict';
      function d(a, b, d) {
        c.LinearScaleAxis['super'].constructor.call(this, a, b, d),
          (this.bounds = c.getBounds(this.axisLength, d.highLow, d.scaleMinSpace, d.referenceValue, d.onlyInteger));
      }
      function e(a) {
        return {
          pos: (this.axisLength * (a - this.bounds.min)) / this.bounds.range,
          len: c.projectLength(this.axisLength, this.bounds.step, this.bounds)
        };
      }
      c.LinearScaleAxis = c.Axis.extend({ constructor: d, projectValue: e });
    })(window, document, a),
    (function(a, b, c) {
      'use strict';
      function d(a, b, d) {
        c.StepAxis['super'].constructor.call(this, a, b, d),
          (this.stepLength = this.axisLength / (d.stepCount - (d.stretch ? 1 : 0)));
      }
      function e(a, b) {
        return { pos: this.stepLength * b, len: this.stepLength };
      }
    ...
    (function(a, b, c) {
      ...
      function d(a) {
        var b = [],
          d = c.normalizeDataArray(c.getDataArray(this.data, a.reverseData), this.data.labels.length);
        this.svg = c.createSvg(this.container, a.width, a.height, a.classNames.chart);
        var e = c.createChartRect(this.svg, a, f.padding),
          g = c.getHighLow(d, a),
          h = new c.StepAxis(c.Axis.units.x, e, { stepCount: this.data.labels.length, stretch: a.fullWidth }),
          i = new c.LinearScaleAxis(c.Axis.units.y, e, {
            highLow: g,
            scaleMinSpace: a.axisY.scaleMinSpace,
            onlyInteger: a.axisY.onlyInteger
          }),
          j = this.svg.elem('g').addClass(a.classNames.labelGroup),
          k = this.svg.elem('g').addClass(a.classNames.gridGroup);
        c.createAxis(h, this.data.labels, e, k, j, this.supportsForeignObject, a, this.eventEmitter),
          c.createAxis(i, i.bounds.values, e, k, j, this.supportsForeignObject, a, this.eventEmitter),
          this.data.series.forEach(
            function(f, g) {
              (b[g] = this.svg.elem('g')),
                b[g].attr({ 'series-name': f.name, meta: c.serialize(f.meta) }, c.xmlNs.uri),
                b[g].addClass(
                  [a.classNames.series, f.className || a.classNames.series + '-' + c.alphaNumerate(g)].join(' ')
                );
              var j = [],
                k = [];
              d[g].forEach(
                function(a, b) {
                  var l = { x: e.x1 + h.projectValue(a, b, d[g]).pos, y: e.y1 - i.projectValue(a, b, d[g]).pos };
                  j.push(l.x, l.y), k.push({ value: a, valueIndex: b, meta: c.getMetaData(f, b) });
                }.bind(this)
              );
              var l = {
              ...
              if (
                (l.showPoint &&
                  n.pathElements.forEach(
                    function(d) {
                      var e = b[g]
                        .elem('line', { x1: d.x, y1: d.y, x2: d.x + 0.01, y2: d.y }, a.classNames.point)
                        .attr({ value: d.data.value, meta: d.data.meta }, c.xmlNs.uri);
                      this.eventEmitter.emit('draw', {
                        type: 'point',
                        value: d.data.value,
                        index: d.data.valueIndex,
                        meta: d.data.meta,
                        series: f,
                        seriesIndex: g,
                        group: b[g],
                ...
                var o = b[g]
                  .elem('path', { d: n.stringify() }, a.classNames.line, !0)
                  .attr({ values: d[g] }, c.xmlNs.uri);
                this.eventEmitter.emit('draw', {
                  type: 'line',
                  values: d[g],
                  path: n.clone(),
              ...
              if (l.showArea) {
                var p = Math.max(Math.min(a.areaBase, i.bounds.max), i.bounds.min),
                  q = e.y1 - i.projectValue(p).pos;
                n.splitByCommand('M')
                  .filter(function(a) {
                  ...
                  .forEach(
                    function(h) {
                      var i = b[g]
                        .elem('path', { d: h.stringify() }, a.classNames.area, !0)
                        .attr({ values: d[g] }, c.xmlNs.uri);
                      this.eventEmitter.emit('draw', {
                        type: 'area',
                        values: d[g],
    ...
    (function(a, b, c) {
      ...
      function d(a) {
        var b,
          d = [],
          e = c.getDataArray(this.data, a.reverseData),
          g = a.distributeSeries
            ? e.map(function(a) {
                return [a];
              })
            : c.normalizeDataArray(e, this.data.labels.length);
        if (
        ...
        var i,
          ...
          l,
          m,
          n = c.createChartRect(this.svg, a, f.padding);
        (j =
          ...
          a.horizontalBars
            ? ((k = m = new c.StepAxis(c.Axis.units.y, n, { stepCount: j })),
              (i = l = new c.LinearScaleAxis(c.Axis.units.x, n, {
                highLow: b,
                scaleMinSpace: a.axisX.scaleMinSpace,
                onlyInteger: a.axisX.onlyInteger,
                referenceValue: 0
              })))
            : ((k = l = new c.StepAxis(c.Axis.units.x, n, { stepCount: j })),
              (i = m = new c.LinearScaleAxis(c.Axis.units.y, n, {
                highLow: b,
                scaleMinSpace: a.axisY.scaleMinSpace,
                onlyInteger: a.axisY.onlyInteger,
                referenceValue: 0
              })));
        var o = this.svg.elem('g').addClass(a.classNames.labelGroup),
          p = this.svg.elem('g').addClass(a.classNames.gridGroup),
          q = a.horizontalBars ? n.x1 + i.projectValue(0).pos : n.y1 - i.projectValue(0).pos,
          r = [];
        c.createAxis(k, this.data.labels, n, p, o, this.supportsForeignObject, a, this.eventEmitter),
          c.createAxis(i, i.bounds.values, n, p, o, this.supportsForeignObject, a, this.eventEmitter),
          this.data.series.forEach(
            function(b, e) {
              var f,
                h = e - (this.data.series.length - 1) / 2;
              (f =
                a.distributeSeries && !a.stackBars
                  ? k.axisLength / g.length / 2
                  : a.distributeSeries && a.stackBars
                    ? k.axisLength / 2
                    : k.axisLength / g[e].length / 2),
                (d[e] = this.svg.elem('g')),
                d[e].attr({ 'series-name': b.name, meta: c.serialize(b.meta) }, c.xmlNs.uri),
                d[e].addClass(
                  [a.classNames.series, b.className || a.classNames.series + '-' + c.alphaNumerate(e)].join(' ')
                ),
                g[e].forEach(
                  function(j, l) {
                    var m, o, p, s;
                    if (
                      ((s = a.distributeSeries && !a.stackBars ? e : a.distributeSeries && a.stackBars ? 0 : l),
                      (m = a.horizontalBars
                        ? {
                            x: n.x1 + i.projectValue(j || 0, l, g[e]).pos,
                            y: n.y1 - k.projectValue(j || 0, s, g[e]).pos
                          }
                        : {
                            x: n.x1 + k.projectValue(j || 0, s, g[e]).pos,
                            y: n.y1 - i.projectValue(j || 0, l, g[e]).pos
                          }),
                      (m[k.units.pos] += f * (a.horizontalBars ? -1 : 1)),
                      (m[k.units.pos] +=
                        a.stackBars || a.distributeSeries ? 0 : h * a.seriesBarDistance * (a.horizontalBars ? -1 : 1)),
                      (p = r[l] || q),
                      (r[l] = p - (q - m[k.counterUnits.pos])),
                      void 0 !== j)
                    ) {
                      var t = {};
                      (t[k.units.pos + '1'] = m[k.units.pos]),
                        (t[k.units.pos + '2'] = m[k.units.pos]),
                        (t[k.counterUnits.pos + '1'] = a.stackBars ? p : q),
                        (t[k.counterUnits.pos + '2'] = a.stackBars ? r[l] : m[k.counterUnits.pos]),
                        (o = d[e]
                          .elem('line', t, a.classNames.bar)
                          .attr({ value: j, meta: c.getMetaData(b, l) }, c.xmlNs.uri)),
    ...
    (function(a, b, c) {
      ...
      function e(a) {
        var b,
          ...
          i = [],
          j = a.startAngle,
          k = c.getDataArray(this.data, a.reverseData);
        (this.svg = c.createSvg(
          this.container,
          a.width,
          a.height,
          ...
          (b = c.createChartRect(this.svg, a, g.padding)),
          ...
          (f = 'outside' === a.labelPosition || a.donut ? e : 'center' === a.labelPosition ? 0 : e / 2),
          (f += a.labelOffset);
        for (
          var l = { x: b.x1 + b.width() / 2, y: b.y2 + b.height() / 2 },
            m =
              1 ===
            ...
            n = 0;
          n < this.data.series.length;
          n++
        ) {
          var o = this.data.series[n];
          (i[n] = this.svg.elem('g', null, null, !0)),
            i[n].attr({ 'series-name': o.name }, c.xmlNs.uri),
            i[n].addClass(
              [a.classNames.series, o.className || a.classNames.series + '-' + c.alphaNumerate(n)].join(' ')
            );
          var p = j + (k[n] / h) * 360;
          p - j === 360 && (p -= 0.01);
          var q = c.polarToCartesian(l.x, l.y, e, j - (0 === n || m ? 0 : 0.2)),
            r = c.polarToCartesian(l.x, l.y, e, p),
            s = new c.Svg.Path(!a.donut).move(r.x, r.y).arc(e, e, 0, p - j > 180, 0, q.x, q.y);
          a.donut || s.line(l.x, l.y);
          var t = i[n].elem('path', { d: s.stringify() }, a.donut ? a.classNames.sliceDonut : a.classNames.slicePie);
          if (
            (t.attr({ value: k[n], meta: c.serialize(o.meta) }, c.xmlNs.uri),
            a.donut &&
              t.attr({
            ...
            var u = c.polarToCartesian(l.x, l.y, f, j + (p - j) / 2),
              v = a.labelInterpolationFnc(this.data.labels ? this.data.labels[n] : k[n], n);
            if (v || 0 === v) {
              var w = i[n]
                .elem('text', { dx: u.x, dy: u.y, 'text-anchor': d(l, u, a.labelDirection) }, a.classNames.label)
                .text('' + v);
              this.eventEmitter.emit('draw', {
                type: 'label',
                index: n,
        ...
        this.eventEmitter.emit('created', { chartRect: b, svg: this.svg, options: a });
      }
      function f(a, b, d, e) {
