...
!(function(t, e) {
  ...
  function o(e, n, r, o, d) {
    ...
    var h = s(c),
      ...
      y = g.length - 1;
    for (
      o.fallbackToLetter && 0 == b && 0 == y && ((p = ''), (g = h.split(p)), (y = g.length - 1));
      y >= b && (0 != b || 0 != y);
        ...
        a(r, o)
          ? ((y = w),
            o.fallbackToLetter &&
              0 == b &&
              0 == y &&
              ((p = ''), (g = g[0].split(p)), (v = -1), (w = -1), (b = 0), (y = g.length - 1)))
          : ((v = w), (b = w));
    }
    if (-1 == v || (1 == g.length && 0 == g[0].length)) {
      ...
      x.contents().length > T ? (c = u(x.contents().eq(-1 - T), n)) : ((c = u(x, n, !0)), T || x.detach()),
        c &&
          ((h = i(s(c), o)),
          l(c, h),
          T &&
            ...
            o
              .bind('update.dot', function(e, d) {
                ...
                var c = !1,
                  u = !1;
                return (
                  s.afterElement && ((c = s.afterElement.clone(!0)), c.show(), s.afterElement.detach()),
