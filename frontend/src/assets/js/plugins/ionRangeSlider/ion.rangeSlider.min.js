...
(function(c, ea, $, M) {
  var aa = 0,
    ...
    X = 'ontouchstart' in $ || 0 < M.msMaxTouchPoints,
    N = function(c) {
        ...
        return this.each(function() {
          ...
          if (!e.data('isActive')) {
                ...
                (g && 1 < g.length
                  ? ('number' !== typeof a.min
                    ...
                    'number' !== typeof a.max
                      ...
                      : 'number' !== typeof a.to && (a.to = parseFloat(g[1])))
                  : g &&
                    1 === g.length &&
                    ('number' !== typeof a.min
                      ? (a.min = parseFloat(g[0]))
            ...
            var p = e.prev(),
              ...
              Y = 0,
              u = 0;
            parseInt(a.step, 10) !== parseFloat(a.step) &&
              ((u = a.step.toString().split('.')[1]), (u = Math.pow(10, u.length)));
            ...
            var ba = function() {
                ...
                a.hideMinMax ||
                  ...
                  a.values
                    ? (C.html(a.prefix + a.values[0] + a.postfix),
                      D.html(a.prefix + a.values[a.values.length - 1] + a.maxPostfix + a.postfix))
                    : (C.html(a.prefix + z(a.min) + a.postfix), D.html(a.prefix + z(a.max) + a.maxPostfix + a.postfix)),
                  (O = C.outerWidth()),
                  (P = D.outerWidth()));
                ga();
              },
              ga = function() {
                if ('single' === a.type) {
                  if (
                    (q.append('<span class="irs-slider single"></span>'),
                    (x = q.find('.single')),
                ...
                p.on('mouseup', function(b) {
                  if (s === n.pluginCount && !v && !a.disable) {
                    ...
                    R = q.width() - G;
                    'single' === a.type
                      ? ((r = x), r.attr('id', 'irs-active-slider'), W(b))
                      : 'double' === a.type && ((r = b <= d ? m : t), r.attr('id', 'irs-active-slider'), W(b), L());
                    r.removeAttr('id');
                    r = null;
                  }
                });
                ...
                a.hasGrid && ia();
                a.disable
                  ? (p.addClass('irs-disabled'), p.append('<span class="irs-disable-mask"></span>'))
              ...
              K = function(b, d, h) {
                ...
                'single' === a.type
                  ...
                  : 'double' === a.type &&
                    ('from' === h
                      ? ((Q = 0), (R = parseInt(t.css('left'), 10)))
                      : ((Q = parseInt(m.css('left'), 10)), (R = q.width() - G)));
              },
              L = function() {
                var a = m.width(),
                  d = c.data(m[0], 'x') || parseInt(m[0].style.left, 10) || m.position().left,
                  h = (c.data(t[0], 'x') || parseInt(t[0].style.left, 10) || t.position().left) - d;
              ...
              W = function(b) {
                ...
                'single' === a.type
                  ? (0 > d && (d = 0), d > V && (d = V))
                  : 'double' === a.type && (d < Q && (d = Q), d > R && (d = R), L());
                c.data(r[0], 'x', d);
                Z();
                b = Math.round(d);
                r[0].style.left = b + 'px';
              ...
              Z = function() {
                var b = {
                  ...
                  h;
                'single' === a.type
                  ? ((b.fromX = c.data(x[0], 'x') || parseInt(x[0].style.left, 10) || x.position().left),
                    (b.fromPers = (b.fromX / F) * 100),
                    (h = (d / 100) * b.fromPers + a.min),
                    (b.fromNumber = Math.round(h / a.step) * a.step),
                    b.fromNumber < a.min && (b.fromNumber = a.min),
                    b.fromNumber > a.max && (b.fromNumber = a.max),
                    u && (b.fromNumber = parseInt(b.fromNumber * u, 10) / u),
                    I && (b.fromValue = a.values[b.fromNumber]))
                  : 'double' === a.type &&
                    ((b.fromX = c.data(m[0], 'x') || parseInt(m[0].style.left, 10) || m.position().left),
                    (b.fromPers = (b.fromX / F) * 100),
                    (h = (d / 100) * b.fromPers + a.min),
                    (b.fromNumber = Math.round(h / a.step) * a.step),
                    b.fromNumber < a.min && (b.fromNumber = a.min),
                    (b.toX = c.data(t[0], 'x') || parseInt(t[0].style.left, 10) || t.position().left),
                    (b.toPers = (b.toX / F) * 100),
                    (d = (d / 100) * b.toPers + a.min),
                    (b.toNumber = Math.round(d / a.step) * a.step),
                    b.toNumber > a.max && (b.toNumber = a.max),
                    u &&
                      ((b.fromNumber = parseInt(b.fromNumber * u, 10) / u),
                      (b.toNumber = parseInt(b.toNumber * u, 10) / u)),
                    I && ((b.fromValue = a.values[b.fromNumber]), (b.toValue = a.values[b.toNumber])));
                f = b;
                da();
              },
              ha = function() {
                var b = {
                  ...
                  d = a.max - a.min;
                'single' === a.type
                  ? ((b.fromPers = 0 !== d ? ((b.fromNumber - a.min) / d) * 100 : 0),
                    (b.fromX_pure = (F / 100) * b.fromPers),
                    (b.fromX = Math.round(b.fromX_pure)),
                    (x[0].style.left = b.fromX + 'px'),
                    c.data(x[0], 'x', b.fromX_pure))
                  : 'double' === a.type &&
                    ((b.fromPers = 0 !== d ? ((b.fromNumber - a.min) / d) * 100 : 0),
                    (b.fromX_pure = (F / 100) * b.fromPers),
                    (b.fromX = Math.round(b.fromX_pure)),
                    (m[0].style.left = b.fromX + 'px'),
                    c.data(m[0], 'x', b.fromX_pure),
                    (b.toPers = 0 !== d ? ((b.toNumber - a.min) / d) * 100 : 1),
                    (b.toX_pure = (F / 100) * b.toPers),
                    (b.toX = Math.round(b.toX_pure)),
                    (t[0].style.left = b.toX + 'px'),
                    c.data(t[0], 'x', b.toX_pure),
                    L());
                f = b;
                da();
              },
              da = function() {
                ...
                h = '';
                'single' === a.type
                  ? ((h = f.fromNumber === a.max ? a.maxPostfix : ''),
                    (A[0].style.display = 'none'),
                    (B[0].style.display = 'none'),
                    (h = I
                      ? a.prefix + a.values[f.fromNumber] + h + a.postfix
                      : a.prefix + z(f.fromNumber) + h + a.postfix),
                    w.html(h),
                    (g = w.outerWidth()),
                    (k = f.fromX - g / 2 + k),
                    0 > k && (k = 0),
                    ...
                    a.hideMinMax ||
                      a.hideFromTo ||
                      ((C[0].style.display = k < O ? 'none' : 'block'),
                      (D[0].style.display = k + g > l - P ? 'none' : 'block')),
                    e.attr('value', parseFloat(f.fromNumber)))
                  : 'double' === a.type &&
                    ((h = f.toNumber === a.max ? a.maxPostfix : ''),
                    I
                      ? ((b = a.prefix + a.values[f.fromNumber] + a.postfix),
                        (d = a.prefix + a.values[f.toNumber] + h + a.postfix),
                        (h =
                          f.fromNumber !== f.toNumber
                            ? a.prefix +
                              ...
                              a.postfix
                            : a.prefix + a.values[f.fromNumber] + h + a.postfix))
                      : ((b = a.prefix + z(f.fromNumber) + a.postfix),
                        (d = a.prefix + z(f.toNumber) + h + a.postfix),
                        (h =
                          f.fromNumber !== f.toNumber
                            ? a.prefix + z(f.fromNumber) + ' \u2014 ' + a.prefix + z(f.toNumber) + h + a.postfix
                            : a.prefix + z(f.fromNumber) + h + a.postfix)),
                    A.html(b),
                    B.html(d),
                    w.html(h),
                    ...
                    (B[0].style.left = c + 'px'),
                    (g = w.outerWidth()),
                    (k = f.fromX + (f.toX - f.fromX) / 2 - g / 2 + k),
                    0 > k && (k = 0),
                    k > l - g && (k = l - g),
                    (w[0].style.left = k + 'px'),
                    d + b < c
                      ? ((w[0].style.display = 'none'), (A[0].style.display = 'block'), (B[0].style.display = 'block'))
                      : ((w[0].style.display = 'block'), (A[0].style.display = 'none'), (B[0].style.display = 'none')),
                    a.hideMinMax ||
                      a.hideFromTo ||
                      ((C[0].style.display = k < O || d < O ? 'none' : 'block'),
                      (D[0].style.display = k + g > l - P || c + h > l - P ? 'none' : 'block')),
                    e.attr('value', parseFloat(f.fromNumber) + ';' + parseFloat(f.toNumber)));
                ja();
              },
              ja = function() {
              ...
              ia = function() {
                ...
                for (b = 0; 4 >= b; b += 1)
                  (c = Math.floor((l / 4) * b)),
                    ...
                    u
                      ? ((d = a.min + ((a.max - a.min) / 4) * b),
                        (d = (d / a.step) * a.step),
                        (d = parseInt(d * u, 10) / u))
                      : ((d = Math.round(a.min + ((a.max - a.min) / 4) * b)),
                        (d = Math.round(d / a.step) * a.step),
                        (d = z(d))),
                    I &&
                      (a.hideMinMax
                        ? ((d = Math.round(a.min + ((a.max - a.min) / 4) * b)),
                          (d = Math.round(d / a.step) * a.step),
                          (d = 0 === b || 4 === b ? a.values[d] : ''))
                        : (d = '')),
                    0 === b
                      ? (e +=
                          '<span class="irs-grid-text" style="left: ' + c + 'px; text-align: left;">' + d + '</span>')
                      : 4 === b
                        ? ((c -= 100),
                          (e +=
                            ...
                            d +
                            '</span>'))
                        : ((c -= 50), (e += '<span class="irs-grid-text" style="left: ' + c + 'px;">' + d + '</span>'));
                M.html(e);
              };
            ba();
          }
  ...
  c.fn.ionRangeSlider = function(s) {
    ...
    if ('object' !== typeof s && s) c.error('Method ' + s + ' does not exist for jQuery.ionRangeSlider');
