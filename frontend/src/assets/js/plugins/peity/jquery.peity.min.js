...
(function(e, q, h) {
  ...
  j.register('pie', { delimiter: null, diameter: 16, fill: ['#ff9900', '#fff4dd', '#ffc66e'] }, function(a) {
    ...
    for (
      var a = this.prepare(a.width || a.diameter, a.height || a.diameter),
        d = a.width(),
        g = a.height(),
        a = d / 2,
        g = g / 2,
      ...
      var n = b[d],
        ...
        k;
      if (0 != l) {
        if (1 == l) k = o('circle', { cx: a, cy: g, r: p });
        else {
          k = 2 * l * e;
          var l = i + k,
            m = p * h.cos(i) + a,
  ...
  j.register(
    ...
    function(a) {
      ...
      for (
        var c = h.max.apply(h, b.concat([a.max])),
  ...
  j.register('bar', { delimiter: ',', fill: ['#4D89F9'], gap: 1, height: 16, max: null, min: 0, width: 32 }, function(
    a
  ) {
    for (
      var b = this.values(),
