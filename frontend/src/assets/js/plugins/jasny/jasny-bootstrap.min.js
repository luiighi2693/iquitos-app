    ...
    var b = function(c, d) {
      (this.$element = a(c)),
        ...
        this.options.disablescrolling &&
          ((this.options.disableScrolling = this.options.disablescrolling), delete this.options.disablescrolling);
    };
    (b.DEFAULTS = { toggle: !0, placement: 'auto', autohide: !0, recalc: !0, disableScrolling: !0 }),
      ...
      (b.prototype.disableScrolling = function() {
        ...
        if (
          (void 0 === a('body').data('offcanvas-style') && a('body').data('offcanvas-style', a('body').attr('style')),
        ...
        if (!this.state) {
          ...
          if ((this.$element.trigger(b), !b.isDefaultPrevented())) {
            ...
            -1 !== c.index(this.$element) &&
              (a(this.$element).data('offcanvas-style', a(this.$element).attr('style') || ''),
              this.$element.css(d, -1 * f),
              this.$element.css(d)),
              c.addClass('canvas-sliding').each(function() {
                void 0 === a(this).data('offcanvas-style') &&
                  a(this).data('offcanvas-style', a(this).attr('style') || ''),
    ...
    (e.DEFAULTS = {
              ...
              '?' == d
                ...
                : b[d]
                  ? (this.tests.push(new RegExp(b[d])),
                    null === this.firstNonMaskPos && (this.firstNonMaskPos = this.tests.length - 1))
      ...
      (e.prototype.keydownEvent = function(a) {
        ...
        if (8 == c || 46 == c || (b && 127 == c)) {
          ...
          return (
            f - e === 0 &&
              ((e = 46 != c ? this.seekPrev(e) : (f = this.seekNext(e - 1))), (f = 46 == c ? this.seekNext(f) : f)),
      ...
      (e.prototype.checkVal = function(a) {
        ...
        return (
          !a && d + 1 < this.partialPosition
            ...
            : (a || d + 1 >= this.partialPosition) &&
              (this.writeBuffer(), a || this.$element.val(this.$element.val().substring(0, d + 1))),
