  ...
  b.extend(b.jgrid, {
    ...
    parseDate: function(e, f, c, d) {
      var a = /^\/Date\((([-+])?[0-9]+)(([-+])([0-9]{2})([0-9]{2}))?\)\/$/,
        ...
        g = { m: 1, d: 1, y: 1970, h: 0, i: 0, s: 0, u: 0 },
        h = 0,
        k,
        n,
        h = function(a, b) {
        ...
        if (isNaN(f - 0) || 'u' !== String(e).toLowerCase())
          if (f.constructor === Date) h = f;
            ...
            for (n = e.length; k < n; k++)
              'M' === e[k] &&
                ((l = b.inArray(f[k], d.monthNames)), -1 !== l && 12 > l && ((f[k] = l + 1), (g.m = f[k]))),
                'F' === e[k] &&
                  ((l = b.inArray(f[k], d.monthNames, 12)), -1 !== l && 11 < l && ((f[k] = l + 1 - 12), (g.m = f[k]))),
                'a' === e[k] &&
                  ((l = b.inArray(f[k], d.AmPm)),
                  -1 !== l && 2 > l && f[k] === d.AmPm[l] && ((f[k] = l), (g.h = h(f[k], g.h)))),
                'A' === e[k] &&
                  ((l = b.inArray(f[k], d.AmPm)),
                  -1 !== l && 1 < l && f[k] === d.AmPm[l] && ((f[k] = l - 2), (g.h = h(f[k], g.h)))),
      ...
      var r = h.getDay(),
        ...
        G = {
          ...
          W:
            5 > q
              ? Math.floor((x + q - 1) / 7) + 1
              : Math.floor((x + q - 1) / 7) || (4 > (new Date(p - 1, 0, 1).getDay() + 6) % 7 ? 53 : 52),
    ...
    getAccessor: function(b, f) {
      ...
      if (void 0 === c)
        try {
          if (('string' === typeof f && (a = f.split('.')), (l = a.length)))
    ...
    from: function(e) {
      return new function(e, c) {
        ...
        this._getOrder = function(a, e, g, c, f, h) {
          ...
          void 0 === c && (c = 'text');
          x =
            'float' === c || 'number' === c || 'currency' === c || 'numeric' === c
              ? function(a) {
        ...
        this.startsWith = function(a, c) {
          ...
          G
            ? d._append(
                d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") +
                  '.substr(0,' +
                  e +
                  ') == ' +
                  d._getStr('"' + d._toStr(c) + '"')
              )
            : (null != c && (e = g ? b.trim(c.toString()).length : c.toString().length),
              d._append(d._getStr('this') + '.substr(0,' + e + ') == ' + d._getStr('"' + d._toStr(a) + '"')));
        ...
        this.contains = function(a, b) {
          G
            ? d._append(
                d._getStr("jQuery.jgrid.getAccessor(this,'" + a + "')") + '.indexOf("' + d._toStr(b) + '",0) > -1'
              )
            : d._append(d._getStr('this') + '.indexOf("' + d._toStr(a) + '",0) > -1');
          ...
          c = {
            ...
            dragMove: function(a) {
              if (this.resizing) {
                ...
                var c = 'ltr' === d.direction ? a.width + b : a.width - b,
                  e;
                33 < c &&
                  (this.curGbox.css({ left: this.resizing.sOL + b }),
                  !0 === d.forceFit
                    ? ((e = this.headers[this.resizing.idx + d.nv]),
                      (b = 'ltr' === d.direction ? e.width - b : e.width + b),
                      33 < b && ((a.newWidth = c), (e.newWidth = b)))
            ...
            dragEnd: function() {
              ...
              if (this.resizing) {
                ...
                !0 === d.forceFit
                  ? ((e = this.headers[c + d.nv].newWidth || this.headers[c + d.nv].width),
                    (this.headers[c + d.nv].width = e),
                    (this.headers[c + d.nv].el.style.width = e + 'px'),
                    (this.cols[c + d.nv].style.width = e + 'px'),
                    0 < this.footers.length && (this.footers[c + d.nv].style.width = e + 'px'),
                    (d.colModel[c + d.nv].width = e))
                  : ((d.tblwidth = this.newWidth || d.tblwidth),
                    b('table:first', this.bDiv).css('width', d.tblwidth + 'px'),
                    b('table:first', this.hDiv).css('width', d.tblwidth + 'px'),
                    (this.hDiv.scrollLeft = this.bDiv.scrollLeft),
                    d.footerrow &&
                      (b('table:first', this.sDiv).css('width', d.tblwidth + 'px'),
            ...
            populateVisible: function() {
              ...
              if (a) {
                ...
                if (f) {
                  ...
                  m < a &&
                    0 >= k &&
                    (void 0 === d.lastpage || parseInt((m + g + f - 1) / f, 10) <= d.lastpage) &&
                    ((n = parseInt((a - m + f - 1) / f, 10)),
                    0 <= m || 2 > n || !0 === d.scroll ? ((E = Math.round((m + g) / f) + 1), (k = -1)) : (k = 1));
                  0 < k && ((E = parseInt(g / f, 10) + 1), (n = parseInt((g + a) / f, 10) + 2 - E), (C = !0));
                  !n ||
                    (d.lastpage && (E > d.lastpage || 1 === d.lastpage || (E === d.page && E === d.lastpage))) ||
                    (c.hDiv.loading
                      ? (c.timer = setTimeout(c.populateVisible, d.scrollTimeout))
                      : ((d.page = E),
                        C && (c.selectionPreserver(e[0]), c.emptyRows.call(e[0], !1, !1)),
                        c.populate(n)));
                }
              }
            },
          ...
          if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
            ...
            var r = function(a, b) {
              ...
              p = function(d, e, f, g, pa, h) {
                ...
                if (0 === e) E += 'width: ' + c.headers[d].width + 'px;';
                  ...
                  k.cellattr &&
                  b.isFunction(k.cellattr) &&
                  (d = k.cellattr.call(a, pa, f, g, k, h)) &&
                  'string' === typeof d
                )
                  if (
                    ((d = d.replace(/style/i, 'style').replace(/title/i, 'title')),
                    -1 < d.indexOf('title') && (k.title = !1),
                    -1 < d.indexOf('class') && (n = void 0),
                    (A = d.replace('-style', '-sti').split(/style/)),
                    2 === A.length)
                  ) {
                ...
                E +=
                  (void 0 !== n ? ' class="' + n + '"' : '') +
                  (k.title && f ? ' title="' + b.jgrid.stripHtml(f) + '"' : '');
              ...
              x = function(c, d, e, f, g) {
                ...
                void 0 !== h.formatter
                  ? ((c = '' !== String(a.p.idPrefix) ? b.jgrid.stripPref(a.p.idPrefix, c) : c),
                    (c = { rowId: c, colModel: h, gid: a.p.id, pos: e }),
                    (d = b.isFunction(h.formatter)
                      ? h.formatter.call(a, d, c, f, g)
                      : b.fmatter
                        ? b.fn.fmatter.call(a, h.formatter, d, c, f, g)
                        : q(d)))
                  : (d = q(d));
                return d;
              },
                      ...
                      ((d[e] =
                        'local' === b
                          ...
                          : 'xml' === b || 'xmlstring' === b
                            ? c.xmlmap || c.name
                            : c.jsonmap || c.name),
                      !1 !== a.p.keyIndex && !0 === c.key && (a.p.keyName = d[e]),
                      e++);
                return d;
              },
              W = function(c) {
              ...
              X = function(a, c) {
                ...
                this.p.deepempty
                  ? b(this.rows)
                      .slice(1)
                      .remove()
                  : ((d = 0 < this.rows.length ? this.rows[0] : null),
                    b(this.firstChild)
                      .empty()
                      .append(d));
                a &&
              ...
              O = function() {
                ...
                f = !0 === a.p.subGrid ? 1 : 0;
                d =
                  !1 === a.p.keyIndex || !0 === a.p.loadonce
                    ? a.p.localReader.id
                    : a.p.colModel[a.p.keyIndex + e + f + d].name;
                for (e = 0; e < c; e++)
              ...
              K = function(c, d, e, f, g) {
                ...
                if (b.isXMLDoc(c)) {
                  ...
                  b.isFunction(k.userdata)
                    ? (a.p.userData = k.userdata.call(a, c) || {})
                    : b.jgrid.getXmlData(c, k.userdata, !0).each(function() {
                  ...
                  if (c && S) {
                    ...
                    var F = !1,
                      J;
                    a.p.grouping &&
                      ((F = !0 === a.p.groupingView.groupCollapse), (J = b.jgrid.getMethod('groupingPrepare')));
                    for (; I < S; ) {
                      w = c[I];
                      H = m(w, B + I);
                      H = a.p.idPrefix + H;
                      ...
                      !1 === a.p.gridview &&
                        ...
                        n.triggerHandler('jqGridAfterInsertRow', [H, v, w]),
                        g && a.p.afterInsertRow.call(a, H, v, w),
                        (s = []));
                      v = {};
                      R++;
                      I++;
                  ...
                  !0 === a.p.gridview &&
                    ((A = -1 < a.p.treeANode ? a.p.treeANode : 0),
                    a.p.grouping
                      ? (l || n.jqGrid('groupingRender', y, a.p.colModel.length, a.p.page, D), (y = null))
                      : !0 === a.p.treeGrid && 0 < A
                        ? b(a.rows[A]).after(s.join(''))
                        : b('tbody:first', d).append(s.join('')));
                  if (!0 === a.p.subGrid)
                    try {
                  ...
                  if (l) {
                    ...
                    a.p.grouping &&
                      ((a.p.groupingView._locgr = !0),
                      n.jqGrid('groupingRender', y, a.p.colModel.length, a.p.page, D),
                      (y = null));
                  }
                }
              },
              Y = function(c, d, e, f, g) {
                ...
                if (c) {
                  -1 !== a.p.treeANode || a.p.scroll ? (e = 1 < e ? e : 1) : (X.call(a, !1, !0), (e = 1));
                  var k,
                    l = ('local' !== a.p.datatype && a.p.loadonce) || 'jsonstring' === a.p.datatype;
                  l && ((a.p.data = []), (a.p._index = {}), (a.p.localReader.id = '_id_'));
                  a.p.reccount = 0;
                  'local' === a.p.datatype
                    ? ((d = a.p.localReader), (k = 'local'))
                    : ((d = a.p.jsonReader), (k = 'json'));
                  var m = b(a),
                    n = 0,
                    C,
                    A,
                  ...
                  var N = b.isFunction(a.p.afterInsertRow),
                    ...
                    O;
                  a.p.grouping &&
                    ((Q = !0 === a.p.groupingView.groupCollapse), (O = b.jgrid.getMethod('groupingPrepare')));
                  for (; A < c; ) {
                    g = B[A];
                    s = b.jgrid.getAccessor(g, v);
                    void 0 === s &&
                      ('number' === typeof v &&
                        null != a.p.colModel[v + u + z + t] &&
                        (s = b.jgrid.getAccessor(g, a.p.colModel[v + u + z + t].name)),
                      void 0 === s &&
                        ((s = F + A),
                        0 === q.length &&
                          d.cell &&
                          ((C = b.jgrid.getAccessor(g, d.cell) || g), (s = null != C && void 0 !== C[v] ? C[v] : s))));
                    s = a.p.idPrefix + s;
                    C = 1 === e ? 0 : e;
                    S = 1 === (C + A) % 2 ? ia : '';
                    ...
                    !1 === a.p.gridview &&
                      (b('#' + b.jgrid.jqID(a.p.id) + ' tbody:first').append(L.join('')),
                      m.triggerHandler('jqGridAfterInsertRow', [s, w, g]),
                      N && a.p.afterInsertRow.call(a, s, w, g),
                      (L = []));
                    w = {};
                    n++;
                    A++;
                  ...
                  !0 === a.p.gridview &&
                    ((H = -1 < a.p.treeANode ? a.p.treeANode : 0),
                    a.p.grouping
                      ? l || (m.jqGrid('groupingRender', P, a.p.colModel.length, a.p.page, I), (P = null))
                      : !0 === a.p.treeGrid && 0 < H
                        ? b(a.rows[H]).after(L.join(''))
                        : b('#' + b.jgrid.jqID(a.p.id) + ' tbody:first').append(L.join('')));
                  if (!0 === a.p.subGrid)
                    try {
                  ...
                  if (l) {
                    ...
                    a.p.grouping &&
                      ((a.p.groupingView._locgr = !0), m.jqGrid('groupingRender', P, a.p.colModel.length, a.p.page, I));
                  }
                }
              },
              oa = function() {
                      ...
                      for (d = 0; d < a.rules.length; d++)
                        (k = a.rules[d]),
                          ...
                          q[k.op] &&
                            k.field &&
                            (0 < b && h && 'OR' === h && (u = u.or()),
                            (u = q[k.op](u, h)(k.field, k.data, f[k.field]))),
                          b++;
                      g && u.orEnd();
                    } catch (m) {
                      alert(m);
                ...
                if (b.isArray(a.p.data)) {
                  ...
                  b.each(a.p.colModel, function() {
                    ...
                    'date' === m || 'datetime' === m
                      ? (this.formatter && 'string' === typeof this.formatter && 'date' === this.formatter
                          ? ((l =
                              this.formatoptions && this.formatoptions.srcformat
                                ? this.formatoptions.srcformat
                                : b.jgrid.formatter.date.srcformat),
                            (n =
                              this.formatoptions && this.formatoptions.newformat
                                ? this.formatoptions.newformat
                                : b.jgrid.formatter.date.newformat))
                          : (l = n = this.datefmt || 'Y-m-d'),
                        (f[this.name] = { stype: m, srcfmt: l, newfmt: n, sfunc: this.sortfunc || null }))
                      : (f[this.name] = { stype: m, srcfmt: '', newfmt: '', sfunc: this.sortfunc || null });
                    if (a.p.grouping)
                    ...
                    a.p.multiSort
                      ? this.lso && (d.push(this.name), (c = this.lso.split('-')), e.push(c[c.length - 1]))
                      : g || (this.index !== a.p.sortname && this.name !== a.p.sortname) || ((d = this.name), (g = !0));
                  });
                  if (a.p.treeGrid) b(a).jqGrid('SortTree', d, a.p.sortorder, f[d].stype || 'text', f[d].srcfmt || '');
                    ...
                    a.p.multiSort
                      ...
                      : d &&
                        a.p.sortorder &&
                        g &&
                        ('DESC' === a.p.sortorder.toUpperCase()
                          ? u.orderBy(a.p.sortname, 'd', f[d].stype, f[d].srcfmt, f[d].sfunc)
                    ...
                    if ((a.p.search || a.p.resetsearch) && a.p.grouping && a.p.groupingView._locgr) {
                      ...
                      var w,
                        G = b.jgrid.getMethod('groupingPrepare'),
                        s,
                        F;
                  ...
                  if (!1 !== e && 'stop' !== e)
                    if (b.isFunction(a.p.datatype)) a.p.datatype.call(a, a.p.postData, 'load_' + a.p.id, q, c, l);
                      ...
                      if (
                        ...
                        ((e = a.p.beforeRequest.call(a)), void 0 === e && (e = !0), !1 === e)
                      )
                        return;
                            ...
                            b.extend(
                              {
                                ...
                                data: b.isFunction(a.p.serializeGridData)
                                  ? a.p.serializeGridData.call(a, a.p.postData)
                                  : a.p.postData,
                                success: function(e, f, h) {
                                  if (
                                    b.isFunction(a.p.beforeProcessing) &&
                                    !1 === a.p.beforeProcessing.call(a, e, f, h)
                                  )
                                    T();
                                  else {
              ...
              qa = function(c, e) {
                ...
                if (0 < a.p.rowList.length) {
                  ...
                  for (m = 0; m < a.p.rowList.length; m++)
                    k +=
                      ...
                      a.p.rowList[m] +
                      '"' +
                      (a.p.rowNum === a.p.rowList[m] ? ' selected="selected"' : '') +
                      '>' +
                      a.p.rowList[m] +
                      '</option>';
                  k += '</select></td>';
                ...
                !0 === a.p.pginput &&
                  (d =
                    ...
                    b.jgrid.format(
                      ...
                      "<span id='sp_1_" + b.jgrid.jqID(c) + "'></span>"
                    ) +
                    '</td>');
                !0 === a.p.pgbuttons
                  ? ((m = ['first' + e, 'prev' + e, 'next' + e, 'last' + e]),
                    'rtl' === f && m.reverse(),
                    (g +=
                      "<td id='" +
                      m[0] +
                ...
                g += '</tr></tbody></table>';
                !0 === a.p.viewrecords &&
                  b('td#' + c + '_' + a.p.recordpos, '#' + l).append(
                    "<div dir='" + f + "' style='text-align:" + a.p.recordpos + "' class='ui-paging-info'></div>"
                  );
                ...
                !0 === a.p.pgbuttons &&
                  (b('.ui-pg-button', '#' + l).hover(
                    function() {
                      b(this).hasClass('ui-state-disabled')
                        ? (this.style.cursor = 'default')
                        : (b(this).addClass('ui-state-hover'), (this.style.cursor = 'pointer'));
                    },
                    function() {
                      b(this).hasClass('ui-state-disabled') ||
                        (b(this).removeClass('ui-state-hover'), (this.style.cursor = 'default'));
                    }
                  ),
                  b(
                    '#first' +
                ...
                !0 === a.p.pginput &&
                  b('input.ui-pg-input', '#' + l).keypress(function(c) {
              ...
              wa = function(c, e) {
                ...
                l
                  ? (b('span.s-ico', k).show(),
                    b('span.ui-icon-' + l, k).removeClass('ui-state-disabled'),
                    b(k).attr('aria-selected', 'true'))
                  : a.p.viewsortcols[0] || b('span.s-ico', k).hide();
                a.p.sortorder = '';
                b.each(f, function(b) {
                  this.lso &&
                    (0 < b && h && (g += ', '),
                    (d = this.lso.split('-')),
                    (g += f[b].index || f[b].name),
                    (g += ' ' + d[d.length - 1]),
                    (h = !0),
                ...
                if (a.p.colModel[d].sortable && !(0 < a.p.savedRow.length)) {
                  e ||
                    (a.p.lastsort === d
                      ? 'asc' === a.p.sortorder
                        ? (a.p.sortorder = 'desc')
                        : 'desc' === a.p.sortorder && (a.p.sortorder = 'asc')
                  ...
                  'stop' === b(a).triggerHandler('jqGridSortCol', [a.p.sortname, d, a.p.sortorder])
                    ? (a.p.lastsort = d)
                    : b.isFunction(a.p.onSortCol) && 'stop' === a.p.onSortCol.call(a, a.p.sortname, d, a.p.sortorder)
                      ? (a.p.lastsort = d)
                      : ('local' === a.p.datatype
                          ? a.p.deselectAfterSort && b(a).jqGrid('resetSelection')
                          : ((a.p.selrow = null), a.p.multiselect && ha(!1), (a.p.selarrrow = []), (a.p.savedRow = [])),
                        a.p.scroll && ((f = a.grid.bDiv.scrollLeft), X.call(a, !0, !1), (a.grid.hDiv.scrollLeft = f)),
                        a.p.subGrid &&
                          'local' === a.p.datatype &&
                          b('td.sgexpanded', '#' + b.jgrid.jqID(a.p.id)).each(function() {
                            b(this).trigger('click');
                          }),
                        Q(),
                        (a.p.lastsort = d),
                        a.p.sortname !== c && d && (a.p.lastsort = d));
                }
              },
              xa = function(c) {
            ...
            for (g = 0; g < this.p.colNames.length; g++)
              (F = a.p.headertitles ? ' title="' + b.jgrid.stripHtml(a.p.colNames[g]) + '"' : ''),
                ...
                (a.p.colModel[g].width = a.p.colModel[g].width ? parseInt(a.p.colModel[g].width, 10) : 150),
                ...
                this.checked
                  ? (b(a.rows).each(function(d) {
                      0 < d &&
                        ...
                        !b(this).hasClass('ui-state-disabled') &&
                        (b('#jqg_' + b.jgrid.jqID(a.p.id) + '_' + b.jgrid.jqID(this.id))[a.p.useProp ? 'prop' : 'attr'](
                          'checked',
                          !0
                        ),
                        b(this)
            ...
            (function() {
              ...
              !0 === a.p.shrinkToFit &&
                0 < g &&
                ((n = c.width - e * g - p),
                isNaN(a.p.height) || ((n -= h), (m = !0)),
                (d = 0),
                b.each(a.p.colModel, function(b) {
                  !1 !== this.hidden ||
                    this.fixed ||
                    ((this.width = k = Math.round((n * this.width) / (a.p.tblwidth - e * g - p))), (d += k), (f = b));
                }),
                (q = 0),
                m
                  ? c.width - p - (d + e * g) !== h && (q = c.width - p - (d + e * g) - h)
                  : m || 1 === Math.abs(c.width - p - (d + e * g)) || (q = c.width - p - (d + e * g)),
                (a.p.colModel[f].width += q),
                (a.p.tblwidth = d + q + e * g + p),
                a.p.tblwidth > a.p.width &&
                  ((a.p.colModel[f].width -= a.p.tblwidth - parseInt(a.p.width, 10)), (a.p.tblwidth = a.p.width)));
            })();
            b(m)
            ...
            b(a)
              ...
              .click(function(c) {
                ...
                if (
                  0 === b(t).length ||
                  -1 < t[0].className.indexOf('ui-state-disabled') ||
                  (
                    b(y, a)
                      .closest('table.ui-jqgrid-btable')
                      .attr('id') || ''
                  ).replace('_frozen', '') !== a.id
                )
                  return this;
                ...
                (e = !1 === e || 'stop' === e ? !1 : !0) &&
                  ...
                  (e = a.p.beforeSelectRow.call(a, t[0].id, c));
                if (
                  'A' !== y.tagName &&
                  (('INPUT' !== y.tagName &&
                    'TEXTAREA' !== y.tagName &&
                  ...
                  if (
                    ...
                    (ma = b(y)
                      .closest('td,th')
                      .html()),
                    b(a).triggerHandler('jqGridCellSelect', [B, N, ma, c]),
                    b.isFunction(a.p.onCellSelect) && a.p.onCellSelect.call(a, B, N, ma, c),
                    !0 === a.p.cellEdit)
                  )
                    ...
                    c[a.p.multikey]
                      ...
                      : a.p.multiselect &&
                        d &&
                        ((d = b('#jqg_' + b.jgrid.jqID(a.p.id) + '_' + B).is(':checked')),
                        b('#jqg_' + b.jgrid.jqID(a.p.id) + '_' + B)[a.p.useProp ? 'prop' : 'attr']('checked', d));
                  else {
                    if (a.p.multiselect && a.p.multiboxonly && !d) {
                      ...
                      b(a.p.selarrrow).each(function(c, d) {
                        ...
                        b('#jqg_' + b.jgrid.jqID(a.p.id) + '_' + b.jgrid.jqID(d))[a.p.useProp ? 'prop' : 'attr'](
                          'checked',
                          !1
                        );
                        f &&
                          (b('#' + b.jgrid.jqID(d), '#' + b.jgrid.jqID(f)).removeClass('ui-state-highlight'),
                          b('#jqg_' + b.jgrid.jqID(a.p.id) + '_' + b.jgrid.jqID(d), '#' + b.jgrid.jqID(f))[
                            a.p.useProp ? 'prop' : 'attr'
                          ]('checked', !1));
                      });
                      a.p.selarrrow = [];
              ...
              .bind('reloadGrid', function(c, d) {
                ...
                'local' === a.p.datatype
                  ? (b(a).jqGrid('resetSelection'), a.p.data.length && O())
                  : a.p.treeGrid ||
                    ((a.p.selrow = null), a.p.multiselect && ((a.p.selarrrow = []), ha(!1)), (a.p.savedRow = []));
                ...
                a.grid.prevRowHeight && a.p.scroll
                  ? (delete a.p.lastpage, a.grid.populateVisible())
                  : a.grid.populate();
              ...
              .dblclick(function(c) {
                ...
                0 !== b(t).length &&
                  ((B = t[0].rowIndex),
                  (N = b.jgrid.getCellIndex(y)),
                  b(a).triggerHandler('jqGridDblClickRow', [b(t).attr('id'), B, N, c]),
                  b.isFunction(a.p.ondblClickRow) && a.p.ondblClickRow.call(a, b(t).attr('id'), B, N, c));
              })
              .bind('contextmenu', function(c) {
                y = c.target;
                t = b(y, a.rows).closest('tr.jqgrow');
                0 !== b(t).length &&
                  (a.p.multiselect || b(a).jqGrid('setSelection', t[0].id, !0, c),
                  (B = t[0].rowIndex),
                  (N = b.jgrid.getCellIndex(y)),
                  b(a).triggerHandler('jqGridRightClickRow', [b(t).attr('id'), B, N, c]),
                  b.isFunction(a.p.onRightClickRow) && a.p.onRightClickRow.call(a, b(t).attr('id'), B, N, c));
              });
            c.bDiv = document.createElement('div');
            n && 'auto' === String(a.p.height).toLowerCase() && (a.p.height = '100%');
            b(c.bDiv)
              .append(
                b('<div style="position:relative;' + (n && 8 > b.jgrid.msiever() ? 'height:0.01%;' : '') + '"></div>')
                  .append('<div></div>')
                  .append(this)
              )
            ...
            var na =
              !0 === a.p.hidegrid
                ? b("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' />")
                    .hover(
                      function() {
                    ...
                    .css('rtl' === f ? 'left' : 'right', '0px')
                : '';
            b(c.cDiv)
              .append(na)
              .append("<span class='ui-jqgrid-title'>" + a.p.caption + '</span>')
              .addClass(
            ...
            a.p.toolbar[0] &&
              ((c.uDiv = document.createElement('div')),
              'top' === a.p.toolbar[1]
                ? b(c.uDiv).insertBefore(c.hDiv)
                : 'bottom' === a.p.toolbar[1] && b(c.uDiv).insertAfter(c.hDiv),
              'both' === a.p.toolbar[1]
                ? ((c.ubDiv = document.createElement('div')),
                  b(c.uDiv)
            ...
            a.p.toppager &&
              ...
              (c.topDiv = b("<div id='" + a.p.toppager + "'></div>")[0]),
              ...
              qa(a.p.toppager, '_t'));
            a.p.footerrow &&
              ((c.sDiv = b("<div class='ui-jqgrid-sdiv'></div>")[0]),
              (g = b("<div class='ui-jqgrid-hbox" + ('rtl' === f ? '-rtl' : '') + "'></div>")),
              b(c.sDiv)
                .append(g)
                .width(c.width)
                  ...
                  'visible' === a.p.gridstate
                    ? b(g, '#gbox_' + b.jgrid.jqID(a.p.id)).slideUp('fast', function() {
                        ...
                        0 === f &&
                          ...
                          e && (J || a.p.onHeaderClick.call(a, a.p.gridstate, d)));
                      })
                    : 'hidden' === a.p.gridstate &&
                      b(g, '#gbox_' + b.jgrid.jqID(a.p.id)).slideDown('fast', function() {
                        f--;
                        0 === f &&
                          (b('span', h)
                            .removeClass('ui-icon-circle-triangle-s')
                            .addClass('ui-icon-circle-triangle-n'),
                          J && ((a.p.datatype = ya), Q(), (J = !1)),
                          (a.p.gridstate = 'visible'),
                          b('#gbox_' + b.jgrid.jqID(a.p.id)).hasClass('ui-resizable') &&
                            b('.ui-resizable-handle', '#gbox_' + b.jgrid.jqID(a.p.id)).show(),
                          b(a).triggerHandler('jqGridHeaderClick', [a.p.gridstate, d]),
                          e && (J || a.p.onHeaderClick.call(a, a.p.gridstate, d)));
                      });
                  return !1;
            ...
            a.updatepager = function(c, d) {
                ...
                if ((e = e.outerHeight() || a.grid.prevRowHeight))
                  (g = f * e),
                    ...
                    b('>div:first', a.grid.bDiv)
                      .css({ height: m })
                      .children('div:first')
                      .css({ height: g, display: g ? '' : 'none' }),
                    0 == a.grid.bDiv.scrollTop &&
                      1 < a.p.page &&
              ...
              if ((n += a.p.toppager ? (n ? ',' + a.p.toppager : a.p.toppager) : ''))
                (m = b.jgrid.formatter.integer || {}),
                  (e = r(a.p.page)),
                  (g = r(a.p.lastpage)),
                  b('.selbox', n)[this.p.useProp ? 'prop' : 'attr']('disabled', !1),
                  !0 === a.p.pginput &&
                    (b('.ui-pg-input', n).val(a.p.page),
                    (h = a.p.toppager ? '#sp_1' + p + ',#sp_1' + q : '#sp_1' + p),
                    b(h).html(b.fmatter ? b.fmatter.util.NumberFormat(a.p.lastpage, m) : a.p.lastpage)),
                  a.p.viewrecords &&
                    (0 === a.p.reccount
                      ? b('.ui-paging-info', n).html(a.p.emptyrecords)
                      : ((h = f + 1),
                        (l = a.p.records),
                        b.fmatter &&
                          ((h = b.fmatter.util.NumberFormat(h, m)),
                          (k = b.fmatter.util.NumberFormat(k, m)),
                          (l = b.fmatter.util.NumberFormat(l, m))),
                        b('.ui-paging-info', n).html(b.jgrid.format(a.p.recordtext, h, k, l)))),
                  !0 === a.p.pgbuttons &&
                    (0 >= e && (e = g = 0),
                    1 === e || 0 === e
                      ? (b('#first' + p + ', #prev' + p)
                        ...
                        a.p.toppager &&
                          b('#first_t' + q + ', #prev_t' + q)
                            .addClass('ui-state-disabled')
                            .removeClass('ui-state-hover'))
                      : (b('#first' + p + ', #prev' + p).removeClass('ui-state-disabled'),
                        a.p.toppager && b('#first_t' + q + ', #prev_t' + q).removeClass('ui-state-disabled')),
                    e === g || 0 === e
                      ? (b('#next' + p + ', #last' + p)
                          .addClass('ui-state-disabled')
                          .removeClass('ui-state-hover'),
                        a.p.toppager &&
                          b('#next_t' + q + ', #last_t' + q)
                            .addClass('ui-state-disabled')
                            .removeClass('ui-state-hover'))
                      : (b('#next' + p + ', #last' + p).removeClass('ui-state-disabled'),
                        a.p.toppager && b('#next_t' + q + ', #last_t' + q).removeClass('ui-state-disabled')));
              !0 === c &&
                !0 === a.p.rownumbers &&
                b('>td.jqgrid-rownum', a.rows).each(function(a) {
                  b(this).html(f + 1 + a);
                });
  ...
  b.jgrid.extend({
    ...
    setSelection: function(e, f, c) {
      return this.each(function() {
        ...
        void 0 !== e &&
          ((f = !1 === f ? !1 : !0),
          !(a = b(this).jqGrid('getGridRowById', e)) ||
            !a.className ||
            -1 < a.className.indexOf('ui-state-disabled') ||
            (!0 === this.p.scrollrows &&
              ((l = b(this).jqGrid('getGridRowById', e).rowIndex),
              0 <= l &&
                ((d = b(this.grid.bDiv)[0].clientHeight),
                (g = b(this.grid.bDiv)[0].scrollTop),
                (h = b(this.rows[l]).position().top),
                (l = this.rows[l].clientHeight),
                h + l >= d + g
                  ? (b(this.grid.bDiv)[0].scrollTop = h - (d + g) + l + g)
                  : h < d + g && h < g && (b(this.grid.bDiv)[0].scrollTop = h))),
            !0 === this.p.frozenColumns && (k = this.p.id + '_frozen'),
            this.p.multiselect
              ? (this.setHeadCheckBox(!1),
                (this.p.selrow = a.id),
                (g = b.inArray(this.p.selrow, this.p.selarrrow)),
                -1 === g
                  ...
                  : ('ui-subgrid' !== a.className &&
                      b(a)
                        ...
                        .attr('aria-selected', 'false'),
                    (d = !1),
                    this.p.selarrrow.splice(g, 1),
                    (h = this.p.selarrrow[0]),
                    (this.p.selrow = void 0 === h ? null : h)),
                b('#jqg_' + b.jgrid.jqID(this.p.id) + '_' + b.jgrid.jqID(a.id))[this.p.useProp ? 'prop' : 'attr'](
                  'checked',
                  d
                ),
                k &&
                  (-1 === g
                    ? b('#' + b.jgrid.jqID(e), '#' + b.jgrid.jqID(k)).addClass('ui-state-highlight')
                    : b('#' + b.jgrid.jqID(e), '#' + b.jgrid.jqID(k)).removeClass('ui-state-highlight'),
                  b('#jqg_' + b.jgrid.jqID(this.p.id) + '_' + b.jgrid.jqID(e), '#' + b.jgrid.jqID(k))[
                    this.p.useProp ? 'prop' : 'attr'
                  ]('checked', d)),
                f &&
                  (b(this).triggerHandler('jqGridSelectRow', [a.id, d, c]),
                  this.p.onSelectRow && this.p.onSelectRow.call(this, a.id, d, c)))
              : 'ui-subgrid' !== a.className &&
                (this.p.selrow !== a.id
                  ? (b(b(this).jqGrid('getGridRowById', this.p.selrow))
                    ...
                    k &&
                      (b('#' + b.jgrid.jqID(this.p.selrow), '#' + b.jgrid.jqID(k)).removeClass('ui-state-highlight'),
                      b('#' + b.jgrid.jqID(e), '#' + b.jgrid.jqID(k)).addClass('ui-state-highlight')),
                    (d = !0))
                  : (d = !1),
                (this.p.selrow = a.id),
    ...
    resetSelection: function(e) {
      return this.each(function() {
        var f = this,
          c,
          d;
        !0 === f.p.frozenColumns && (d = f.p.id + '_frozen');
        if (void 0 !== e) {
          c = e === f.p.selrow ? f.p.selrow : e;
          b('#' + b.jgrid.jqID(f.p.id) + ' tbody:first tr#' + b.jgrid.jqID(c))
            .removeClass('ui-state-highlight')
            .attr('aria-selected', 'false');
          d && b('#' + b.jgrid.jqID(c), '#' + b.jgrid.jqID(d)).removeClass('ui-state-highlight');
          if (f.p.multiselect) {
            b('#jqg_' + b.jgrid.jqID(f.p.id) + '_' + b.jgrid.jqID(c), '#' + b.jgrid.jqID(f.p.id))[
              f.p.useProp ? 'prop' : 'attr'
            ]('checked', !1);
            if (d)
              b('#jqg_' + b.jgrid.jqID(f.p.id) + '_' + b.jgrid.jqID(c), '#' + b.jgrid.jqID(d))[
                f.p.useProp ? 'prop' : 'attr'
              ]('checked', !1);
            f.setHeadCheckBox(!1);
          }
          ...
          f.p.multiselect
            ? (b(f.p.selarrrow).each(function(a, c) {
                b(b(f).jqGrid('getGridRowById', c))
                  .removeClass('ui-state-highlight')
                  .attr('aria-selected', 'false');
                b('#jqg_' + b.jgrid.jqID(f.p.id) + '_' + b.jgrid.jqID(c))[f.p.useProp ? 'prop' : 'attr']('checked', !1);
                d &&
                  (b('#' + b.jgrid.jqID(c), '#' + b.jgrid.jqID(d)).removeClass('ui-state-highlight'),
                  b('#jqg_' + b.jgrid.jqID(f.p.id) + '_' + b.jgrid.jqID(c), '#' + b.jgrid.jqID(d))[
                    f.p.useProp ? 'prop' : 'attr'
                  ]('checked', !1));
              }),
              ...
              (f.p.selrow = null))
            : f.p.selrow &&
              (b('#' + b.jgrid.jqID(f.p.id) + ' tbody:first tr#' + b.jgrid.jqID(f.p.selrow))
                .removeClass('ui-state-highlight')
                .attr('aria-selected', 'false'),
              d && b('#' + b.jgrid.jqID(f.p.selrow), '#' + b.jgrid.jqID(d)).removeClass('ui-state-highlight'),
              (f.p.selrow = null));
        !0 === f.p.cellEdit &&
          0 <= parseInt(f.p.iCol, 10) &&
          0 <= parseInt(f.p.iRow, 10) &&
          (b('td:eq(' + f.p.iCol + ')', f.rows[f.p.iRow]).removeClass('edit-cell ui-state-highlight'),
          b(f.rows[f.p.iRow]).removeClass('selected-row ui-state-hover'));
        f.p.savedRow = [];
      });
    },
    getRowData: function(e) {
      ...
      this.each(function() {
        ...
        for (; l < a; )
          d && (k = g.rows[l]),
            b(k).hasClass('jqgrow') &&
              (b('td[role="gridcell"]', k).each(function(a) {
                ...
                if ('cb' !== h && 'subgrid' !== h && 'rn' !== h)
                  if (!0 === g.p.treeGrid && h === g.p.ExpandColumn)
                    ...
                    try {
                      f[h] = b.unformat.call(g, this, { rowId: k.id, colModel: g.p.colModel[a] }, a);
                    } catch (c) {
    ...
    delRowData: function(e) {
      ...
      this.each(function() {
        ...
        this.p.selrow =
          this.p.multiselect && 0 < this.p.selarrrow.length ? this.p.selarrrow[this.p.selarrrow.length - 1] : null;
    ...
    setRowData: function(e, f, c) {
      ...
      this.each(function() {
          ...
          try {
            if (
                ...
                void 0 !== c &&
                  ((m[d] =
                    this.formatter && 'string' === typeof this.formatter && 'date' === this.formatter
                      ...
                      : c),
                  (h = g.formatter(e, c, a, f, 'edit')),
                  (l = this.title ? { title: b.jgrid.stripHtml(h) } : {}),
                  !0 === g.p.treeGrid && d === g.p.ExpandColumn
                    ? b("td[role='gridcell']:eq(" + a + ') > span:first', k)
                        .html(h)
                        .attr(l)
                    : b("td[role='gridcell']:eq(" + a + ')', k)
                        .html(h)
                        .attr(l));
              }),
              'local' === g.p.datatype)
              ...
              var r = b.jgrid.stripPref(g.p.idPrefix, e),
                ...
                q;
              if (g.p.treeGrid)
                for (q in g.p.treeReader) g.p.treeReader.hasOwnProperty(q) && delete m[g.p.treeReader[q]];
        ...
        a &&
          ('string' === n ? b(k).addClass(c) : null !== c && 'object' === n && b(k).css(c),
    ...
    addRowData: function(e, f, c, d) {
      ...
      var a = !1,
        ...
        W;
      f &&
        (b.isArray(f) ? ((x = !0), (c = 'last'), (G = e)) : ((f = [f]), (x = !1)),
        this.each(function() {
          var X = f.length;
          ...
          x ||
            (void 0 !== e
              ...
              : ((e = b.jgrid.randId()),
                !1 !== this.p.keyIndex &&
                  ((G = this.p.colModel[this.p.keyIndex + h + k + n].name), void 0 !== f[0][G] && (e = f[0][G]))));
          U = this.p.altclass;
          for (var O = 0, $ = '', K = {}, Y = b.isFunction(this.p.afterInsertRow) ? !0 : !1; O < X; ) {
            ...
            e = this.p.idPrefix + e;
            n &&
              ((q = this.formatCol(0, 1, '', null, e, !0)),
              (g[g.length] = '<td role="gridcell" class="ui-state-default jqgrid-rownum" ' + q + '>0</td>'));
            h &&
              ((p = '<input role="checkbox" type="checkbox" id="jqg_' + this.p.id + '_' + e + '" class="cbox"/>'),
              (q = this.formatCol(n, 1, '', null, e, !0)),
              (g[g.length] = '<td role="gridcell" ' + q + '>' + p + '</td>'));
            k && (g[g.length] = b(this).jqGrid('addSubGridCell', h + n, 1));
            for (r = h + k + n; r < this.p.colModel.length; r++)
              (ea = this.p.colModel[r]),
                (l = ea.name),
                (K[l] = M[l]),
              ...
              switch (c) {
                ...
                case 'after':
                  if ((m = b(this).jqGrid('getGridRowById', d)))
                    b(this.rows[m.rowIndex + 1]).hasClass('ui-subgrid')
                      ? b(this.rows[m.rowIndex + 1]).after(g)
                      : b(m).after(g.join('')),
                      (m = m.rowIndex + 1);
                  break;
                case 'before':
                  if ((m = b(this).jqGrid('getGridRowById', d))) b(m).before(g.join('')), (m = m.rowIndex - 1);
              }
            ...
            'local' === this.p.datatype &&
              ((K[this.p.localReader.id] = W), (this.p._index[W] = this.p.data.length), this.p.data.push(K), (K = {}));
          }
          !0 !== this.p.altRows ||
            x ||
            ('last' === c
              ? 1 === (this.rows.length - 1) % 2 && b(this.rows[this.rows.length - 1]).addClass(U)
              : b(this.rows).each(function(a) {
    ...
    footerData: function(e, f, c) {
      ...
      this.each(function() {
        ...
        b(this.p.colModel).each(function(d) {
          ...
          'set' === e
            ? void 0 !== f[a] &&
              ((n = c ? k.formatter('', f[a], d, f, 'edit') : f[a]),
              (h = this.title ? { title: b.jgrid.stripHtml(n) } : {}),
              b('tr.footrow td:eq(' + d + ')', k.grid.sDiv)
                .html(n)
                .attr(h),
              (l = !0))
            : 'get' === e && (g[a] = b('tr.footrow td:eq(' + d + ')', k.grid.sDiv).html());
        });
      });
      return 'get' === e ? g : l;
    },
    showHideCol: function(e, f) {
      return this.each(function() {
        ...
        if (c.grid) {
          ...
          !0 === d &&
            (!0 !== c.p.shrinkToFit || isNaN(c.p.height) || (c.p.tblwidth += parseInt(c.p.scrollOffset, 10)),
            b(c).jqGrid('setGridWidth', !0 === c.p.shrinkToFit ? c.p.tblwidth : c.p.width));
      ...
      return this.each(function() {
        if (this.grid) {
          ...
          if (!isNaN(e)) {
            ...
            !0 === c.p.toolbar[0] &&
              (b(c.grid.uDiv).css('width', e + 'px'),
              'both' === c.p.toolbar[1] && b(c.grid.ubDiv).css('width', e + 'px'));
            ...
            if (!0 === f) {
              ...
              b.each(c.p.colModel, function(b) {
                !1 !== this.hidden ||
                  this.fixed ||
                  ((d = this.widthOrg),
                  (d = Math.round((m * d) / (c.p.tblwidth - l * h - r))),
                  0 > d ||
                    ((this.width = d),
                    (a += d),
                    (c.grid.headers[b].width = d),
                    (c.grid.headers[b].el.style.width = d + 'px'),
                    c.p.footerrow && (c.grid.footers[b].style.width = d + 'px'),
                    q && (c.grid.cols[b].style.width = d + 'px'),
                    (g = b)));
              });
              if (!g) return;
              p = 0;
              k
                ? e - r - (a + l * h) !== n && (p = e - r - (a + l * h) - n)
                : 1 !== Math.abs(e - r - (a + l * h)) && (p = e - r - (a + l * h));
              c.p.colModel[g].width += p;
              c.p.tblwidth = a + p + l * h + r;
              c.p.tblwidth > e
                ? ((k = c.p.tblwidth - parseInt(e, 10)), (c.p.tblwidth = e), (d = c.p.colModel[g].width -= k))
                : (d = c.p.colModel[g].width);
            ...
            c.p.tblwidth &&
              (b('table:first', c.grid.bDiv).css('width', c.p.tblwidth + 'px'),
              b('table:first', c.grid.hDiv).css('width', c.p.tblwidth + 'px'),
      ...
      return this.each(function() {
        ...
        if (
          ...
          (isNaN(f)
            ...
            : (g = parseInt(f, 10)),
          0 <= g && (h = b(this).jqGrid('getGridRowById', e)))
        ) {
          var n = b('td:eq(' + g + ')', h);
          if ('' !== c || !0 === l)
            (h = this.formatter(e, c, g, h, 'edit')),
              (k = this.p.colModel[g].title ? { title: b.jgrid.stripHtml(h) } : {}),
              this.p.treeGrid && 0 < b('.tree-wrap', b(n)).length
                ? b('span', b(n))
                    .html(h)
                    .attr(k)
                : b(n)
              ...
              'local' === this.p.datatype &&
                ((h = this.p.colModel[g]),
                (c =
                  h.formatter && 'string' === typeof h.formatter && 'date' === h.formatter
                    ? b.unformat.date.call(this, c, h)
                    : c),
                (k = this.p._index[b.jgrid.stripPref(this.p.idPrefix, e)]),
                void 0 !== k && (this.p.data[k][h.name] = c));
            ...
            for (; r < m; ) {
              if (b(this.rows[r]).hasClass('jqgrow')) {
                try {
                  a = b.unformat.call(
                    this,
                    b(this.rows[r].cells[n]),
                    { rowId: this.rows[r].id, colModel: this.p.colModel[n] },
                    n
                  );
                } catch (q) {
                ...
                c
                  ? ((k = parseFloat(a)),
                    isNaN(k) ||
                      ((l += k), void 0 === h && (h = g = k), (g = Math.min(g, k)), (h = Math.max(h, k)), p++))
                  : f
                    ? d.push({ id: this.rows[r].id, value: a })
                    : d.push(a);
              }
              r++;
            }
    ...
    bindKeys: function(e) {
      ...
      return this.each(function() {
        ...
        b(c).keydown(function(d) {
          ...
          if (a)
            if (
              ((h = c.p._index[b.jgrid.stripPref(c.p.idPrefix, a.id)]),
              ...
              13 === d.keyCode
                ? (b(c).triggerHandler('jqGridKeyEnter', [c.p.selrow]),
                  b.isFunction(f.onEnter) && f.onEnter.call(c, c.p.selrow))
                : 32 === d.keyCode &&
                  (b(c).triggerHandler('jqGridKeySpace', [c.p.selrow]),
...
(function(a) {
    ...
    NumberFormat: function(c, b) {
      ...
      if (a.fmatter.isNumber(c)) {
        ...
        if (a.fmatter.isNumber(b.decimalPlaces)) {
          ...
          g = e.lastIndexOf('.');
          if (0 < h)
            for (0 > g ? ((e += f), (g = e.length - 1)) : '.' !== f && (e = e.replace('.', f)); e.length - 1 - g < h; )
              e += '0';
        }
  ...
  a.fn.fmatter.checkbox = function(c, b) {
    ...
    return (
      '<input type="checkbox" ' +
      (0 > c.search(/(false|f|0|no|n|off|undefined)/i) ? " checked='checked' " : '') +
      ' value="' +
      c +
      '" offval="no" ' +
      e +
  ...
  a.fn.fmatter.showlink = function(c, b) {
    ...
    return a.fmatter.isString(c) || a.fmatter.isNumber(c)
      ? '<a ' + e + ' href="' + d + '">' + c + '</a>'
      : a.fn.fmatter.defaultFormat(c, b);
  };
  ...
  a.fn.fmatter.date = function(c, b, d, e) {
    ...
    return d.reformatAfterEdit || 'edit' !== e
      ? a.fmatter.isEmpty(c)
        ? a.fn.fmatter.defaultFormat(c, b)
        : a.jgrid.parseDate(d.srcformat, c, d.newformat, d)
      : a.fn.fmatter.defaultFormat(c, b);
  };
  a.fn.fmatter.select = function(c, b) {
    ...
    void 0 !== b.colModel.formatoptions
      ? ((d = b.colModel.formatoptions.value),
        (f = void 0 === b.colModel.formatoptions.separator ? ':' : b.colModel.formatoptions.separator),
      ...
      : void 0 !== b.colModel.editoptions &&
        ...
        (f = void 0 === b.colModel.editoptions.separator ? ':' : b.colModel.editoptions.separator),
        (g = void 0 === b.colModel.editoptions.delimiter ? ';' : b.colModel.editoptions.delimiter));
    if (d) {
      var h = !0 === b.colModel.editoptions.multiple ? !0 : !1,
        l = [];
      h &&
        ((l = c.split(',')),
        (l = a.map(l, function(b) {
          return a.trim(b);
        })));
      if (a.fmatter.isString(d)) {
        ...
        a.fmatter.isObject(d) &&
          (h
            ? (e = a.map(l, function(a) {
                return d[a];
              }))
            : (e[0] = d[c] || ''));
    }
  ...
  a.jgrid.extend({
      ...
      return this.each(function() {
        ...
        if (this.grid) {
          ...
          for (k = 0; k < this.p.colModel.length; k++)
            if (this.p.colModel[k].index === a || this.p.colModel[k].name === a) {
              h = k;
              !0 === this.p.frozenColumns &&
                !0 === this.p.colModel[k].frozen &&
                (e = this.grid.fhDiv.find('#' + this.p.id + '_' + a));
              break;
            }
          -1 !== h &&
            ((k = this.p.colModel[h].sortable),
            e || (e = this.grid.headers[h].el),
            'boolean' !== typeof k && (k = !0),
            'boolean' !== typeof c && (c = !1),
            k && this.sortData('jqgh_' + this.p.id + '_' + a, h, c, d, e));
        }
      });
    },
    ...
    setGridState: function(b) {
      return this.each(function() {
        this.grid &&
          ('hidden' === b
            ? (a('.ui-jqgrid-bdiv, .ui-jqgrid-hdiv', '#gview_' + a.jgrid.jqID(this.p.id)).slideUp('fast'),
              this.p.pager && a(this.p.pager).slideUp('fast'),
              this.p.toppager && a(this.p.toppager).slideUp('fast'),
              !0 === this.p.toolbar[0] &&
                ('both' === this.p.toolbar[1] && a(this.grid.ubDiv).slideUp('fast'), a(this.grid.uDiv).slideUp('fast')),
            ...
            : 'visible' === b &&
              (a('.ui-jqgrid-hdiv, .ui-jqgrid-bdiv', '#gview_' + a.jgrid.jqID(this.p.id)).slideDown('fast'),
              this.p.pager && a(this.p.pager).slideDown('fast'),
              this.p.toppager && a(this.p.toppager).slideDown('fast'),
              !0 === this.p.toolbar[0] &&
                ('both' === this.p.toolbar[1] && a(this.grid.ubDiv).slideDown('fast'),
        ...
        if (!this.ftoolbar) {
          var d = function() {
              ...
              a.each(c.p.colModel, function() {
                var l = a(
                  ...
                  !0 === this.frozen && !0 === c.p.frozenColumns ? c.grid.fhDiv : c.grid.hDiv
                );
                ...
                if (
                  (g =
                    ...
                    'SPAN' === l[0].nodeName.toUpperCase()
                      ? this.searchoptions.custom_value.call(c, l.children('.customelement:first'), 'get')
                      : l.val()) ||
                  'nu' === q ||
                  'nn' === q
                )
            ...
            h = function(e, f, g) {
              ...
              for (p = 0; p < l.sopt.length; p++)
                (q = a.inArray(l.sopt[p], h)),
                  -1 !== q &&
                    ((k = g === b.odata[q].oper ? 'ui-state-highlight' : ''),
                    (f +=
          ...
          a.each(c.p.colModel, function(h) {
            ...
            if (this.search) {
              ...
              g.clearSearch
                ? ((m = b.resetTitle || 'Clear Search Value'),
                  a('td:eq(2)', n).append(
                    "<a title='" +
                      m +
              ...
              switch (this.stype) {
                case 'select':
                  if ((m = this.surl || g.dataUrl))
                        ...
                        a.extend(
                          {
                            ...
                            dataType: 'html',
                            success: function(e) {
                              void 0 !== g.buildSelect
                                ? (e = g.buildSelect(e)) && a('td:eq(1)', n).append(e)
                                : a('td:eq(1)', n).append(e);
                    ...
                    var r, w, u;
                    f.searchoptions
                      ? ((r = void 0 === f.searchoptions.value ? '' : f.searchoptions.value),
                        (w = void 0 === f.searchoptions.separator ? ':' : f.searchoptions.separator),
                        (u = void 0 === f.searchoptions.delimiter ? ';' : f.searchoptions.delimiter))
                      : f.editoptions &&
                        ((r = void 0 === f.editoptions.value ? '' : f.editoptions.value),
                        (w = void 0 === f.editoptions.separator ? ':' : f.editoptions.separator),
                        (u = void 0 === f.editoptions.delimiter ? ';' : f.editoptions.delimiter));
                    if (r) {
                ...
                case 'custom':
                  a('td:eq(1)', n).append(
                    "<span style='width:95%;padding:0px;' name='" + (f.index || f.name) + "' id='gs_" + f.name + "'/>"
                  );
                  a(l).append(n);
                  try {
          ...
          b.searchOperators &&
            (a('.soptclass', k).click(function(b) {
              var c = a(this).offset();
              h(this, c.left, c.top);
              b.stopPropagation();
            }),
          ...
          a('.clearsearchclass', k).click(function(e) {
            ...
            'select' === c.p.colModel[f].stype
              ? g
                ? a('td.ui-search-input select', e).val(g)
                : (a('td.ui-search-input select', e)[0].selectedIndex = 0)
              : a('td.ui-search-input input', e).val(g);
            !0 === b.autosearch && d();
          });
          this.ftoolbar = !0;
              ...
              switch (this.stype) {
                ...
                case 'custom':
                  a.isFunction(this.searchoptions.custom_value) &&
                    ...
                    this.searchoptions.custom_value.call(c, d.children('.customelement:first'), 'set', b || '');
              }
            });
            var k = 0 < g ? !0 : !1;
            c.p.resetsearch = !0;
    ...
    destroyFilterToolbar: function() {
      return this.each(function() {
        this.ftoolbar &&
          ((this.toggleToolbar = this.clearToolbar = this.triggerToolbar = null),
          (this.ftoolbar = !1),
          a(this.grid.hDiv)
    ...
    setGroupHeaders: function(b) {
      ...
      return this.each(function() {
        ...
        void 0 === n[0]
          ? (n = a('<tr>', { role: 'row', 'aria-hidden': 'true' })
        ...
        for (c = 0; c < x; c++)
          if (
            ...
            (f = a(s)),
            (d = m[c]),
            (e = { height: '0px', width: q[c].width + 'px', display: d.hidden ? 'none' : '' }),
            a('<th>', { role: 'gridcell' })
              .css(e)
            ...
            0 === h
              ? b.useColSpanStyle
                ...
                : (a('<th>', { role: 'columnheader' })
                    .addClass('ui-state-default ui-th-column-header ui-th-' + this.p.direction)
                    .css({ display: d.hidden ? 'none' : '', 'border-top': '0 none' })
                    .insertBefore(f),
                  k.append(s))
              : (k.append(s), h--);
        ...
        p.append(m);
        b.useColSpanStyle &&
          (p.find('span.ui-jqgrid-resize').each(function() {
            var b = a(this).parent();
              ...
              a(b).bind('jqGridAfterGridComplete.setFrozenColumns', function() {
                ...
                !0 === b.p.hoverrows &&
                  ...
                  a('tr.jqgrow', '#' + a.jgrid.jqID(b.p.id)).hover(
                    ...
                    function() {
                      a(this).removeClass('ui-state-hover');
                      a('#' + a.jgrid.jqID(this.id), '#' + a.jgrid.jqID(b.p.id) + '_frozen').removeClass(
                        'ui-state-hover'
                      );
                    }
                  ));
...
(function(a) {
  a.extend(a.jgrid, {
    ...
    hideModal: function(d, b) {
      ...
      if (b.onClose) {
        var c =
          b.gb && 'string' === typeof b.gb && '#gbox_' === b.gb.substr(0, 6)
            ? b.onClose.call(a('#' + b.gb.substr(6))[0], d)
            : b.onClose(d);
    ...
    createModal: function(d, b, c, g, e, h, f) {
      ...
      var q = a("<a class='ui-jqdialog-titlebar-close ui-corner-all'></a>")
        .hover(
          function() {
      ...
      if (a.fn.jqm && !0 === c.jqModal)
        0 === c.left &&
          0 === c.top &&
          c.overlay &&
          ((f = []), (f = a.jgrid.findPos(e)), (c.left = f[0] + 4), (c.top = f[1] + 4)),
          (b.top = c.top + 'px'),
          (b.left = c.left);
      ...
      c.zIndex ||
        ((g = a(g)
          ...
          .filter(':first')
          .css('z-index')),
        (c.zIndex = g ? parseInt(g, 10) + 2 : 950));
      g = 0;
      l &&
        b.left &&
        !h &&
        ((g = a(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8),
        (b.left = parseInt(b.left, 10) + parseInt(g, 10)));
      b.left && (b.left += 'px');
      a(k)
        .css(
          a.extend(
        ...
        .attr({ tabIndex: '-1', role: 'dialog', 'aria-labelledby': d.modalhead, 'aria-hidden': 'true' });
    ...
    info_dialog: function(d, b, c, g) {
      ...
      b += '</div>';
      try {
        'false' === a('#info_dialog').attr('aria-hidden') && a.jgrid.hideModal('#info_dialog', { jqm: h }),
          a('#info_dialog').remove();
      } catch (k) {}
      a.jgrid.createModal(
        { themodal: 'info_dialog', modalhead: 'info_head', modalcontent: 'info_content', scrollelm: 'infocnt' },
        b,
        e,
        '',
        '',
    ...
    createEl: function(d, b, c, g, e) {
      ...
      switch (d) {
        ...
        case 'checkbox':
          ...
          b.value
            ? ((d = b.value.split(':')),
              c === d[0] && ((f.checked = !0), (f.defaultChecked = !0)),
              (f.value = d[0]),
              a(f).attr('offval', d[1]))
            : ((d = (c + '').toLowerCase()),
              0 > d.search(/(false|f|0|no|n|off|undefined)/i) && '' !== d
        ...
        case 'select':
          ...
          if (void 0 !== b.dataUrl) {
              ...
              a.extend(
                {
                  ...
                  success: function(b) {
                    ...
                    b &&
                      (a(c).append(b),
                      h(c, f, l ? ['postData'] : void 0),
                      void 0 === f.size && (f.size = g ? 3 : 1),
                      g
                        ? ((d = e.split(',')),
            ...
            var n,
              q,
              p = void 0 === b.separator ? ':' : b.separator;
            ...
            if ('string' === typeof b.value)
              for (n = b.value.split(e), m = 0; m < n.length; m++)
                (q = n[m].split(p)),
                  ...
                  d &&
                    (-1 < a.inArray(a.trim(q[1]), g) || -1 < a.inArray(a.trim(q[0]), g)) &&
                    (e.selected = 'selected');
              ...
              for (m in ((p = b.value), p))
                p.hasOwnProperty(m) &&
                  ...
                  (e.innerHTML = p[m]),
                  f.appendChild(e),
                  d || (a.trim(m) !== a.trim(c) && a.trim(p[m]) !== a.trim(c)) || (e.selected = 'selected'),
                  d && (-1 < a.inArray(a.trim(p[m]), g) || -1 < a.inArray(a.trim(m), g)) && (e.selected = 'selected'));
            h(f, b, ['value']);
          }
          break;
        case 'text':
    ...
    checkValues: function(d, b, c, g) {
      ...
      if (e) {
        ...
        if (
          !(!0 !== e.integer || (!1 === c && a.jgrid.isEmpty(d)) || (!isNaN(d) && 0 === d % 1 && -1 === d.indexOf('.')))
        )
        ...
        if (!0 === e.custom && (!1 !== c || !a.jgrid.isEmpty(d)))
          return a.isFunction(e.custom_func)
            ? ((d = e.custom_func.call(this, d, h, b)), a.isArray(d) ? d : [!1, a.jgrid.edit.msg.customarray, ''])
...
(function(a) {
  ...
  a.jgrid.extend({
      ...
      return this.each(function() {
        function c(c) {
          ...
          w &&
            ...
            a(e).triggerHandler('jqGridFilterAfterShow', [c]),
            a.isFunction(b.afterShowSearch) && b.afterShowSearch.call(e, c));
        }
        var e = this;
        if (e.grid) {
          var h = 'fbox_' + e.p.id,
            w = !0,
            t = !0,
            s = { themodal: 'searchmod' + h, modalhead: 'searchhd' + h, modalcontent: 'searchcnt' + h, scrollelm: h },
          ...
          if (void 0 !== a('#' + a.jgrid.jqID(s.themodal))[0]) c(a('#fbox_' + a.jgrid.jqID(+e.p.id)));
            ...
            var f = a("<div><div id='" + h + "' class='searchFilter' style='overflow:auto'></div></div>").insertBefore(
            ...
            b.columns.length
              ? ((x = b.columns), (y = 0), (p = x[0].index || x[0].name))
            ...
            if ((!r && p) || !1 === b.multipleSearch) {
              var D = 'eq';
              0 <= y && x[y].searchoptions && x[y].searchoptions.sopt
                ? (D = x[y].searchoptions.sopt[0])
                : b.sopt && b.sopt.length && (D = b.sopt[0]);
            ...
            b.tmplNames &&
              ...
              ((q = !0),
              (m = b.tmplLabel),
              (m += "<select class='ui-template'>"),
              (m += "<option value='default'>Default</option>"),
            ...
            q &&
              ...
              a('.ui-template', f).bind('change', function() {
                var c = a(this).val();
                'default' === c
                  ? a('#' + h).jqFilter('addFilter', r)
                  : a('#' + h).jqFilter('addFilter', b.tmplFilters[parseInt(c, 10)]);
                return !1;
              });
            ...
            (b.searchOnEnter || b.closeOnEscape) &&
              a('#' + a.jgrid.jqID(s.themodal)).keydown(function(c) {
                var d = a(c.target);
                if (
                  b.searchOnEnter &&
                  13 === c.which &&
            ...
            g &&
              a('#' + h + '_query').bind('click', function() {
            ...
            c(a('#' + h));
            a('.fm-button:not(.ui-state-disabled)', f).hover(
              function() {
                a(this).addClass('ui-state-hover');
              },
              function() {
      ...
      return this.each(function() {
            ...
            if (b.length) {
              ...
              a.each(d.p.colModel, function() {
                if (this.name === c && this.editoptions && a.isFunction(this.editoptions.custom_value)) {
                  try {
                    if (
                      ((l[c] = this.editoptions.custom_value.call(d, a('#' + a.jgrid.jqID(c), p), 'get')),
                      void 0 === l[c])
                    )
                      throw 'e1';
                  } catch (b) {
                    'e1' === b
                      ? a.jgrid.info_dialog(
                          a.jgrid.errors.errcap,
                          "function 'custom_value' " + a.jgrid.edit.msg.novalue,
                          a.jgrid.edit.bClose
                        )
                      : a.jgrid.info_dialog(a.jgrid.errors.errcap, b.message, a.jgrid.edit.bClose);
                  }
                  return !0;
                }
              });
              ...
              switch (a(this).get(0).type) {
                case 'checkbox':
                  a(this).is(':checked')
                    ...
                    : ((b = a(this).attr('offval')), (l[this.name] = b));
                  break;
                case 'select-one':
        ...
        function h(c, e, n, f) {
          ...
          a(e.p.colModel).each(function(t) {
            k = this.name;
            m = (l = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1)
              ? "style='display:none'"
              : '';
            if ('cb' !== k && 'subgrid' !== k && !0 === this.editable && 'rn' !== k) {
              if (!1 === u) q = '';
                ...
                try {
                  q = a.unformat.call(
                    e,
                    a("td[role='gridcell']:eq(" + t + ')', e.rows[u]),
                  ...
                  q =
                    this.edittype && 'textarea' === this.edittype
                      ? a("td[role='gridcell']:eq(" + t + ')', e.rows[u]).text()
                      : a("td[role='gridcell']:eq(" + t + ')', e.rows[u]).html();
                }
                if (!q || '&nbsp;' === q || '&#160;' === q || (1 === q.length && 160 === q.charCodeAt(0))) q = '';
              }
              var s = a.extend({}, this.editoptions || {}, { id: k, name: k }),
                y = a.extend(
                  {},
                  { elmprefix: '', elmsuffix: '', rowabove: !1, rowcontent: '' },
                  this.formoptions || {}
                ),
              ...
              '_empty' === c &&
                s.defaultValue &&
                (q = a.isFunction(s.defaultValue) ? s.defaultValue.call(d) : s.defaultValue);
              this.edittype || (this.edittype = 'text');
              d.p.autoencode && (q = a.jgrid.htmlDecode(q));
              r = a.jgrid.createEl.call(
                d,
                this.edittype,
                s,
                q,
                !1,
                a.extend({}, a.jgrid.ajaxOptions, e.p.ajaxSelectOptions || {})
              );
              if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) b[d.p.id]._savedData[k] = q;
              a(r).addClass('FormElement');
              -1 < a.inArray(this.edittype, ['text', 'textarea', 'password', 'select']) &&
                a(r).addClass('ui-widget-content ui-corner-all');
              ...
              'custom' === this.edittype &&
                a.isFunction(s.custom_value) &&
                s.custom_value.call(d, a('#' + k, '#' + g), 'set', q);
          ...
          0 < h &&
            ...
            (t[0].rp = h + 999),
            a(n).append(t),
            b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) &&
        ...
        function w(c, e, n) {
          ...
          if ('_empty' === c)
            a(m).each(function() {
              ...
              (l = a('#' + a.jgrid.jqID(g), '#' + n)) &&
                l.length &&
                null !== l[0] &&
                ((h = ''),
                'custom' === this.edittype && a.isFunction(q.custom_value)
                  ? q.custom_value.call(d, a('#' + g, '#' + n), 'set', h)
                  : q.defaultValue
                    ? ((h = a.isFunction(q.defaultValue) ? q.defaultValue.call(d) : q.defaultValue),
                      'checkbox' === l[0].type
                        ? ((r = h.toLowerCase()),
                          0 > r.search(/(false|f|0|no|n|off|undefined)/i) && '' !== r
                            ? ((l[0].checked = !0), (l[0].defaultChecked = !0), (l[0].value = h))
                            : ((l[0].checked = !1), (l[0].defaultChecked = !1)))
                        : l.val(h))
                    : 'checkbox' === l[0].type
                      ? ((l[0].checked = !1), (l[0].defaultChecked = !1), (h = a(l).attr('offval')))
                      : l[0].type && 'select' === l[0].type.substr(0, 6)
                        ? (l[0].selectedIndex = 0)
                        : l.val(h),
                !0 === b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate) &&
                (b[d.p.id]._savedData[g] = h);
            }),
              a('#id_g', '#' + n).val(c);
          else {
            var t = a(e).jqGrid('getInd', c, !0);
            t &&
              (a('td[role="gridcell"]', t).each(function(l) {
                g = m[l].name;
                  ...
                  switch (m[l].edittype) {
                    ...
                    case 'select':
                      ...
                      a('#' + g + ' option', '#' + n).each(function() {
                        m[l].editoptions.multiple ||
                        (a.trim(f) !== a.trim(a(this).text()) &&
                          h[0] !== a.trim(a(this).text()) &&
                          h[0] !== a.trim(a(this).val()))
                          ? m[l].editoptions.multiple
                            ? -1 < a.inArray(a.trim(a(this).text()), h) || -1 < a.inArray(a.trim(a(this).val()), h)
                              ? (this.selected = !0)
                              : (this.selected = !1)
                            : (this.selected = !1)
                          : (this.selected = !0);
                    ...
                    case 'checkbox':
                      ...
                      if (m[l].editoptions && m[l].editoptions.value)
                        ...
                        else a('#' + g, '#' + n)[d.p.useProp ? 'prop' : 'attr']({ checked: !1, defaultChecked: !1 });
                      else
                        (f = f.toLowerCase()),
                          0 > f.search(/(false|f|0|no|n|off|undefined)/i) && '' !== f
                            ? (a('#' + g, '#' + n)[d.p.useProp ? 'prop' : 'attr']('checked', !0),
                              a('#' + g, '#' + n)[d.p.useProp ? 'prop' : 'attr']('defaultChecked', !0))
                            : (a('#' + g, '#' + n)[d.p.useProp ? 'prop' : 'attr']('checked', !1),
                              a('#' + g, '#' + n)[d.p.useProp ? 'prop' : 'attr']('defaultChecked', !1));
                      break;
                    case 'custom':
                      try {
                        ...
                        'e1' === p
                          ...
                          : a.jgrid.info_dialog(a.jgrid.errors.errcap, p.message, a.jgrid.edit.bClose);
                      }
                  }
                  k++;
                }
        ...
        function s() {
          ...
          a.isFunction(b[d.p.id].beforeCheckValues) &&
            (C = b[d.p.id].beforeCheckValues.call(d, l, a('#' + g), B)) &&
            'object' === typeof C &&
            (l = C);
          for (r in l) if (l.hasOwnProperty(r) && ((n = a.jgrid.checkValues.call(d, l[r], r)), !1 === n[0])) break;
          t();
          n[0] &&
            ((f = a(d).triggerHandler('jqGridAddEditClickSubmit', [b[d.p.id], l, B])),
            void 0 === f &&
              a.isFunction(b[d.p.id].onclickSubmit) &&
              (f = b[d.p.id].onclickSubmit.call(d, b[d.p.id], l, B) || {}),
            (n = a(d).triggerHandler('jqGridAddEditBeforeSubmit', [l, a('#' + g), B])),
            void 0 === n && (n = [!0, '', '']),
            n[0] && a.isFunction(b[d.p.id].beforeSubmit) && (n = b[d.p.id].beforeSubmit.call(d, l, a('#' + g), B)));
          if (n[0] && !b[d.p.id].processing) {
            ...
            if (!0 === d.p.treeGrid)
              for (s in (l[m] === k.addoper &&
                ((u = a(d).jqGrid('getGridParam', 'selrow')),
                (l['adjacency' === d.p.treeGridModel ? d.p.treeReader.parent_id_field : 'parent_id'] = u)),
              d.p.treeReader))
                d.p.treeReader.hasOwnProperty(s) &&
                  ((f = d.p.treeReader[s]),
                  !l.hasOwnProperty(f) || (l[m] === k.addoper && 'parent_id_field' === s) || delete l[f]);
            ...
            s = a.extend(
              {
                ...
                complete: function(f, r) {
                  ...
                  300 <= f.status && 304 !== f.status
                    ? ((n[0] = !1),
                      (n[1] = a(d).triggerHandler('jqGridAddEditErrorTextFormat', [f, B])),
                      a.isFunction(b[d.p.id].errorTextFormat)
                        ? (n[1] = b[d.p.id].errorTextFormat.call(d, f, B))
                        : (n[1] = r + " Status: '" + f.statusText + "'. Error code: " + f.status))
                    : ((n = a(d).triggerHandler('jqGridAddEditAfterSubmit', [f, l, B])),
                      void 0 === n && (n = [!0, '', '']),
                      n[0] && a.isFunction(b[d.p.id].afterSubmit) && (n = b[d.p.id].afterSubmit.call(d, f, l, B)));
                  if (!1 === n[0]) a('#FormError>td', p).html(n[1]), a('#FormError', p).show();
                    ...
                    l[m] === k.addoper
                      ? (n[2] || (n[2] = a.jgrid.randId()),
                        ...
                        b[d.p.id].reloadAfterSubmit
                          ...
                          : !0 === d.p.treeGrid
                            ? a(d).jqGrid('addChildNode', n[2], u, l)
                            : a(d).jqGrid('addRowData', n[2], l, c.addedrow),
                        b[d.p.id].closeAfterAdd
                          ? (!0 !== d.p.treeGrid && a(d).jqGrid('setSelection', n[2]),
                            a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
                              gb: '#gbox_' + a.jgrid.jqID(v),
                              jqm: c.jqModal,
                              onClose: b[d.p.id].onClose
                            }))
                          : b[d.p.id].clearAfterAdd && w('_empty', d, g))
                      : (b[d.p.id].reloadAfterSubmit
                          ? (a(d).trigger('reloadGrid'),
                          ...
                          : !0 === d.p.treeGrid
                            ? a(d).jqGrid('setTreeRow', l[h], l)
                            : a(d).jqGrid('setRowData', l[h], l),
                        b[d.p.id].closeAfterEdit &&
                          a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
                            gb: '#gbox_' + a.jgrid.jqID(v),
                            jqm: c.jqModal,
                    ...
                    a.isFunction(b[d.p.id].afterComplete) &&
                      ((e = f),
                      setTimeout(function() {
              ...
              a.jgrid.ajaxOptions,
              b[d.p.id].ajaxEditOptions
            );
            s.url ||
              b[d.p.id].useDataProxy ||
              (a.isFunction(d.p.dataProxy)
                ? (b[d.p.id].useDataProxy = !0)
                : ((n[0] = !1), (n[1] += ' ' + a.jgrid.errors.nourl)));
            n[0] &&
              (b[d.p.id].useDataProxy
                ? ((f = d.p.dataProxy.call(d, s, 'set_' + d.p.id)),
                  void 0 === f && (f = [!0, '']),
                  !1 === f[0]
                    ? ((n[0] = !1), (n[1] = f[1] || 'Error deleting the selected row!'))
                    : (s.data.oper === k.addoper &&
                        b[d.p.id].closeAfterAdd &&
                        a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
                          gb: '#gbox_' + a.jgrid.jqID(v),
                          jqm: c.jqModal,
        ...
        function f() {
          ...
          b[d.p.id].checkOnUpdate &&
            ((l = {}), e(), (M = r(l, b[d.p.id]._savedData))) &&
            (a('#' + g).data('disabled', !0), a('.confirm', '#' + q.themodal).show(), (c = !1));
          return c;
        }
        function k() {
          var b;
        ...
        function u(b, c) {
          var d = c[1].length - 1;
          0 === b
            ? a('#pData', p + '_2').addClass('ui-state-disabled')
            : void 0 !== c[1][b - 1] && a('#' + a.jgrid.jqID(c[1][b - 1])).hasClass('ui-state-disabled')
              ? a('#pData', p + '_2').addClass('ui-state-disabled')
              : a('#pData', p + '_2').removeClass('ui-state-disabled');
          b === d
            ? a('#nData', p + '_2').addClass('ui-state-disabled')
            : void 0 !== c[1][b + 1] && a('#' + a.jgrid.jqID(c[1][b + 1])).hasClass('ui-state-disabled')
              ? a('#nData', p + '_2').addClass('ui-state-disabled')
              : a('#nData', p + '_2').removeClass('ui-state-disabled');
        }
        function x() {
        ...
        if (d.grid && z) {
          var v = d.p.id,
            ...
            m = 'TblGrid_' + v,
            p = '#' + a.jgrid.jqID(m),
            q = { themodal: 'editmod' + v, modalhead: 'edithd' + v, modalcontent: 'editcnt' + v, scrollelm: g },
          ...
          if (!1 !== n) {
            ...
            a(H).append(F);
            A = a(
              "<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + 2 * C + "'></td></tr>"
            );
            A[0].rp = 0;
            a(F).append(A);
            A = a(
            ...
            a('#' + a.jgrid.jqID(q.themodal)).keydown(function(e) {
              ...
              if (!0 === b[d.p.id].savekey[0] && e.which === b[d.p.id].savekey[1] && 'TEXTAREA' !== n.tagName)
                return a('#sData', p + '_2').trigger('click'), !1;
              if (27 === e.which) {
                if (!f()) return !1;
                O &&
                  a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
            ...
            c.checkOnUpdate &&
              (a('a.ui-jqdialog-titlebar-close span', '#' + a.jgrid.jqID(q.themodal)).removeClass('jqmClose'),
              a('a.ui-jqdialog-titlebar-close', '#' + a.jgrid.jqID(q.themodal))
                .unbind('click')
                .click(function() {
                  if (!f()) return !1;
                  a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
            ...
            !0 === c.saveicon[0] &&
              a('#sData', p + '_2')
                .addClass('right' === c.saveicon[1] ? 'fm-button-icon-right' : 'fm-button-icon-left')
                .append("<span class='ui-icon " + c.saveicon[2] + "'></span>");
            !0 === c.closeicon[0] &&
              a('#cData', p + '_2')
                .addClass('right' === c.closeicon[1] ? 'fm-button-icon-right' : 'fm-button-icon-left')
                .append("<span class='ui-icon " + c.closeicon[2] + "'></span>");
            if (b[d.p.id].checkOnSubmit || b[d.p.id].checkOnUpdate)
              (J =
            ...
            E && E.call(d, a('#' + g), B);
            '_empty' !== z && b[d.p.id].viewPagerButtons
              ? a('#pData,#nData', p + '_2').show()
            ...
            N ||
              a('.' + a.jgrid.jqID(c.overlayClass)).click(function() {
                if (!f()) return !1;
                a.jgrid.hideModal('#' + a.jgrid.jqID(q.themodal), {
                  gb: '#gbox_' + a.jgrid.jqID(v),
                  jqm: c.jqModal,
            ...
            a('.fm-button', '#' + a.jgrid.jqID(q.themodal)).hover(
              function() {
                a(this).addClass('ui-state-hover');
              },
              function() {
            ...
            a('#sData', p + '_2').click(function() {
              ...
              '_empty' === l[d.p.id + '_id']
                ? s()
                : !0 === c.checkOnSubmit
                  ? (M = r(l, b[d.p.id]._savedData))
                    ? (a('#' + g).data('disabled', !0), a('.confirm', '#' + a.jgrid.jqID(q.themodal)).show())
                    : s()
                  : s();
              return !1;
            });
              ...
              if (-1 !== b[0] && b[1][b[0] + 1]) {
                ...
                if (
                  (a.isFunction(c.onclickPgButtons) &&
                    ((e = c.onclickPgButtons.call(d, 'next', a('#' + g), b[1][b[0]])), void 0 !== e && !1 === e)) ||
                  a('#' + a.jgrid.jqID(b[1][b[0] + 1])).hasClass('ui-state-disabled')
                )
                  return !1;
                w(b[1][b[0] + 1], d, g);
                ...
                a.isFunction(c.afterclickPgButtons) &&
                  c.afterclickPgButtons.call(d, 'next', a('#' + g), b[1][b[0] + 1]);
                u(b[0] + 1, b);
              }
              return !1;
            });
            a('#pData', p + '_2').click(function() {
              ...
              if (-1 !== b[0] && b[1][b[0] - 1]) {
                ...
                if (
                  (a.isFunction(c.onclickPgButtons) &&
                    ((e = c.onclickPgButtons.call(d, 'prev', a('#' + g), b[1][b[0]])), void 0 !== e && !1 === e)) ||
                  a('#' + a.jgrid.jqID(b[1][b[0] - 1])).hasClass('ui-state-disabled')
                )
                  return !1;
                w(b[1][b[0] - 1], d, g);
                ...
                a.isFunction(c.afterclickPgButtons) &&
                  c.afterclickPgButtons.call(d, 'prev', a('#' + g), b[1][b[0] - 1]);
                u(b[0] - 1, b);
              }
              return !1;
            });
    ...
    viewGridRow: function(z, c) {
      ...
      return this.each(function() {
        function e() {
          (!0 !== b[r.p.id].closeOnEscape && !0 !== b[r.p.id].navkeys[0]) ||
            setTimeout(function() {
        ...
        function h(b, d, e, f) {
          ...
          a(d.p.colModel).each(function() {
            (k = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1) ||
              'right' !== this.align ||
              (this.formatter && -1 !== a.inArray(this.formatter, z)
          ...
          a(d.p.colModel).each(function(b) {
            g = this.name;
            x = !1;
            p = (k = this.editrules && !0 === this.editrules.edithidden ? !1 : !0 === this.hidden ? !0 : !1)
              ? "style='display:none'"
              : '';
            ...
            if ('cb' !== g && 'subgrid' !== g && 'rn' !== g && D) {
              m =
                !1 === s
                  ? ''
                  : g === d.p.ExpandColumn && !0 === d.p.treeGrid
                    ? a('td:eq(' + b + ')', d.rows[s]).text()
                    : a('td:eq(' + b + ')', d.rows[s]).html();
        ...
        function w(b, c) {
          ...
          if ((k = a(c).jqGrid('getInd', b, !0)))
            a('td', k).each(function(b) {
              ...
              e =
                c.p.colModel[b].editrules && !0 === c.p.colModel[b].editrules.edithidden
                  ? !1
              ...
              'cb' !== d &&
                'subgrid' !== d &&
                'rn' !== d &&
                ((g = d === c.p.ExpandColumn && !0 === c.p.treeGrid ? a(this).text() : a(this).html()),
                (d = a.jgrid.jqID('v_' + d)),
                a('#' + d + ' span', '#' + u).html(g),
                e &&
                  a('#' + d, '#' + u)
        ...
        function t(b, c) {
          var d = c[1].length - 1;
          0 === b
            ? a('#pData', '#' + u + '_2').addClass('ui-state-disabled')
            : void 0 !== c[1][b - 1] && a('#' + a.jgrid.jqID(c[1][b - 1])).hasClass('ui-state-disabled')
              ? a('#pData', u + '_2').addClass('ui-state-disabled')
              : a('#pData', '#' + u + '_2').removeClass('ui-state-disabled');
          b === d
            ? a('#nData', '#' + u + '_2').addClass('ui-state-disabled')
            : void 0 !== c[1][b + 1] && a('#' + a.jgrid.jqID(c[1][b + 1])).hasClass('ui-state-disabled')
              ? a('#nData', u + '_2').addClass('ui-state-disabled')
              : a('#nData', '#' + u + '_2').removeClass('ui-state-disabled');
        }
        function s() {
        ...
        if (r.grid && z) {
          var f = r.p.id,
            ...
            x = 'ViewGrid_' + f,
            d = 'ViewTbl_' + f,
            v = { themodal: 'viewmod' + f, modalhead: 'viewhd' + f, modalcontent: 'viewcnt' + f, scrollelm: k },
          ...
          var y = isNaN(b[a(this)[0].p.id].dataheight)
              ? b[a(this)[0].p.id].dataheight
              : b[a(this)[0].p.id].dataheight + 'px',
          ...
          if (!1 !== m) {
            ...
            d &&
              (a('#pData, #nData', '#' + u + '_2').css('float', 'right'),
              a('.EditButton', '#' + u + '_2').css('text-align', 'left'));
            ...
            a('.fm-button:not(.ui-state-disabled)', '#' + u + '_2').hover(
              function() {
                a(this).addClass('ui-state-hover');
              },
              function() {
            ...
            a('#nData', '#' + u + '_2').click(function() {
              ...
              -1 !== b[0] &&
                b[1][b[0] + 1] &&
                (a.isFunction(c.onclickPgButtons) && c.onclickPgButtons.call(r, 'next', a('#' + k), b[1][b[0]]),
                w(b[1][b[0] + 1], r),
                a(r).jqGrid('setSelection', b[1][b[0] + 1]),
                a.isFunction(c.afterclickPgButtons) &&
                  c.afterclickPgButtons.call(r, 'next', a('#' + k), b[1][b[0] + 1]),
                t(b[0] + 1, b));
              e();
              return !1;
            });
            a('#pData', '#' + u + '_2').click(function() {
              ...
              -1 !== b[0] &&
                b[1][b[0] - 1] &&
                (a.isFunction(c.onclickPgButtons) && c.onclickPgButtons.call(r, 'prev', a('#' + k), b[1][b[0]]),
                w(b[1][b[0] - 1], r),
                a(r).jqGrid('setSelection', b[1][b[0] - 1]),
                a.isFunction(c.afterclickPgButtons) &&
                  c.afterclickPgButtons.call(r, 'prev', a('#' + k), b[1][b[0] - 1]),
                t(b[0] - 1, b));
              e();
              return !1;
            });
        ...
        if (e.grid && z) {
          ...
          if (void 0 !== a('#' + a.jgrid.jqID(m.themodal))[0]) {
            ...
            !0 === b[e.p.id].processing &&
              ((b[e.p.id].processing = !1), a('#dData', '#' + k).removeClass('ui-state-active'));
            ...
            var p = isNaN(b[e.p.id].dataheight) ? b[e.p.id].dataheight : b[e.p.id].dataheight + 'px',
              ...
              g =
                ...
                ("<table cellspacing='0' cellpadding='0' border='0' class='EditTable' id='" +
                  ...
                  ("<a id='dData' class='fm-button ui-state-default ui-corner-all'>" + c.bSubmit + '</a>') +
                  '&#160;' +
                  ("<a id='eData' class='fm-button ui-state-default ui-corner-all'>" + c.bCancel + '</a>') +
                  '</td></tr></tbody></table>');
            c.gbox = '#gbox_' + a.jgrid.jqID(s);
            a.jgrid.createModal(m, g, c, '#gview_' + a.jgrid.jqID(e.p.id), a('#gview_' + a.jgrid.jqID(e.p.id))[0]);
            t && ((f = t.call(e, a('#' + k))), void 0 === f && (f = !0));
            if (!1 === f) return;
            a('.fm-button', '#' + k + '_2').hover(
              function() {
                a(this).addClass('ui-state-hover');
              },
              function() {
            ...
            !0 === c.delicon[0] &&
              a('#dData', '#' + k + '_2')
                .addClass('right' === c.delicon[1] ? 'fm-button-icon-right' : 'fm-button-icon-left')
                .append("<span class='ui-icon " + c.delicon[2] + "'></span>");
            !0 === c.cancelicon[0] &&
              a('#eData', '#' + k + '_2')
                .addClass('right' === c.cancelicon[1] ? 'fm-button-icon-right' : 'fm-button-icon-left')
                .append("<span class='ui-icon " + c.cancelicon[2] + "'></span>");
              ...
              if (f[0] && !b[e.p.id].processing) {
                ...
                g = a.extend(
                  {
                    ...
                    complete: function(d, g) {
                      var q;
                      300 <= d.status && 304 !== d.status
                        ? ((f[0] = !1),
                          a.isFunction(b[e.p.id].errorTextFormat)
                            ? (f[1] = b[e.p.id].errorTextFormat.call(e, d))
                            : (f[1] = g + " Status: '" + d.statusText + "'. Error code: " + d.status))
                        : a.isFunction(b[e.p.id].afterSubmit) && (f = b[e.p.id].afterSubmit.call(e, d, u));
                ...
                g.url ||
                  ...
                  (a.isFunction(e.p.dataProxy)
                    ...
                    : ((f[0] = !1), (f[1] += ' ' + a.jgrid.errors.nourl)));
                f[0] &&
                  (b[e.p.id].useDataProxy
                    ? ((g = e.p.dataProxy.call(e, g, 'del_' + e.p.id)),
                      void 0 === g && (g = [!0, '']),
                      !1 === g[0]
                        ? ((f[0] = !1), (f[1] = g[1] || 'Error deleting the selected row!'))
                        : a.jgrid.hideModal('#' + a.jgrid.jqID(m.themodal), {
                            gb: '#gbox_' + a.jgrid.jqID(s),
                            jqm: c.jqModal,
                            onClose: b[e.p.id].onClose
        ...
        if (!this.nav) {
          ...
          if (f.grid && 'string' === typeof b) {
            void 0 === a('#' + r.themodal)[0] &&
              ...
              a.jgrid.createModal(
                r,
                '<div>' + c.alerttext + "</div><span tabindex='0'><span tabindex='-1' id='jqg_alrt'></span></span>",
                {
            ...
            for (x = 0; x < u; x++) {
              var g = a(
                ...
                p;
              0 === x
                ? ((m = b), (p = f.p.id), m === f.p.toppager && ((p += '_top'), (u = 1)))
                : ((m = f.p.toppager), (p = f.p.id + '_top'));
              'rtl' === f.p.direction &&
                a(g)
                  .attr('dir', 'rtl')
                  .css('float', 'right');
              c.add &&
                ...
                a(k).append(
                  "<div class='ui-pg-div'><span class='ui-icon " + c.addicon + "'></span>" + c.addtext + '</div>'
                ),
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.addtitle || '', id: h.id || 'add_' + p })
                  .click(function() {
                    a(this).hasClass('ui-state-disabled') ||
                      (a.isFunction(c.addfunc) ? c.addfunc.call(f) : a(f).jqGrid('editGridRow', 'new', h));
                    return !1;
                  })
                  .hover(d, v),
                (k = null));
              c.edit &&
                ...
                (e = e || {}),
                a(k).append(
                  "<div class='ui-pg-div'><span class='ui-icon " + c.editicon + "'></span>" + c.edittext + '</div>'
                ),
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.edittitle || '', id: e.id || 'edit_' + p })
                  .click(function() {
                    if (!a(this).hasClass('ui-state-disabled')) {
                      ...
                      b
                        ? a.isFunction(c.editfunc)
                          ? c.editfunc.call(f, b)
                          : a(f).jqGrid('editGridRow', b, e)
                        : (a.jgrid.viewModal('#' + r.themodal, { gbox: '#gbox_' + a.jgrid.jqID(f.p.id), jqm: !0 }),
                          a('#jqg_alrt').focus());
                    }
                    return !1;
                  })
              ...
              c.view &&
                ...
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.viewtitle || '', id: s.id || 'view_' + p })
                  .click(function() {
                    if (!a(this).hasClass('ui-state-disabled')) {
                      var b = f.p.selrow;
                      b
              ...
              c.del &&
                ...
                (w = w || {}),
                a(k).append(
                  "<div class='ui-pg-div'><span class='ui-icon " + c.delicon + "'></span>" + c.deltext + '</div>'
                ),
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.deltitle || '', id: w.id || 'del_' + p })
                  .click(function() {
                    if (!a(this).hasClass('ui-state-disabled')) {
                      var b;
              ...
              c.search &&
                ...
                (t = t || {}),
                a(k).append(
                  "<div class='ui-pg-div'><span class='ui-icon " + c.searchicon + "'></span>" + c.searchtext + '</div>'
                ),
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.searchtitle || '', id: t.id || 'search_' + p })
                  .click(function() {
                    a(this).hasClass('ui-state-disabled') ||
                      (a.isFunction(c.searchfunc) ? c.searchfunc.call(f, t) : a(f).jqGrid('searchGrid', t));
                    return !1;
                  })
                  .hover(d, v),
                t.showOnLoad && !0 === t.showOnLoad && a(k, g).click(),
                (k = null));
              c.refresh &&
                ((k = a("<td class='ui-pg-button ui-corner-all'></td>")),
                a(k).append(
                ...
                a('tr', g).append(k),
                a(k, g)
                  .attr({ title: c.refreshtitle || '', id: 'refresh_' + p })
                  .click(function() {
                    if (!a(this).hasClass('ui-state-disabled')) {
                      ...
                      switch (c.refreshstate) {
                        case 'firstpage':
                          ...
                          break;
                        case 'current':
                          a(f).trigger('reloadGrid', [{ current: !0 }]);
                      }
              ...
              f.p._nvtd &&
                (k > f.p._nvtd[0] && (a(m + '_' + c.position, m).width(k), (f.p._nvtd[0] = k)), (f.p._nvtd[1] = k));
              g = k = k = null;
              this.nav = !0;
            }
          }
          ...
          if (e && (!c.id || void 0 === a('#' + a.jgrid.jqID(c.id), e)[0])) {
            ...
            'NONE' === c.buttonicon.toString().toUpperCase()
              ...
              : a(w)
                  .addClass('ui-pg-button ui-corner-all')
                  .append(
                    "<div class='ui-pg-div'><span class='ui-icon " + c.buttonicon + "'></span>" + c.caption + '</div>'
                  );
            c.id && a(w).attr('id', c.id);
            'first' === c.position
              ? 0 === e.rows[0].cells.length
                ? a('tr', e).append(w)
                : a('tr td:eq(0)', e).before(w)
              : a('tr', e).append(w);
            a(w, e)
              .attr('title', c.title || '')
              .click(function(b) {
      ...
      return this.each(function() {
        ...
        if (e.grid) {
          ...
          if (w)
            for (h in w)
              w.hasOwnProperty(h) &&
                (a('[name=' + a.jgrid.jqID(h) + ']', c).is('input:radio') ||
                a('[name=' + a.jgrid.jqID(h) + ']', c).is('input:checkbox')
                  ? a('[name=' + a.jgrid.jqID(h) + ']', c).each(function() {
  ...
  a.fn.jqFilter = function(d) {
    ...
    return this.each(function() {
      if (!this.filter) {
        ...
        var d,
          q = this.p.columns.length,
          f,
          w = /msie/i.test(navigator.userAgent) && !window.opera;
        ...
        if (q) {
          ...
          this.createTableForGroup = function(g, l) {
            ...
            if (!0 === this.p.ruleButtons) {
              ...
              for (c = 0; c < n.groupOps.length; c++)
                (k = g.groupOp === b.p.groupOps[c].op ? " selected='selected'" : ''),
            ...
            h = '<span></span>';
            this.p.groupButton &&
              ((h = a("<input type='button' value='+ {}' title='Add subgroup' class='add-group'/>")),
            ...
            if (!0 === this.p.ruleButtons) {
              ...
              h.bind('click', function() {
                ...
                e = f.searchoptions.sopt
                  ...
                  : b.p.sopt
                    ? b.p.sopt
                    : -1 !== a.inArray(f.searchtype, b.p.strarr)
                      ? b.p.stropts
                      : b.p.numopts;
            ...
            null !== l &&
              ((h = a("<input type='button' value='-' title='Delete group' class='delete-group'/>")),
              e.append(h),
              h.bind('click', function() {
          ...
          this.createTableRowForRule = function(g, l) {
            ...
            q.bind('change', function() {
              ...
              if (k) {
                ...
                h = k.searchoptions.sopt
                  ? k.searchoptions.sopt
                  : b.p.sopt
                    ? b.p.sopt
                    : -1 !== a.inArray(k.searchtype, b.p.strarr)
                      ? b.p.stropts
                      : b.p.numopts;
                var l = '',
                  m = 0;
                ...
                for (e = 0; e < h.length; e++)
                  (r = a.inArray(h[e], t)),
                    -1 !== r &&
                      (0 === m && (g.op = b.p.ops[r].oper),
                      (l += "<option value='" + b.p.ops[r].oper + "'>" + b.p.ops[r].text + '</option>'),
                      m++);
                a('.selectopts', f)
                  .empty()
                  .append(l);
                ...
                a.jgrid.msie &&
                  9 > a.jgrid.msiever() &&
                  ((l = parseInt(a('select.selectopts', f)[0].offsetWidth, 10) + 1),
                  a('.selectopts', f).width(l),
                  a('.selectopts', f).css('width', 'auto'));
                a('.data', f)
                  .empty()
                  .append(d);
                ...
                a('.input-elm', f).bind('change', function(e) {
                  e = e.target;
                  g.data =
                    'SPAN' === e.nodeName.toUpperCase() && k.searchoptions && a.isFunction(k.searchoptions.custom_value)
                      ? k.searchoptions.custom_value.call(c, a(e).children('.customelement:first'), 'get')
                      : e.value;
                  b.onchange();
                });
                setTimeout(function() {
            ...
            k.searchoptions.id = a.jgrid.randId();
            w && 'text' === k.inputtype && !k.searchoptions.size && (k.searchoptions.size = 10);
            p = a.jgrid.createEl.call(c, k.inputtype, k.searchoptions, g.data, !0, b.p.ajaxSelectOptions || {}, !0);
            ...
            v.bind('change', function() {
              ...
              'nu' === g.op || 'nn' === g.op
                ...
                : ('SELECT' === c.tagName.toUpperCase() && (g.data = c.value),
            ...
            for (e = 0; e < h.length; e++)
              (r = a.inArray(h[e], t)),
                -1 !== r &&
                  ((s = g.op === b.p.ops[r].oper ? " selected='selected'" : ''),
                  (d += "<option value='" + b.p.ops[r].oper + "'" + s + '>' + b.p.ops[r].text + '</option>'));
            v.append(d);
            ...
            a(p)
              ...
              .bind('change', function() {
                g.data =
                  'custom' === k.inputtype
                    ? k.searchoptions.custom_value.call(c, a(this).children('.customelement:first'), 'get')
                    : a(this).val();
                b.onchange();
              });
            d = a('<td></td>');
            ...
            !0 === this.p.ruleButtons &&
              ((p = a("<input type='button' value='-' title='Delete rule' class='delete-rule ui-del'/>")),
              d.append(p),
          ...
          this.getStringForRule = function(d) {
            ...
            return -1 !== a.inArray(m.searchtype, ['int', 'integer', 'float', 'number', 'currency']) ||
              'nn' === b ||
              'nu' === b
              ? d.field + ' ' + f + ' ' + c
              : d.field + ' ' + f + ' "' + c + '"';
  ...
  a.jgrid.extend({
    editRow: function(c, e, b, l, h, n, p, g, f) {
      ...
      'object' === a.type(d[0])
        ? (m = d[0])
        : (void 0 !== e && (m.keys = e),
          a.isFunction(b) && (m.oneditfunc = b),
          a.isFunction(l) && (m.successfunc = l),
          void 0 !== h && (m.url = h),
          void 0 !== n && (m.extraparam = n),
          a.isFunction(p) && (m.aftersavefunc = p),
          a.isFunction(g) && (m.errorfunc = g),
          a.isFunction(f) && (m.afterrestorefunc = f));
      m = a.extend(
        !0,
        {
          keys: !1,
      ...
      return this.each(function() {
        var d = this,
          ...
          q;
        d.grid &&
          ((l = a(d).jqGrid('getInd', c, !0)),
          !1 !== l &&
            ((b = a.isFunction(m.beforeEditRow) ? m.beforeEditRow.call(d, m, c) : void 0),
            void 0 === b && (b = !0),
            b &&
              ((b = a(l).attr('editable') || '0'),
              '0' !== b ||
                a(l).hasClass('not-editable-row') ||
                ((q = d.p.colModel),
                a('td[role="gridcell"]', l).each(function(b) {
                  f = q[b].name;
                  ...
                  if (
                    ...
                    'subgrid' !== f &&
                    'rn' !== f &&
                    (d.p.autoencode && (e = a.jgrid.htmlDecode(e)), (n[f] = e), !0 === q[b].editable)
                  ) {
                    null === h && (h = b);
                    ...
                    var x = a.jgrid.createEl.call(
                      d,
                      q[b].edittype,
                      p,
                      e,
                      !0,
                      a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})
                    );
                    a(x).addClass('editable');
                    l ? a('span:first', this).append(x) : a(this).append(x);
                    a.jgrid.bindEv.call(d, x, p);
                    'select' === q[b].edittype &&
                      void 0 !== q[b].editoptions &&
                      !0 === q[b].editoptions.multiple &&
                      void 0 === q[b].editoptions.dataUrl &&
                      a.jgrid.msie &&
                      a(x).width(a(x).width());
                    g++;
                  }
                ...
                0 < g &&
                  ...
                  a(d).triggerHandler('jqGridInlineEditRow', [c, m]),
                  a.isFunction(m.oneditfunc) && m.oneditfunc.call(d, c))))));
      });
    },
    saveRow: function(c, e, b, l, h, n, p) {
      ...
      'object' === a.type(g[0])
        ? (f = g[0])
        : (a.isFunction(e) && (f.successfunc = e),
          void 0 !== b && (f.url = b),
          void 0 !== l && (f.extraparam = l),
          a.isFunction(h) && (f.aftersavefunc = h),
          a.isFunction(n) && (f.errorfunc = n),
          a.isFunction(p) && (f.afterrestorefunc = p));
      var f = a.extend(
          !0,
          {
            successfunc: null,
      ...
      if (g) {
        ...
        if ('1' === g) {
                ...
                case 'custom':
                  try {
                    if (t.editoptions && a.isFunction(t.editoptions.custom_value)) {
                      if (
                        ((k[r] = t.editoptions.custom_value.call(d, a('.customelement', this), 'get')), void 0 === k[r])
                      )
                        throw 'e2';
                    } else throw 'e1';
                  } catch (g) {
                    'e1' === g &&
                      ...
                      'e2' === g
                        ...
                        : a.jgrid.info_dialog(a.jgrid.errors.errcap, g.message, a.jgrid.edit.bClose);
                  }
              }
          ...
          k &&
            ...
            void 0 === k[s] || '' === k[s]
              ? (k[s] = c)
              : u.id !== d.p.idPrefix + k[s] &&
                ((g = a.jgrid.stripPref(d.p.idPrefix, c)),
                void 0 !== d.p._index[g] && ((d.p._index[k[s]] = d.p._index[g]), delete d.p._index[g]),
                (c = d.p.idPrefix + k[s]),
                a(u).attr('id', c),
                d.p.selrow === q && (d.p.selrow = c),
                a.isArray(d.p.selarrrow) && ((g = a.inArray(q, d.p.selarrrow)), 0 <= g && (d.p.selarrrow[g] = c)),
                d.p.multiselect &&
                  ((g = 'jqg_' + d.p.id + '_' + c),
                  a('input.cbox', u)
                    .attr('id', g)
            ...
            (k = a.extend({}, k, d.p.inlineData, f.extraparam)));
          if ('clientArray' === f.url) {
            k = a.extend({}, k, y);
            d.p.autoencode &&
              a.each(k, function(d, b) {
                    ...
                    complete: function(b, e) {
                      ...
                      if ('success' === e) {
                        ...
                        if (!0 === g) {
                          ...
                          a(d).triggerHandler('jqGridInlineErrorSaveRow', [c, b, e, null, f]),
                    ...
                    error: function(b, e, g) {
                      ...
                      if (a.isFunction(f.errorfunc)) f.errorfunc.call(d, c, b, e, g);
                        ...
                        try {
                          a.jgrid.info_dialog(
                            a.jgrid.errors.errcap,
                            '<div class="ui-state-error">' + b + '</div>',
                            a.jgrid.edit.bClose,
                            { buttonalign: 'right' }
                          );
                        } catch (h) {
    ...
    restoreRow: function(c, e) {
      ...
      return this.each(function() {
        ...
        if (
          b.grid &&
          ((p = a(b).jqGrid('getInd', c, !0)),
          !1 !== p &&
            ((f = a.isFunction(l.beforeCancelRow) ? l.beforeCancelRow.call(b, l, sr) : void 0),
            void 0 === f && (f = !0),
            f))
        ) {
          for (f = 0; f < b.p.savedRow.length; f++)
            if (String(b.p.savedRow[f].id) === String(c)) {
              e = f;
              break;
            }
          if (0 <= e) {
            ...
            a.each(b.p.colModel, function() {
              !0 === this.editable &&
                b.p.savedRow[e].hasOwnProperty(this.name) &&
                (g[this.name] = b.p.savedRow[e][this.name]);
            });
            ...
            a('#' + a.jgrid.jqID(c), '#' + a.jgrid.jqID(b.p.id)).hasClass('jqgrid-new-row') &&
              setTimeout(function() {
    ...
    addRow: function(c) {
      ...
      return this.each(function() {
        if (this.grid) {
          ...
          void 0 === b && (b = !0);
          b &&
            ((c.rowID = a.isFunction(c.rowID) ? c.rowID.call(e, c) : null != c.rowID ? c.rowID : a.jgrid.randId()),
            !0 === c.useDefValues &&
            ...
            (c.rowID = e.p.idPrefix + c.rowID),
            a('#' + a.jgrid.jqID(c.rowID), '#' + a.jgrid.jqID(e.p.id)).addClass('jqgrid-new-row'),
            c.useFormatter
              ? a('#' + a.jgrid.jqID(c.rowID) + ' .ui-inline-edit', '#' + a.jgrid.jqID(e.p.id)).click()
              : ((b = e.p.prmNames),
          ...
          e.edit &&
            a(b).jqGrid('navButtonAdd', c, {
              ...
              onClickButton: function() {
                ...
                c
                  ? (a(b).jqGrid('editRow', c, e.editParams),
                    a('#' + h + '_ilsave').removeClass('ui-state-disabled'),
                    a('#' + h + '_ilcancel').removeClass('ui-state-disabled'),
                    a('#' + h + '_iladd').addClass('ui-state-disabled'),
                    a('#' + h + '_iledit').addClass('ui-state-disabled'))
              ...
              onClickButton: function() {
                ...
                if (c) {
                  var f = b.p.prmNames,
                    m = f.oper,
                    d = e.editParams;
                  a('#' + a.jgrid.jqID(c), '#' + h).hasClass('jqgrid-new-row')
                    ? ((e.addParams.addRowParams.extraparam[m] = f.addoper), (d = e.addParams.addRowParams))
                    : (e.editParams.extraparam || (e.editParams.extraparam = {}),
                      (e.editParams.extraparam[m] = f.editoper));
            ...
            (a(b).jqGrid('navButtonAdd', c, {
              ...
              onClickButton: function() {
                var c = b.p.savedRow[0].id,
                  f = e.editParams;
                c
                  ? (a('#' + a.jgrid.jqID(c), '#' + h).hasClass('jqgrid-new-row') && (f = e.addParams.addRowParams),
                    a(b).jqGrid('restoreRow', c, f),
                    a(b).jqGrid('showAddEditButtons'))
                  : (a.jgrid.viewModal('#alertmod', { gbox: '#gbox_' + h, jqm: !0 }), a('#jqg_alrt').focus());
              }
            }),
            a('#' + h + '_ilcancel').addClass('ui-state-disabled'));
          !0 === e.restoreAfterSelect &&
            ((l = a.isFunction(b.p.beforeSelectRow) ? b.p.beforeSelectRow : !1),
            (b.p.beforeSelectRow = function(c, f) {
              var h = !0;
              0 < b.p.savedRow.length &&
                !0 === b.p._inlinenav &&
                c !== b.p.selrow &&
                null !== b.p.selrow &&
                (b.p.selrow === e.addParams.rowID
                  ? a(b).jqGrid('delRowData', b.p.selrow)
                  : a(b).jqGrid('restoreRow', b.p.selrow, e.editParams),
                a(b).jqGrid('showAddEditButtons'));
              l && (h = l.call(b, c, f));
              return h;
            }));
          ...
          if ('subgrid' !== g && 'cb' !== g && 'rn' !== g) {
            ...
            if (!0 !== k.editable || !0 !== a || h.hasClass('not-editable-cell'))
              ...
              var l = b.extend({}, k.editoptions || {}, { id: d + '_' + g, name: g }),
                q = b.jgrid.createEl.call(
                  c,
                  k.edittype,
                  l,
                  e,
                  !0,
                  b.extend({}, b.jgrid.ajaxOptions, c.p.ajaxSelectOptions || {})
                );
              b(h)
                .html('')
                .append(q)
              ...
              b('input, select, textarea', h).bind('keydown', function(a) {
                27 === a.keyCode &&
                  (0 < b('input.hasDatepicker', h).length
            ...
            switch (k.edittype) {
              case 'select':
                if (k.editoptions.multiple) {
                  ...
                  (e = b('#' + d + '_' + l + ' option:selected', a.rows[d]).val()),
                ...
                try {
                  ...
                  'e1' === r &&
                    b.jgrid.info_dialog(
                      ...
                      "function 'custom_value' " + b.jgrid.edit.msg.nodefined,
                      b.jgrid.edit.bClose
                    ),
                    'e2' === r
                      ? b.jgrid.info_dialog(
                          b.jgrid.errors.errcap,
                          "function 'custom_value' " + b.jgrid.edit.msg.novalue,
                          b.jgrid.edit.bClose
                        )
                      : b.jgrid.info_dialog(b.jgrid.errors.errcap, r.message, b.jgrid.edit.bClose);
                }
            }
            if (h !== a.p.savedRow[c].v) {
              if ((c = b(a).triggerHandler('jqGridBeforeSaveCell', [a.rows[d].id, m, e, d, f]))) h = e = c;
              b.isFunction(a.p.beforeSaveCell) &&
                (c = a.p.beforeSaveCell.call(a, a.rows[d].id, m, e, d, f)) &&
                (h = e = c);
              ...
              if (!0 === s[0]) {
                ...
                b.isFunction(a.p.beforeSubmitCell) &&
                  ((c = a.p.beforeSubmitCell.call(a, a.rows[d].id, m, e, d, f)) || (c = {}));
                      ...
                      b.extend(
                        {
                          ...
                          complete: function(c, k) {
                            ...
                            a.grid.hDiv.loading = !1;
                            if ('success' === k) {
                              var l = b(a).triggerHandler('jqGridAfterSubmitCell', [a, c, p.id, m, e, d, f]) || [
                                !0,
                                ''
                              ];
                              !0 === l[0] &&
                                b.isFunction(a.p.afterSubmitCell) &&
                                (l = a.p.afterSubmitCell.call(a, c, p.id, m, e, d, f));
                              !0 === l[0]
                                ? (b(g).empty(),
                                  b(a).jqGrid('setCell', a.rows[d].id, f, h, !1, !1, !0),
                                  b(g).addClass('dirty-cell'),
                                  b(a.rows[d]).addClass('edited'),
                                  b(a).triggerHandler('jqGridAfterSaveCell', [a.rows[d].id, m, e, d, f]),
                                  b.isFunction(a.p.afterSaveCell) &&
                                    a.p.afterSaveCell.call(a, a.rows[d].id, m, e, d, f),
                                  a.p.savedRow.splice(0, 1))
                                : (b.jgrid.info_dialog(b.jgrid.errors.errcap, l[1], b.jgrid.edit.bClose),
                          ...
                          error: function(c, e, h) {
                            ...
                            b.isFunction(a.p.errorCell)
                              ? a.p.errorCell.call(a, c, e, h)
                              : b.jgrid.info_dialog(
                                  b.jgrid.errors.errcap,
                                  c.status + ' : ' + c.statusText + '<br/>' + e,
                                  b.jgrid.edit.bClose
                                );
                            b(a).jqGrid('restoreCell', d, f);
                          }
                ...
                'clientArray' === a.p.cellsubmit &&
                  ...
                  b(a.rows[d]).addClass('edited'),
                  b(a).triggerHandler('jqGridAfterSaveCell', [a.rows[d].id, m, e, d, f]),
                  b.isFunction(a.p.afterSaveCell) && a.p.afterSaveCell.call(a, a.rows[d].id, m, e, d, f),
                  a.p.savedRow.splice(0, 1));
              } else
                try {
                  window.setTimeout(function() {
      ...
      return this.each(function() {
        function d(c, d, e) {
          if ('v' === e.substr(0, 1)) {
            ...
            'vd' === e &&
              n >= f &&
              (b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop + a.rows[c].clientHeight);
            'vu' === e && r < g && (b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop - a.rows[c].clientHeight);
          }
          'h' === e &&
            ((e = b(a.grid.bDiv)[0].clientWidth),
          ...
          b('#' + a.p.knv)
            ...
            .keydown(function(c) {
              ...
              switch (e) {
                case 38:
                  0 < a.p.iRow - 1 &&
                    (d(a.p.iRow - 1, a.p.iCol, 'vu'), b(a).jqGrid('editCell', a.p.iRow - 1, a.p.iCol, !1));
                  break;
                case 40:
                  a.p.iRow + 1 <= a.rows.length - 1 &&
                    (d(a.p.iRow + 1, a.p.iCol, 'vd'), b(a).jqGrid('editCell', a.p.iRow + 1, a.p.iCol, !1));
                  break;
                case 37:
                  0 <= a.p.iCol - 1 &&
                    ((g = f(a.p.iCol - 1, 'lft')), d(a.p.iRow, g, 'h'), b(a).jqGrid('editCell', a.p.iRow, g, !1));
                  break;
                case 39:
                  a.p.iCol + 1 <= a.p.colModel.length - 1 &&
                    ((g = f(a.p.iCol + 1, 'rgt')), d(a.p.iRow, g, 'h'), b(a).jqGrid('editCell', a.p.iRow, g, !1));
                  break;
                case 13:
                  0 <= parseInt(a.p.iCol, 10) &&
                    0 <= parseInt(a.p.iRow, 10) &&
                    b(a).jqGrid('editCell', a.p.iRow, a.p.iCol, !0);
                  break;
                default:
                  return !0;
              }
    ...
    open: function(a, k) {
      ...
      e.modal
        ? (m[0] ||
          ...
          m.push(a))
        : 0 < e.overlay
          ? e.closeoverlay && b.w.jqmAddClose(g)
          : (g = d);
      b.o = g ? g.addClass(e.overlayClass).prependTo('body') : d;
      e.ajax
        ? ((f = e.target || b.w),
          (g = e.ajax),
          (f = 'string' == typeof f ? c(f, b.w) : c(f)),
          (g = '@' == g.substr(0, 1) ? c(k).attr(g.substring(1)) : g),
          f.html(e.ajaxText).load(g, function() {
...
(function(b) {
  ...
  b.jqDnR = {
    ...
    drag: function(a) {
      'd' == d.k
        ? e.css({ left: d.X + a.pageX - d.pX, top: d.Y + a.pageY - d.pY })
        : (e.css({ width: Math.max(a.pageX - d.pX + d.W, 0), height: Math.max(a.pageY - d.pY + d.H, 0) }),
    ...
    addSubGrid: function(d, c) {
      return this.each(function() {
        ...
        if (a.grid) {
          var p = function(c, d, h) {
            ...
            n = function(c, d) {
              var h,
                f,
                e,
                g = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                k = b('<tr></tr>');
                ...
                for (g = 0; g < a.p.subGridModel[0].params.length; g++)
                  for (f = 0; f < a.p.colModel.length; f++)
                    a.p.colModel[f].name === a.p.subGridModel[0].params[g] &&
                      (d[a.p.colModel[f].name] = b('td:eq(' + f + ')', c)
                        .text()
                        .replace(/\&#160\;/gi, ''));
              if (!a.grid.hDiv.loading)
                switch (
                  ((a.grid.hDiv.loading = !0),
                  b('#load_' + b.jgrid.jqID(a.p.id)).show(),
                  a.p.subgridtype || (a.p.subgridtype = a.p.datatype),
                  b.isFunction(a.p.subgridtype)
          ...
          for (; q < u; )
            b(a.rows[q]).hasClass('jqgrow') &&
              b(a.rows[q].cells[d]).bind('click', function() {
                ...
                if (b(this).hasClass('sgcollapsed')) {
                  ...
                  e = c.id;
                  if (
                    !0 === a.p.subGridOptions.reloadOnExpand ||
                    (!1 === a.p.subGridOptions.reloadOnExpand && !b(l).hasClass('ui-subgrid'))
                  ) {
                    s = 1 <= d ? "<td colspan='" + d + "'>&#160;</td>" : '';
                    g = b(a).triggerHandler('jqGridSubGridBeforeExpand', [m + '_' + e, e]);
                    (g = !1 === g || 'stop' === g ? !1 : !0) &&
                      b.isFunction(a.p.subGridBeforeExpand) &&
                      (g = a.p.subGridBeforeExpand.call(a, m + '_' + e, e));
                    if (!1 === g) return !1;
                    b(c).after(
                  ...
                  if (!1 === g) return !1;
                  !0 === a.p.subGridOptions.reloadOnExpand
                    ? b(l).remove('.ui-subgrid')
                    : b(l).hasClass('ui-subgrid') && b(l).hide();
                  b(this)
                    .html(
                      "<a style='cursor:pointer;'><span class='ui-icon " + a.p.subGridOptions.plusicon + "'></span></a>"
                    )
  ...
  d.extend(d.jgrid, {
    template: function(b) {
      ...
      return b.replace(/\{([\w\-]+)(?:\:([\w\.]*)(?:\((.*?)?\))?)?\}/g, function(b, m) {
        ...
        for (a = 0; a < c; a++)
          if (d.isArray(k[a])) for (var e = k[a], f = e.length; f--; ) if (m === e[f].nm) return e[f].v;
      });
    }
  });
  d.jgrid.extend({
      ...
      return this.each(function() {
        ...
        if (null === c || ('object' !== typeof c && !d.isFunction(c))) this.p.grouping = !1;
          ...
          for (b = 0; b < c.groupField.length; b++)
            c.groupOrder[b] || (c.groupOrder[b] = 'asc'),
              ...
              !0 === c.groupColumnShow[b]
                ? ((c.visibiltyOnNextGrouping[b] = !0), d(this).jqGrid('showCol', c.groupField[b]))
                : ((c.visibiltyOnNextGrouping[b] = d('#' + d.jgrid.jqID(this.p.id + '_' + c.groupField[b])).is(
                    ':visible'
                  )),
                  d(this).jqGrid('hideCol', c.groupField[b]));
          c.summary = [];
          c.hideFirstGroupCol &&
            (c.formatDisplayField[0] = function(a) {
              return a;
            });
          b = 0;
          for (k = a.length; b < k; b++)
            c.hideFirstGroupCol &&
              !a[b].hidden &&
              c.groupField[0] === a[b].name &&
              (a[b].formatter = function() {
                return '';
              }),
              a[b].summaryType &&
                (a[b].summaryDivider
            ...
            void 0 !== f &&
              (0 === k
                ? (a.groups.push({
                  ...
                  (a.lastvalues[g] = f),
                  (a.counters[g] = { cnt: 1, pos: a.groups.length - 1, summary: d.extend(!0, [], a.summary) }))
                : 'object' === typeof f ||
                  (d.isArray(a.isInTheSameGroup) && d.isFunction(a.isInTheSameGroup[g])
                    ? a.isInTheSameGroup[g].call(c, a.lastvalues[g], f, g, a)
                    : a.lastvalues[g] === f)
                  ? 1 === p
                    ? (a.groups.push({
                        idx: g,
                      ...
                      (a.lastvalues[g] = f),
                      (a.counters[g] = { cnt: 1, pos: a.groups.length - 1, summary: d.extend(!0, [], a.summary) }))
                    : ((a.counters[g].cnt += 1), (a.groups[a.counters[g].pos].cnt = a.counters[g].cnt))
                  : (a.groups.push({
                      idx: g,
                      dataIndex: e,
                      value: f,
              ...
              d.each(a.counters[g].summary, function() {
                d.isFunction(this.st)
                  ? (this.v = this.st.call(c, this.v, this.nm, b))
                  : ((this.v = d(c).jqGrid(
    ...
    groupingRender: function(b, k, a, c) {
      return this.each(function() {
        ...
        var e = this,
          ...
          r,
          q,
          n = f.groupCollapse ? f.plusicon : f.minusicon,
          t,
          y = [],
        ...
        d.each(f.groups, function(g, l) {
          ...
          p =
            ...
            '\');return false;"></span>';
          try {
            d.isArray(f.formatDisplayField) && d.isFunction(f.formatDisplayField[l.idx])
              ? ((l.displayValue = f.formatDisplayField[l.idx].call(
                  e,
                  l.displayValue,
                  l.value,
                  e.p.colModel[y[l.idx]],
                  l.idx,
                  f
                )),
                (t = l.displayValue))
              : (t = e.formatter(r, l.displayValue, y[l.idx], l.value));
          } catch (C) {
            t = l.displayValue;
          }
          'header' === f.groupSummaryPos[l.idx]
            ? ((h +=
                '<tr id="' +
                r +
                '"' +
                (f.groupCollapse && 0 < l.idx ? ' style="display:none;" ' : ' ') +
                ...
                'px;">' +
                p +
                d.jgrid.template(f.groupText[l.idx], t, l.cnt, l.summary) +
                '</td>'),
              (h += m(g, l.idx - 1, f.groups, 1)),
              (h += '</tr>'))
            : (h +=
                '<tr id="' +
                r +
          ...
          if (z - 1 === l.idx) {
            ...
            if ('header' !== f.groupSummaryPos[l.idx]) {
              ...
              for (s = 0; s < x; s++)
                A[s] &&
                  ((u = ''),
                  f.groupCollapse && !f.showSummaryOnHide && (u = ' style="display:none;"'),
                  (h +=
                    '<tr' +
                    u +
                    ' jqfootlevel="' +
  ...
  d.jgrid.extend({
      ...
      return this.each(function() {
        ...
        if (a.grid && a.p.treeGrid)
          for (
            ...
            (l = d.jgrid.stripPref(a.p.idPrefix, a.rows[b].id)),
              (l = a.p.data[a.p._index[l]]),
              'nested' !== a.p.treeGridModel ||
                l[k] ||
                ((m = parseInt(l[a.p.treeReader.left_field], 10)),
                (p = parseInt(l[a.p.treeReader.right_field], 10)),
                (l[k] = p === m + 1 ? 'true' : 'false'),
                (a.rows[b].cells[a.p._treeleafpos].innerHTML = l[k])),
              (m = parseInt(l[g], 10)),
              ...
              'true' === l[k] || !0 === l[k]
                ? ((q += (void 0 !== l[f] && '' !== l[f] ? l[f] : a.p.treeIcons.leaf) + ' tree-leaf treeclick'),
                  (l[k] = !0),
                  (p = 'leaf'))
                : ((l[k] = !1), (p = '')),
              ...
              (q =
                !1 === l[e]
                  ? q + (!0 === l[k] ? "'" : a.p.treeIcons.plus + " tree-plus treeclick'")
                  : q + (!0 === l[k] ? "'" : a.p.treeIcons.minus + " tree-minus treeclick'")),
              (q += '></div></div>'),
              d(a.rows[b].cells[h])
                .wrapInner("<span class='cell-wrapper" + p + "'></span>")
                .prepend(q),
              m !== parseInt(a.p.tree_root_level, 10) &&
                ((l = (l = d(a).jqGrid('getNodeParent', l)) && l.hasOwnProperty(e) ? l[e] : !0) ||
                  d(a.rows[b]).css('display', 'none')),
              d(a.rows[b].cells[h])
                .find('div.treeclick')
                .bind('click', function(b) {
                  ...
                  a.p.data[b][k] ||
                    (a.p.data[b][e]
                      ? (d(a).jqGrid('collapseRow', a.p.data[b]), d(a).jqGrid('collapseNode', a.p.data[b]))
                      : (d(a).jqGrid('expandRow', a.p.data[b]), d(a).jqGrid('expandNode', a.p.data[b])));
                  return !1;
                }),
              !0 === a.p.ExpandColClick &&
                d(a.rows[b].cells[h])
                  ...
                  .bind('click', function(b) {
                    ...
                    a.p.data[c][k] ||
                      (a.p.data[c][e]
                        ? (d(a).jqGrid('collapseRow', a.p.data[c]), d(a).jqGrid('collapseNode', a.p.data[c]))
                        : (d(a).jqGrid('expandRow', a.p.data[c]), d(a).jqGrid('expandNode', a.p.data[c])));
      ...
      return this.each(function() {
        ...
        if (b.p.treeGrid) {
          ...
          b.p.treeIcons = d.extend(
            { plus: a, minus: 'ui-icon-triangle-1-s', leaf: 'ui-icon-radio-off' },
            b.p.treeIcons || {}
          );
          ...
          for (e in b.p.colModel)
            if (b.p.colModel.hasOwnProperty(e))
              for (k in ((a = b.p.colModel[e].name),
              a !== b.p.ExpandColumn || h || ((h = !0), (b.p.expColInd = c)),
              c++,
              b.p.treeReader))
          ...
          d.each(b.p.treeReader, function(a, e) {
            e &&
              -1 === d.inArray(e, g) &&
              ('leaf_field' === a && (b.p._treeleafpos = c),
              c++,
              b.p.colNames.push(e),
              b.p.colModel.push({
                name: e,
        ...
        if (a.grid && a.p.treeGrid)
          switch (a.p.treeGridModel) {
            ...
            case 'adjacency':
              ...
              d(this.p.data).each(function() {
                if (this[p] === d.jgrid.stripPref(a.p.idPrefix, b[m])) return (c = this), !1;
              });
          }
      });
      return c;
        ...
        if (this.grid && this.p.treeGrid) {
          ...
          c =
            void 0 !== b
              ? void 0 !== b[h]
                ? b[h]
                : b[a] || 0 < d(this).jqGrid('getNodeChildren', b).length
                  ? !0
                  : !1
              : !1;
        }
        ...
        if (this.grid && this.p.treeGrid) {
          ...
          if (!b[c]) {
            var f = d.jgrid.getAccessor(b, this.p.localReader.id),
              ...
              m = this.p._index[f];
            d(this).jqGrid('isNodeLoaded', this.p.data[m])
              ? ((b[c] = !0),
                d('div.treeclick', n)
              ...
              : this.grid.hDiv.loading ||
                ...
                'nested' === this.p.treeGridModel
                  ? d(this).jqGrid('setGridParam', {
                      postData: { nodeid: f, n_left: b[k], n_right: b[g], n_level: b[e] }
                    })
                  : d(this).jqGrid('setGridParam', { postData: { nodeid: f, parentid: b[a], n_level: b[e] } }),
                d(this).trigger('reloadGrid'),
                (b[h] = !0),
                'nested' === this.p.treeGridModel
                  ? d(this).jqGrid('setGridParam', {
    ...
    collapseNode: function(b) {
      return this.each(function() {
        if (this.grid && this.p.treeGrid) {
          ...
          b[c] &&
            ((b[c] = !1),
            (c = d.jgrid.getAccessor(b, this.p.localReader.id)),
            (c = d('#' + this.p.idPrefix + d.jgrid.jqID(c), this.grid.bDiv)[0]),
            d('div.treeclick', c)
    ...
    addChildNode: function(b, c, a, h) {
      ...
      if (a) {
        ...
        if (void 0 === b || null === b) {
          s = e.p.data.length - 1;
          if (0 <= s) for (; 0 <= s; ) (l = Math.max(l, parseInt(e.p.data[s][e.p.localReader.id], 10))), s--;
          b = l + 1;
        }
        var y = d(e).jqGrid('getInd', c);
        x = !1;
        void 0 === c || null === c || '' === c
          ? ((v = c = null), (l = 'last'), (w = e.p.tree_root_level), (s = e.p.data.length + 1))
          : ((l = 'after'),
            (u = e.p._index[c]),
            (t = e.p.data[u]),
            (c = t[e.p.localReader.id]),
            (w = parseInt(t[f], 10) + 1),
            (s = d(e).jqGrid('getFullTreeNode', t)),
            s.length
              ? ((v = s = s[s.length - 1][e.p.localReader.id]), (s = d(e).jqGrid('getInd', v) + 1))
              : (s = d(e).jqGrid('getInd', c) + 1),
            t[g] &&
              ((x = !0),
              (t[k] = !0),
              d(e.rows[y])
                ...
                .addClass(e.p.treeIcons.minus + ' tree-minus'),
              (e.p.data[u][g] = !1),
              (t[q] = !0)));
        u = s + 1;
        void 0 === a[k] && (a[k] = !1);
        ...
        if ('nested' === e.p.treeGridModel) {
          ...
          if (null !== c) {
            ...
            if (f.length)
              for (r in f)
                f.hasOwnProperty(r) &&
                  ((f[r][m] = f[r][m] > g ? parseInt(f[r][m], 10) + 2 : f[r][m]),
                  (f[r][p] = f[r][p] >= g ? parseInt(f[r][p], 10) + 2 : f[r][p]));
            a[m] = g;
            a[p] = g + 1;
          } else {
  ...
  d.jgrid.extend({
    pivotSetup: function(q, n) {
      var h = [],
        ...
        v = [],
        r = [],
        b = { grouping: !0, groupingView: { groupField: [], groupSummary: [], groupSummaryPos: [] } },
        f = [],
        c = d.extend(
          {
            rowTotals: !1,
      ...
      this.each(function() {
            ...
            if (a.hasOwnProperty(g)) {
              if (
                ...
                ('level' === g &&
                  (void 0 === F[a.level] &&
                    ...
                    0 < a.level &&
                      '_r_Totals' !== a.text &&
                      (f[a.level - 1] = { useColSpanStyle: !1, groupHeaders: [] })),
                  F[a.level] !== a.text &&
                    a.children.length &&
                    '_r_Totals' !== a.text &&
                    0 < a.level &&
                    (f[a.level - 1].groupHeaders.push({ titleText: a.text }),
                    (b = f[a.level - 1].groupHeaders.length),
                    (e = 1 === b ? K : G + (b - 1) * z),
                    (f[a.level - 1].groupHeaders[b - 1].startColumnName = h[e].name),
                    (f[a.level - 1].groupHeaders[b - 1].numberOfColumns = h.length - e),
                    (G = h.length)),
                  (F[a.level] = a.text)),
                a.level === l && 'level' === g && 0 < l)
              )
                if (1 < z) {
                  b = 1;
                  for (d in a.fields)
                    1 === b &&
                      f[l - 1].groupHeaders.push({ startColumnName: d, numberOfColumns: 1, titleText: a.text }),
                      b++;
              ...
              if ('level' === g && 0 < a.level)
                for (d in ((b = 0), a.fields)) {
                  ...
                  1 < z
                    ? ((e.name = d), (e.label = c.aggregates[b].label || d))
                    : ((e.name = a.text), (e.label = '_r_Totals' === a.text ? c.rowTotalsText : a.text));
                  h.push(e);
                  b++;
                }
            }
        ...
        var m,
          ...
          p = 0;
        c.rowTotals &&
          0 < c.yDimension.length &&
          (c.yDimension.splice(0, 0, { dataName: c.yDimension[0].dataName }),
        ...
        for (var A = {}; p < y; ) {
          ...
          k = {};
          a = 0;
          do (t[a] = d.trim(m[c.xDimension[a].dataName])), (k[c.xDimension[a].dataName] = t[a]), a++;
          while (a < s);
          var g = 0;
          D = -1;
          a = n(e, J, t);
          if (!a) {
            ...
            if (1 <= l) {
              for (g = 0; g < l; g++)
                (u[g] = d.trim(m[c.yDimension[g].dataName])),
                  c.yDimension[g].converter &&
                    d.isFunction(c.yDimension[g].converter) &&
                    (u[g] = c.yDimension[g].converter.call(this, u[g], t, u));
        ...
        if (0 < x)
          for (a = 0; a < x; a++)
            (b.groupingView.groupField[a] = h[a].name),
            ...
            if (xmlJsonClass.xml2json && c.jgrid.parse) {
              ...
              h
                ? ((h = e.grid.datatype),
                  ...
                  c(d)
                    .jqGrid(f)
                    .jqGrid('setGridParam', { datatype: h }))
                : c(d).jqGrid(f);
        ...
        switch (a.imptype) {
              ...
              c.extend(
                {
                  ...
                  complete: function(b, g) {
                    'success' === g &&
                      (f(b.responseXML, a),
                      c(d).triggerHandler('jqGridImportComplete', [b, a]),
                      c.isFunction(a.importComplete) && a.importComplete(b));
                  }
                },
                a.ajaxOptions
              )
          ...
          case 'xmlstring':
            if (a.impstring && 'string' === typeof a.impstring) {
              ...
              g &&
                (f(g, a),
                c(d).triggerHandler('jqGridImportComplete', [g, a]),
                c.isFunction(a.importComplete) && a.importComplete(g),
                (a.impstring = null));
              g = null;
            }
            break;
          ...
          case 'jsonstring':
            a.impstring &&
              ...
              (b(a.impstring, a),
              c(d).triggerHandler('jqGridImportComplete', [a.impstring, a]),
              c.isFunction(a.importComplete) && a.importComplete(a.impstring),
              (a.impstring = null));
        }
      });
    },
          ...
          if (b.treeGrid)
            for (f in b.treeReader)
              b.treeReader.hasOwnProperty(f) &&
                (b.colNames.splice(b.colNames.length - 1), b.colModel.splice(b.colModel.length - 1));
          switch (a.exptype) {
            case 'xmlstring':
    ...
    excelExport: function(a) {
      ...
      return this.each(function() {
        if (this.grid) {
          var d;
          'remote' === a.exptype &&
            ((d = c.extend({}, this.p.postData)),
            (d[a.oper] = a.tag),
            (d = jQuery.param(d)),
            (d = -1 !== a.url.indexOf('?') ? a.url + '&' + d : a.url + '?' + d),
            (window.location = d));
        }
      });
    }
  ...
  toObj: function(a) {
    ...
    if (1 === a.nodeType) {
      ...
      if (a.firstChild) {
        ...
        if (h)
          if (2 > f && 2 > e)
            for (this.removeWhite(a), c = a.firstChild; c; c = c.nextSibling)
              3 === c.nodeType
  ...
  jQuery(l).each(function() {
    if (!this.grid) {
      ...
      jQuery('th', jQuery(this)).each(function() {
        0 === d.length && k
          ? (d.push({ name: '__selection__', index: '__selection__', width: 0, hidden: !0 }), e.push('__selection__'))
          : (d.push({
              name:
                jQuery(this).attr('id') ||
                jQuery
      ...
      jQuery(this).jqGrid(
        jQuery.extend({ datatype: 'local', width: b, colNames: e, colModel: d, multiselect: c }, m || {})
      );
      for (b = 0; b < f.length; b++)
        (a = null),
  ...
  b.jgrid.extend({
    sortableColumns: function(a) {
      return this.each(function() {
        ...
        c.p.sortable.options
          ? b.extend(e, c.p.sortable.options)
          : b.isFunction(c.p.sortable) && (c.p.sortable = { update: c.p.sortable });
        if (e.start) {
          var g = e.start;
    ...
    sortableRows: function(a) {
      return this.each(function() {
        ...
        d.grid &&
          ...
          a.start && b.isFunction(a.start) ? ((a._start_ = a.start), delete a.start) : (a._start_ = !1),
          a.update && b.isFunction(a.update) ? ((a._update_ = a.update), delete a.update) : (a._update_ = !1),
        ...
        if (c.grid && !c.p.treeGrid && b.fn.draggable && b.fn.droppable)
          if (
            (void 0 === b('#jqgrid_dnd')[0] &&
              b('body').append("<table id='jqgrid_dnd' class='ui-jqgrid-dnd'></table>"),
            'string' === typeof a && 'updateDnD' === a && !0 === c.p.jqgdnd)
          )
            d();
          else if (
            ((a = b.extend(
                  ...
                  return b.extend(
                    {
                      start: function(e, d) {
                        ...
                        for (f = 0; f < b.data(c, 'dnd').connectWith.length; f++)
                          0 === b(b.data(c, 'dnd').connectWith[f]).jqGrid('getGridParam', 'reccount') &&
                            b(b.data(c, 'dnd').connectWith[f]).jqGrid('addRowData', 'jqg_empty_row', {});
                  ...
                  return b.extend(
                    {
                      accept: function(a) {
                        ...
                        return 0 < a.length && void 0 !== b.data(a[0], 'dnd')
                          ? ((a = b.data(a[0], 'dnd').connectWith),
                            -1 !== b.inArray('#' + b.jgrid.jqID(this.id), a) ? !0 : !1)
                          : !1;
                      },
                      drop: function(e, d) {
                        if (b(d.draggable).hasClass('jqgrow')) {
                          ...
                          a.beforedrop &&
                            ...
                            void 0 !== h && null !== h && 'object' === typeof h && (f = h));
                          if (d.helper.dropped) {
                            var m;
                            a.autoid &&
                              (b.isFunction(a.autoid)
                                ? (m = a.autoid.call(this, f))
                                : ((m = Math.ceil(1e3 * Math.random())), (m = a.autoidprefix + m)));
            ...
            for (
              a.connectWith = a.connectWith.split(','),
                ...
                b.data(c, 'dnd', a),
                0 === c.p.reccount || c.p.jqgdnd || d(),
                c.p.jqgdnd = !0,
                e = 0;
              e < a.connectWith.length;
              e++
            )
    ...
    gridResize: function(a) {
      return this.each(function() {
        ...
        d.grid &&
          b.fn.resizable &&
          ((a = b.extend({}, a || {})),
          a.alsoResize ? ((a._alsoResize_ = a.alsoResize), delete a.alsoResize) : (a._alsoResize_ = !1),
          a.stop && b.isFunction(a.stop) ? ((a._stop_ = a.stop), delete a.stop) : (a._stop_ = !1),
          (a.stop = function(e, g) {
