...
!(function(a) {
  ...
  function l(a, b) {
    var c,
      d = a.add(b);
    return (
      d.css({ position: 'relative', left: -1 }),
  ...
  function Q(a, b, c) {
    ...
    return T(c)
      ? (b - a) / c
      : ((d = c.asMonths()),
        Math.abs(d) >= 1 && ha(d) ? b.diff(a, 'months', !0) / d : b.diff(a, 'days', !0) / c.asDays());
  }
  function R(a, b) {
    var c, d;
    return T(a) || T(b)
      ...
      : ((c = a.asMonths()),
        (d = b.asMonths()),
        Math.abs(c) >= 1 && ha(c) && Math.abs(d) >= 1 && ha(d) ? c / d : a.asDays() / b.asDays());
  }
  function S(a, c) {
    var d;
    return T(a)
      ? b.duration(a * c)
      : ((d = a.asMonths()),
        Math.abs(d) >= 1 && ha(d) ? b.duration({ months: d * c }) : b.duration({ days: a.asDays() * c }));
  }
  function T(a) {
  ...
  function ta(a, b, c, d, e) {
    var f;
    return (
      (a = Wa.moment.parseZone(a)),
      (b = Wa.moment.parseZone(b)),
  ...
  function xa(a) {
    for (var b, c = [], d = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; (b = d.exec(a)); )
      b[1] ? c.push(b[1]) : b[2] ? c.push({ maybe: xa(b[2]) }) : b[3] ? c.push({ token: b[3] }) : b[5] && c.push(b[5]);
    return c;
  }
  function ya() {}
  function za(a, b) {
  ...
  function Qa(c, e) {
    ...
    function l(b, c) {
      ha++,
        ...
        !$ &&
          b &&
          (($ = U.view = ga[b] || (ga[b] = U.instantiateView(b))),
          $.setElement(a("<div class='fc-view fc-" + b + "-view' />").appendTo(Y)),
          W.activateButton(b)),
        $ &&
          ((ba = $.massageCurrentDate(ba)),
          ($.displaying && ba.isWithin($.intervalStart, $.intervalEnd)) ||
    ...
    U.bindOptions(
      ...
      function(a, b, c, d, e, g, h) {
        ...
        'iso' === h && (h = 'ISO'),
          ('ISO' !== h && 'local' !== h && 'function' != typeof h) || (V._fullCalendar_weekCalc = h),
          ba && f(ba);
      }
    ),
      ...
      (U.moment = function() {
        ...
        return (
          'local' === U.options.timezone
            ...
            : (a =
                'UTC' === U.options.timezone
                  ? Wa.moment.utc.apply(null, arguments)
      ...
      (U.getDefaultEventEnd = function(a, b) {
        var c = b.clone();
        return (
          a ? c.stripTime().add(U.defaultAllDayEventDuration) : c.add(U.defaultTimedEventDuration),
          U.getIsAmbigTimezone() && c.stripZone(),
          c
        );
      }),
  ...
  function Ta(b) {
    function c() {
      ...
      (n = c.theme ? 'ui' : 'fc'),
        f
          ? (m ? m.empty() : (m = this.el = a("<div class='fc-toolbar'/>")),
            m
              .append(e('left'))
              .append(e('right'))
              .append(e('center'))
  ...
  function Ua() {
    ...
    function e(a, b) {
      var c, d;
      for ('reset' === b ? ($ = []) : 'add' !== b && ($ = u($, a)), c = 0; c < a.length; c++)
        (d = a[c]), 'pending' !== d._status && Z++, (d._fetchId = (d._fetchId || 0) + 1), (d._status = 'pending');
    ...
    function y(a, b) {
      ...
      if (f) {
        for (c = G(f), d = 0; d < c.length; d++)
          (e = c[d]), e.source || (b && (X.events.push(e), (e.source = X)), $.push(e));
        return W($), c;
      }
      return [];
    }
    ...
    function C(c, d) {
      ...
      if (
        ...
        f && ((f = S.moment(f)), f.isValid() || (f = null)),
          (g = c.allDay),
          void 0 === g && (g = ba(d ? d.allDayDefault : void 0, S.options.allDayDefault)),
          D(e, f, g, h);
      }
    ...
    function E(a) {
      F(a),
        ...
        a.end || (S.options.forceEventDuration ? (a.end = S.getDefaultEventEnd(a.allDay, a.start)) : (a.end = null));
    }
    function F(a) {
      null == a.allDay && (a.allDay = !(a.start.hasTime() || (a.end && a.end.hasTime()))),
        a.allDay
          ? (a.start.stripTime(), a.end && a.end.stripTime())
          : (a.start.hasTime() || (a.start = S.applyTimezone(a.start.time(0))),
            a.end && !a.end.hasTime() && (a.end = S.applyTimezone(a.end.time(0))));
    }
    function G(b, c, d) {
      var e,
        f,
  ...
  (Wa.moment = function() {
    ...
    (gb.week = gb.weeks = function(a) {
      ...
      return null == a && 'function' == typeof b
        ? b(this)
        : 'ISO' === b
          ? hb.isoWeek.apply(this, arguments)
          : hb.week.apply(this, arguments);
    }),
    (gb.time = function(a) {
    ...
    (gb.stripTime = function() {
      ...
      return (
        this._ambigTime ||
          ((a = this.toArray()), this.utc(), bb(this, a.slice(0, 3)), (this._ambigTime = !0), (this._ambigZone = !0)),
        this
      );
    }),
    (gb.hasTime = function() {
      ...
      return this._fullCalendar && arguments[0]
        ...
        : this._ambigTime
          ...
          : this._ambigZone
            ...
            : hb.format.apply(this, arguments);
    }),
    (gb.toISOString = function() {
      return this._ambigTime
        ...
        : this._ambigZone
          ? pa(this, 'YYYY-MM-DD[T]HH:mm:ss')
          : hb.toISOString.apply(this, arguments);
    }),
    ...
    pb = (Wa.CoordCache = ya.extend({
      ...
      constructor: function(b) {
        (this.els = a(b.els)),
          ...
          (this.forcedOffsetParentEl = b.offsetParent ? a(b.offsetParent) : null);
      },
      build: function() {
    ...
    setScrollVel: function(a, b) {
      (this.scrollTopVel = a),
        ...
        (!this.scrollTopVel && !this.scrollLeftVel) ||
          ...
          (this.scrollIntervalId = setInterval(ia(this, 'scrollIntervalFunc'), this.scrollIntervalMs));
    },
  ...
  var rb = qb.extend({
      ...
      handleDragStart: function(a) {
        var b;
        qb.prototype.handleDragStart.apply(this, arguments),
          (b = this.queryHit(v(a), w(a))),
          b && this.handleHitOver(b);
      },
      handleDrag: function(a, b, c) {
        var d;
        qb.prototype.handleDrag.apply(this, arguments),
      ...
      handleInteractionEnd: function() {
        qb.prototype.handleInteractionEnd.apply(this, arguments),
          (this.origHit = null),
          (this.hit = null),
      ...
      queryHit: function(a, b) {
        return (
          this.coordAdjust && ((a += this.coordAdjust.left), (b += this.coordAdjust.top)), this.component.queryHit(a, b)
        );
      }
    }),
    sb = ya.extend(mb, {
    ...
    tb = (Wa.Grid = ya.extend(mb, nb, {
      ...
      dayTouchStart: function(a) {
        ...
        (b.isSelected || b.selectedEvent) && this.tempIgnoreMouse(),
          this.dayDragListener.startInteraction(a, { delay: this.view.opt('longPressDelay') });
      },
          ...
          f = new rb(this, {
            ...
            hitOver: function(d, f, h) {
              h &&
                (f || (a = null),
                e &&
                  ((b = c.computeSelection(c.getHitSpan(h), c.getHitSpan(d))),
                  b ? c.renderSelection(b) : b === !1 && g()));
            },
            hitOut: function() {
            ...
            interactionEnd: function(e, f) {
              f ||
                (a && !c.isIgnoringMouse && d.triggerDayClick(c.getHitSpan(a), c.getHitEl(a), e),
                b && d.reportSelection(b, e));
            }
          });
        return f;
      },
  ...
  tb.mixin({
    ...
    buildBusinessHourSegs: function(b) {
      ...
      return (
        !c.length &&
          this.view.calendar.options.businessHours &&
          (c = [a.extend({}, Gb, { start: this.view.end, end: this.view.end, dow: null })]),
        this.eventsToSegs(c)
      );
    },
    ...
    handleSegMouseover: function(a, b) {
      this.isIgnoringMouse ||
        ...
        a.el.addClass('fc-allow-mouse-resize'),
    ...
    handleSegMouseout: function(a, b) {
      (b = b || {}),
        this.mousedOverSeg &&
          ...
          a.el.removeClass('fc-allow-mouse-resize'),
    ...
    handleSegTouchStart: function(a, b) {
      ...
      f && h && (i = this.startSegResize(a, b)),
        i ||
          (!g && !h) ||
          ((c = g ? this.buildSegDragListener(a) : this.buildSegSelectListener(a)),
          c.startInteraction(b, { delay: f ? 0 : this.view.opt('longPressDelay') })),
      ...
      return (
        g.hasTime() === h.hasTime()
          ? ((d = this.diffDates(h, g)),
            c.allDay && T(d)
              ? ((e = { start: c.start.clone(), end: f.getEventEnd(c), allDay: !1 }), f.normalizeEventTimes(e))
    ...
    computeEventResize: function(a, b, c, d) {
      ...
      return (
        ...
        e.start.isBefore(e.end) ||
          ((f = this.minResizeDuration || (d.allDay ? g.defaultAllDayEventDuration : g.defaultTimedEventDuration)),
    ...
    getSegClasses: function(a, b, c) {
      var d = this.view,
        e = a.event,
        f = ['fc-event', a.isStart ? 'fc-start' : 'fc-not-start', a.isEnd ? 'fc-end' : 'fc-not-end'].concat(
          e.className,
          e.source ? e.source.className : []
        );
    ...
    eventToRange: function(a) {
      return {
        start: a.start.clone().stripZone(),
          ...
          ? a.end.clone()
          : this.view.calendar.getDefaultEventEnd(null != a.allDay ? a.allDay : !a.start.hasTime(), a.start)
        ).stripZone()
      };
    },
    ...
    invertRanges: function(a) {
      ...
      for (a.sort(Ha), b = 0; b < a.length; b++)
        (c = a[b]), c.start > h && g.push({ start: h, end: c.start }), (h = c.end);
    ...
    compareEventSegs: function(a, b) {
      return (
        ...
        H(a.event, b.event, this.view.eventOrderSpecs)
      );
    }
  }),
    (Wa.isBgEvent = Da),
  ...
  var ub = (Wa.DayTableMixin = {
      ...
      updateDayTable: function() {
        for (var a, b, c, d = this.view, e = this.start.clone(), f = -1, g = [], h = []; e.isBefore(this.end); )
          d.isHiddenDay(e) ? g.push(f + 0.5) : (f++, g.push(f), h.push(e.clone())), e.add(1, 'days');
      ...
      sliceRangeByRow: function(a) {
        ...
        for (b = 0; b < this.rowCnt; b++)
          (c = b * g),
            ...
            (f = Math.floor(f)),
            f >= e &&
              k.push({ row: b, firstRowDayIndex: e - c, lastRowDayIndex: f - c, isStart: e === i, isEnd: f === j });
        return k;
      },
        ...
        for (b = 0; b < this.rowCnt; b++)
          for (c = b * h, d = c + h - 1, e = c; d >= e; e++)
            (f = Math.max(j, e)),
              ...
              (g = Math.floor(g)),
              g >= f &&
                l.push({ row: b, firstRowDayIndex: f - c, lastRowDayIndex: g - c, isStart: f === j, isEnd: g === k });
        return l;
      },
      ...
      renderBgCellHtml: function(a, b) {
        ...
        return (
          ...
          '<td class="' + d.join(' ') + '" data-date="' + a.format('YYYY-MM-DD') + '"' + (b ? ' ' + b : '') + '></td>'
        );
      },
    ...
    vb = (Wa.DayGrid = tb.extend(ub, {
      ...
      renderNumberCellHtml: function(a) {
        ...
        return this.view.dayNumbersVisible
          ? ((b = this.getDayClasses(a)),
            ...
            '<td class="' + b.join(' ') + '" data-date="' + a.format() + '">' + a.date() + '</td>')
          : '<td/>';
      },
      computeEventTimeFormat: function() {
      ...
      renderDrag: function(a, b) {
        return (
          ...
          b && b.component !== this ? this.renderEventLocationHelper(a, b) : void 0
        );
      },
      unrenderDrag: function() {
      ...
      renderMoreLink: function(b, c, d) {
        ...
        return a('<a class="fc-more"/>')
          ...
          .on('click', function(g) {
            ...
            'function' == typeof h &&
              (h = f.trigger('eventLimitClick', null, { date: i, dayEl: k, moreEl: j, segs: m, hiddenSegs: n }, g)),
  ...
  var wb = (Wa.TimeGrid = tb.extend(ub, {
      ...
      for (var a, c, d, e = this.view, f = this.isRTL, g = '', h = b.duration(+this.minTime); h < this.maxTime; )
        (a = this.start.clone().time(h)),
          ...
          (d =
            ...
            e.axisStyleAttr() +
            '>' +
            (c ? '<span>' + ca(a.format(this.labelFormat)) + '</span>' : '') +
            '</td>'),
          (g +=
            '<tr data-time="' +
            a.format('HH:mm:ss') +
    ...
    computeTimeTop: function(a) {
      ...
      return (
        ...
        (b = Math.min(b, d - 1)),
        (c = e - b),
        this.slatCoordCache.getTopPosition(b) + this.slatCoordCache.getHeight(b) * c
      );
    },
    renderDrag: function(a, b) {
        ...
        return (
          ...
          ka(this.clear(), function() {
            return (c.displaying = ka(c.displayView(a), function() {
              null != b ? c.setScroll(b) : c.forceScroll(c.computeInitialScroll(d)),
      ...
      stopNowIndicator: function() {
        this.isNowIndicatorRendered &&
          ...
          this.nowIndicatorIntervalID &&
            (clearTimeout(this.nowIndicatorIntervalID), (this.nowIndicatorIntervalID = null)),
          this.unrenderNowIndicator(),
    ...
    yb = (Wa.Scroller = ya.extend({
      ...
      lockOverflow: function(a) {
        ...
        (a = a || this.getScrollbarWidths()),
          'auto' === b &&
            (b =
              a.top || a.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth
                ? 'scroll'
                : 'hidden'),
          'auto' === c &&
            (c =
              a.left || a.right || this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight
                ? 'scroll'
                : 'hidden'),
        ...
        return (
          ...
          d['class']
            ? (f &&
                ((f = b.duration(f)),
                f.valueOf() &&
                  ((d.duration = f), (g = O(f)), 1 === f.as(g) && ((d.singleUnit = g), k.unshift(h[g] || {})))),
              (d.defaults = c(j)),
              (d.overrides = c(k)),
  ...
  (zb.prototype.getCurrentBusinessHourEvents = function(a) {
    ...
    (zb.prototype.computeBusinessHourEvents = function(b, c) {
      return c === !0
        ? this.expandBusinessHourEvents(b, [{}])
        : a.isPlainObject(c)
          ? this.expandBusinessHourEvents(b, [c])
          : a.isArray(c)
            ? this.expandBusinessHourEvents(b, c, !0)
            : [];
    }),
    (zb.prototype.expandBusinessHourEvents = function(b, c, d) {
      ...
      for (e = 0; e < c.length; e++)
        (f = c[e]),
          (d && !f.dow) ||
            ((f = a.extend({}, Gb, f)),
            b && ((f.start = null), (f.end = null)),
            h.push.apply(h, this.expandEvent(this.buildEventFromInput(f), g.start, g.end)));
      return h;
    });
  var Hb = (Wa.BasicView = xb.extend({
      ...
      setRange: function(a) {
        xb.prototype.setRange.call(this, a),
      ...
      setHeight: function(a, b) {
        ...
        this.scroller.clear(),
          ...
          g && 'number' != typeof g && this.dayGrid.limitRows(g),
          b ||
            (this.scroller.setHeight(c),
            (d = this.scroller.getScrollbarWidths()),
            (d.left || d.right) &&
              (e(this.headRowEl, d), (c = this.computeScrollerHeight(a)), this.scroller.setHeight(c)),
            this.scroller.lockOverflow(d));
      },
  ...
  (Xa.basic = { class: Hb }),
    (Xa.basicDay = { type: 'basic', duration: { days: 1 } }),
    (Xa.basicWeek = { type: 'basic', duration: { weeks: 1 } }),
      ...
      setHeight: function(a, b) {
        ...
        this.bottomRuleEl.hide(),
          ...
          b ||
            ...
            (g.left || g.right) &&
              (e(this.noScrollRowEls, g), (d = this.computeScrollerHeight(a)), this.scroller.setHeight(d)),
    ...
    Mb = {
      renderBgIntroHtml: function() {
        ...
        return (
          ...
          a.axisStyleAttr() +
          '><span>' +
          (a.opt('allDayHtml') || ca(a.opt('allDayText'))) +
          '</span></td>'
        );
      },
      renderIntroHtml: function() {
