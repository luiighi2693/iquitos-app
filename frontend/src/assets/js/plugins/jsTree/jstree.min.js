  ...
  if (!a.jstree) {
    ...
    j.setAttribute('role', 'treeitem'),
        ...
        return c !== !0 || this.length
          ? (this.each(function() {
              ...
              return (
                ...
                g || d || (c !== b && !a.isPlainObject(c)) || a(this).data('jstree', new a.jstree.create(this, c)),
                ((g && !d) || c === !0) && (f = g || !1),
                null !== f && f !== b ? !1 : void 0
              );
            }),
      ...
      (a.jstree.core.prototype = {
        ...
        init: function(b, c) {
          (this._model = {
            data: { '#': { id: '#', parent: null, parents: [], children: [], children_d: [], state: { loaded: !1 } } },
            changed: [],
            force_full_redraw: !1,
            redraw_timeout: !1,
        ...
        bind: function() {
          ...
          this.element
            ...
            .on(
              ...
              a.proxy(function(b) {
                b.preventDefault(),
                  b.currentTarget !== document.activeElement && a(b.currentTarget).focus(),
            ...
            .on(
              ...
              a.proxy(function(b) {
                ...
                var c = null;
                switch (
                  (this._data.core.rtl && (37 === b.which ? (b.which = 39) : 39 === b.which && (b.which = 37)), b.which)
                ) {
                  case 32:
                  ...
                  case 39:
                    b.preventDefault(),
                      this.is_closed(b.currentTarget)
                        ...
                        : this.is_open(b.currentTarget) &&
                          ((c = this.get_node(b.currentTarget, !0).children('.jstree-children')[0]),
                          c &&
            ...
            .on(
              ...
              a.proxy(function() {
                +new Date() - d > 500 &&
                  ...
                  ((d = 0),
                  this.get_node(this.element.attr('aria-activedescendant'), !0)
                    .find('> .jstree-anchor')
                    .focus());
              }, this)
            )
        ...
        get_node: function(b, c) {
          ...
          try {
            ...
            return (
              c && (b = '#' === b.id ? this.element : a('#' + b.id.replace(a.jstree.idregex, '\\$&'), this.element)), b
            );
          } catch (e) {
            return !1;
          }
        ...
        get_path: function(a, b, c) {
          ...
          var d,
            e,
            f = [];
          for (f.push(c ? a.id : a.text), d = 0, e = a.parents.length; e > d; d++)
            f.push(c ? a.parents[d] : this.get_text(a.parents[d]));
        ...
        get_prev_dom: function(b, c) {
          ...
          return (
            (d = b[0].parentNode.parentNode), d && d.className && -1 !== d.className.indexOf('jstree-node') ? a(d) : !1
          );
        },
          ...
          if (b.state.loaded) {
            for (b.state.loaded = !1, d = 0, e = b.children_d.length; e > d; d++) {
              for (f = 0, g = b.parents.length; g > f; f++)
                this._model.data[b.parents[f]].children_d = a.vakata.array_remove_item(
                  this._model.data[b.parents[f]].children_d,
                  b.children_d[d]
                );
              this._model.data[b.children_d[d]].state.selected &&
                ((h = !0),
                (this._data.core.selected = a.vakata.array_remove_item(this._data.core.selected, b.children_d[d]))),
            ...
            this._load_node(
              ...
              a.proxy(function(a) {
                ...
                b.state.loaded &&
                  ...
                  d.removeClass('jstree-closed jstree-open').addClass('jstree-leaf'),
        ...
        _load_nodes: function(a, b, c) {
          ...
          for (g = 0, h = a.length; h > g; g++)
            !f[a[g]] || (f[a[g]].state.loaded && c) || (this.is_loading(a[g]) || this.load_node(a[g], e), (d = !1));
        ...
        load_all: function(a, b) {
          ...
          var c = [],
            ...
            f,
            g;
          for (a.state && !a.state.loaded && c.push(a.id), f = 0, g = e.length; g > f; f++)
            d[e[f]] && d[e[f]].state && !d[e[f]].state.loaded && c.push(e[f]);
          c.length
            ? this._load_nodes(c, function() {
                this.load_all(a, b);
              })
            ...
            ? a.isFunction(d)
              ...
              : 'object' == typeof d
                ? d.url
                    ...
                    a
                      ...
                      .done(
                        a.proxy(function(d, e, f) {
                          ...
                          return -1 !== g.indexOf('json') || 'object' == typeof d
                            ? this._append_json_data(b, d, function(a) {
                                c.call(this, a);
                              })
                            : -1 !== g.indexOf('html') || 'string' == typeof d
                              ? this._append_html_data(b, a(d), function(a) {
                                  c.call(this, a);
                                })
                  ...
                  : ((e = a.isArray(d) || a.isPlainObject(d) ? JSON.parse(JSON.stringify(d)) : d),
                    '#' === b.id
            ...
            h = function(a, b) {
              ...
              var c = a.dat,
                ...
                r = function(a, c, d) {
                  ...
                  return (
                    delete a.data, delete a.children, (k[m.id].original = a), m.state.selected && g.push(m.id), m.id
                  );
                },
                s = function(a, c, d) {
                  (d = d ? d.concat() : []), c && d.unshift(c);
            ...
            try {
              null === this._wrk &&
                (this._wrk = window.URL.createObjectURL(
                  new window.Blob(['self.onmessage = ' + h.toString()], { type: 'text/javascript' })
                )),
        ...
        _parse_model_from_html: function(b, c, d) {
          ...
          for (i in this._model.default_state)
            this._model.default_state.hasOwnProperty(i) && (h.state[i] = this._model.default_state[i]);
          if (
            ((j = a.vakata.attributes(b, !0)),
            a.each(j, function(b, c) {
              return (c = a.trim(c)), c.length ? ((h.li_attr[b] = c), void ('id' === b && (h.id = c.toString()))) : !0;
            }),
            (j = b.children('a').first()),
            j.length &&
              ((j = a.vakata.attributes(j, !0)),
              a.each(j, function(b, c) {
                (c = a.trim(c)), c.length && (h.a_attr[b] = c);
              })),
            (j = b.children('a').first().length
              ? b
                  .children('a')
                  .first()
                  .clone()
              : b.clone()),
            j.children('ins, i, ul').remove(),
            (j = j.html()),
            (j = a('<div />').html(j)),
            (h.text = this.settings.core.force_text ? j.text() : j.html()),
            (j = b.data()),
            (h.data = j ? a.extend(!0, {}, j) : null),
            (h.state.opened = b.hasClass('jstree-open')),
            (h.state.selected = b.children('a').hasClass('jstree-clicked')),
            (h.state.disabled = b.children('a').hasClass('jstree-disabled')),
            h.data && h.data.jstree)
          )
            for (i in h.data.jstree) h.data.jstree.hasOwnProperty(i) && (h.state[i] = h.data.jstree[i]);
          (j = b.children('a').children('.jstree-themeicon')),
            j.length && (h.icon = j.hasClass('jstree-themeicon-hidden') ? !1 : j.attr('rel')),
            h.state.icon && (h.icon = h.state.icon),
            (j = b.children('ul').children('li'));
          do k = 'j' + this._id + '_' + ++this._cnt;
          while (g[k]);
          return (
            (h.id = h.li_attr.id ? h.li_attr.id.toString() : k),
            j.length
              ? (j.each(
                  a.proxy(function(b, c) {
                    (e = this._parse_model_from_html(a(c), h.id, d)),
                      (f = this._model.data[e]),
                      h.children.push(e),
                      f.children_d.length && (h.children_d = h.children_d.concat(f.children_d));
                  }, this)
                ),
                (h.children_d = h.children_d.concat(h.children)))
              : b.hasClass('jstree-closed') && (h.state.loaded = !1),
            h.li_attr['class'] &&
        ...
        _redraw: function() {
          var a = this._model.force_full_redraw
          ...
          for (d = 0, e = a.length; e > d; d++)
            (c = this.redraw_node(a[d], !0, this._model.force_full_redraw)),
              c && this._model.force_full_redraw && b.appendChild(c);
          this._model.force_full_redraw &&
            ((b.className = this.get_container_ul()[0].className),
            b.setAttribute('role', 'group'),
            this.element.empty().append(b)),
            null !== f &&
              ((c = this.get_node(f, !0)),
              c && c.length && c.children('.jstree-anchor')[0] !== document.activeElement
                ? c.children('.jstree-anchor').focus()
                : (this._data.core.focused = null)),
            (this._model.force_full_redraw = !1),
            (this._model.changed = []),
            this.trigger('redraw', { nodes: a });
        },
        redraw: function(a) {
        ...
        draw_children: function(a) {
          ...
          if ((a.children('.jstree-children').remove(), (a = a[0]), b.children.length && b.state.loaded)) {
            for (
              ...
              e.appendChild(this.redraw_node(b.children[c], !0, !0));
            a.appendChild(e);
          }
        },
        redraw_node: function(b, c, d, e) {
          ...
          if (
            ...
            (b = a(b)),
              ...
              c || (i = b.children('.jstree-children')[0]),
              (q = b.children('.jstree-anchor')[0] === document.activeElement),
              b.remove();
          else if (((c = !0), !d)) {
            if (
              ((g = '#' !== f.parent ? a('#' + f.parent.replace(a.jstree.idregex, '\\$&'), this.element)[0] : null),
        ...
        open_node: function(c, d, e) {
          ...
          if (((e = e === b ? this.settings.core.animation : e), !this.is_closed(c)))
            return d && d.call(this, c, !1), !1;
          if (this.is_loaded(c))
            (h = this.get_node(c, !0)),
              (i = this),
              h.length &&
            ...
            c && '#' !== c.id
              ? this.is_closed(c)
                ...
                : ((d = d === b ? this.settings.core.animation : d),
                  ...
                  void ((d && h.length) || this.trigger('after_close', { node: c })))
              : !1
          );
        },
        ...
        open_all: function(a, b, c) {
          ...
          var d = '#' === a.id ? this.get_container_ul() : this.get_node(a, !0),
            ...
            g;
          if (!d.length) {
            for (e = 0, f = a.children_d.length; f > e; e++)
              this.is_closed(this._model.data[a.children_d[e]]) &&
                (this._model.data[a.children_d[e]].state.opened = !0);
        ...
        select_all: function(a) {
          ...
          for (
            this._data.core.selected = this._model.data['#'].children_d.concat(),
              c = 0,
              d = this._data.core.selected.length;
            d > c;
            c++
          )
            this._model.data[this._data.core.selected[c]] &&
              (this._model.data[this._data.core.selected[c]].state.selected = !0);
          this.redraw(!0),
            this.trigger('select_all', { selected: this._data.core.selected }),
            a ||
              this.trigger('changed', { action: 'select_all', selected: this._data.core.selected, old_selection: b });
        },
        deselect_all: function(a) {
          ...
          (this._data.core.selected = []),
            ...
            a ||
              this.trigger('changed', { action: 'deselect_all', selected: this._data.core.selected, old_selection: b });
        },
        ...
        get_state: function() {
          var a = {
            ...
            b;
          for (b in this._model.data)
            this._model.data.hasOwnProperty(b) &&
              '#' !== b &&
              (this._model.data[b].state.opened && a.core.open.push(b),
              this._model.data[b].state.selected && a.core.selected.push(b));
          return a;
        },
        set_state: function(c, d) {
          if (c) {
            if (c.core) {
              var e, f, g, h;
              if (c.core.open)
                return a.isArray(c.core.open)
                  ? ((e = !0),
                    (f = !1),
                    (g = this),
                    a.each(c.core.open.concat([]), function(b, h) {
                      (f = g.get_node(h)),
                        f &&
                          (g.is_loaded(h)
                            ? (g.is_closed(h) && g.open_node(h, !1, 0),
                              c && c.core && c.core.open && a.vakata.array_remove_item(c.core.open, h))
                            : (g.is_loading(h) ||
                                g.open_node(
                                  h,
                                  a.proxy(function(b, e) {
                                    !e && c && c.core && c.core.open && a.vakata.array_remove_item(c.core.open, b.id),
                                      this.set_state(c, d);
                                  }, g),
                                  0
                                ),
                    ...
                    e && (delete c.core.open, this.set_state(c, d)),
                    !1)
        ...
        refresh: function(b, c) {
          (this._data.core.state = c === !0 ? {} : this.get_state()),
            ...
            (this._cnt = 0),
            (this._model.data = {
              '#': { id: '#', parent: null, parents: [], children: [], children_d: [], state: { loaded: !1 } }
            });
        ...
        create_node: function(c, d, e, f, g) {
          ...
          if (
            (e > c.children.length && (e = c.children.length), d.id || (d.id = !0), !this.check('create_node', d, c, e))
          )
          ...
          for (
            ...
            for (h = 0, i = b.parents.length; i > h; h++)
              (f = a.inArray(g[j], this._model.data[b.parents[h]].children_d)),
                -1 !== f &&
                  (this._model.data[b.parents[h]].children_d = a.vakata.array_remove(
            ...
            this._model.data[g[j]].state.selected &&
              ...
              -1 !== f && (this._data.core.selected = a.vakata.array_remove(this._data.core.selected, f)));
          }
          for (
        ...
        check: function(b, c, d, e, f) {
          ...
          return ('move_node' !== b && 'copy_node' !== b) ||
            (f && f.is_multi) ||
            (c.id !== d.id && a.inArray(c.id, d.children) !== e && -1 === a.inArray(d.id, c.children_d))
            ? (g && g.data && (g = g.data),
        ...
        move_node: function(c, d, e, f, g, h) {
          ...
          if (a.isArray(c)) {
            for (c = c.slice(), i = 0, j = c.length; j > i; i++)
              this.move_node(c[i], d, e, f, g, !0) && ((d = c[i]), (e = 'after'));
            return this.redraw(), !0;
          }
          if (((c = c && c.id ? c : this.get_node(c)), !c || '#' === c.id)) return !1;
          if (
            ((k = (c.parent || '#').toString()),
            (m = e.toString().match(/^(before|after)$/) && '#' !== d.id ? this.get_node(d.parent) : d),
            (n = c.instance ? c.instance : this._model.data[c.id] ? this : a.jstree.reference(c.id)),
            (o = !n || !n._id || this._id !== n._id),
            (l =
              n && n._id && k && n._model.data[k] && n._model.data[k].children
                ? a.inArray(c.id, n._model.data[k].children)
                : -1),
            o)
          )
            return this.copy_node(c, d, e, f, g) ? (n && n.delete_node(c), !0) : !1;
          ...
          if (
            (e > m.children.length && (e = m.children.length),
            !this.check('move_node', c, m, e, {
              core: !0,
          ...
          if (c.parent === m.id) {
            for (
              p = m.children.concat(),
                q = a.inArray(c.id, p),
                -1 !== q && ((p = a.vakata.array_remove(p, q)), e > q && e--),
                q = [],
                r = 0,
                s = p.length;
              s > r;
            ...
            for (q = c.children_d.concat(), q.push(c.id), r = 0, s = c.parents.length; s > r; r++) {
              for (p = [], v = n._model.data[c.parents[r]].children_d, t = 0, u = v.length; u > t; t++)
                -1 === a.inArray(v[t], q) && p.push(v[t]);
              n._model.data[c.parents[r]].children_d = p;
            }
            for (
              n._model.data[k].children = a.vakata.array_remove_item(n._model.data[k].children, c.id),
                r = 0,
                s = m.parents.length;
              s > r;
              r++
            )
              this._model.data[m.parents[r]].children_d = this._model.data[m.parents[r]].children_d.concat(q);
            for (p = [], r = 0, s = m.children.length; s > r; r++) p[r >= e ? r + 1 : r] = m.children[r];
            for (
              p[e] = c.id,
                m.children = p,
                m.children_d.push(c.id),
                m.children_d = m.children_d.concat(c.children_d),
                c.parent = m.id,
                q = m.parents.concat(),
                q.unshift(m.id),
                v = c.parents.length,
                ...
                q = q.concat(),
                r = 0,
                s = c.children_d.length;
              s > r;
              r++
            )
              (this._model.data[c.children_d[r]].parents = this._model.data[c.children_d[r]].parents.slice(0, -1 * v)),
                Array.prototype.push.apply(this._model.data[c.children_d[r]].parents, q);
            ('#' === k || '#' === m.id) && (this._model.force_full_redraw = !0),
              this._model.force_full_redraw || (this._node_changed(k), this._node_changed(m.id)),
              h || this.redraw();
          }
          return (
            f && f.call(this, c, m, e),
        ...
        copy_node: function(c, d, e, f, g, h) {
          ...
          if (a.isArray(c)) {
            for (c = c.slice(), i = 0, j = c.length; j > i; i++)
              (l = this.copy_node(c[i], d, e, f, g, !0)), l && ((d = l), (e = 'after'));
            return this.redraw(), !0;
          }
          if (((c = c && c.id ? c : this.get_node(c)), !c || '#' === c.id)) return !1;
          switch (
            ((p = (c.parent || '#').toString()),
            (q = e.toString().match(/^(before|after)$/) && '#' !== d.id ? this.get_node(d.parent) : d),
            (r = c.instance ? c.instance : this._model.data[c.id] ? this : a.jstree.reference(c.id)),
            (s = !r || !r._id || this._id !== r._id),
            '#' === d.id && ('before' === e && (e = 'first'), 'after' === e && (e = 'last')),
            e)
          ) {
            case 'before':
          ...
          if (
            (e > q.children.length && (e = q.children.length),
            !this.check('copy_node', c, q, e, {
              core: !0,
          ...
          if ((o.id === !0 && delete o.id, (o = this._parse_model_from_json(o, q.id, q.parents.concat())), !o))
            return !1;
          for (
            l = this.get_node(o),
              c && c.state && c.state.loaded === !1 && (l.state.loaded = !1),
              k = [],
              k.push(o),
              k = k.concat(l.children_d),
              this.trigger('model', { nodes: k, parent: q.id }),
              m = 0,
              n = q.parents.length;
            n > m;
            m++
          )
            this._model.data[q.parents[m]].children_d = this._model.data[q.parents[m]].children_d.concat(k);
          for (k = [], m = 0, n = q.children.length; n > m; m++) k[m >= e ? m + 1 : m] = q.children[m];
          return (
            (k[e] = l.id),
            (q.children = k),
            q.children_d.push(l.id),
            (q.children_d = q.children_d.concat(l.children_d)),
            '#' === q.id && (this._model.force_full_redraw = !0),
            this._model.force_full_redraw || this._node_changed(q.id),
            h || this.redraw('#' === q.id),
            f && f.call(this, l, q, e),
            this.trigger('copy_node', {
              ...
              old_parent: p,
              old_position:
                r && r._id && p && r._model.data[p] && r._model.data[p].children
                  ? a.inArray(c.id, r._model.data[p].children)
                  : -1,
              is_multi: r && r._id && r._id !== this._id,
              is_foreign: !r || !r._id,
              old_instance: r,
        ...
        paste: function(a, b) {
          return (
            ...
            a && e && e.match(/^(copy_node|move_node)$/) && d
              ? (this[e](d, a, b) && this.trigger('paste', { parent: a.id, node: d, mode: e }),
                (d = !1),
                (e = !1),
                void (f = !1))
              : !1
        ...
        edit: function(b, c) {
          ...
          var d = this._data.core.rtl,
            ...
            h = c,
            i = a('<div />', {
              css: { position: 'absolute', top: '-200px', left: d ? '0px' : '-1000px', visibility: 'hidden' }
            }).appendTo('body'),
            j = a('<input />', {
              value: h,
              ...
              keydown: function(a) {
                var b = a.which;
                27 === b && (this.value = h),
                  (27 === b || 13 === b || 37 === b || 38 === b || 39 === b || 40 === b || 32 === b) &&
          ...
          g
            ...
            .append(f.contents().clone())
            .append(j),
            f.replaceWith(g),
            i.css(k),
            j
              .css(k)
              .width(Math.min(i.text('pW' + j[0].value).width(), e))[0]
              .select();
        },
        set_theme: function(b, c) {
          ...
          c &&
            -1 === a.inArray(c, g) &&
            (a('head').append('<link rel="stylesheet" href="' + c + '" type="text/css" />'), g.push(c)),
            ...
            b && '#' !== b.id
              ? ((g = b.icon),
                ...
                c === !1
                  ...
                  : c === !0
                    ? (f
                        .removeClass('jstree-themeicon-custom ' + g)
                        .css('background', '')
                        .removeAttr('rel'),
                      g === !1 && this.show_icon(b))
                    : -1 === c.indexOf('/') && -1 === c.indexOf('.')
                      ? (f.removeClass(g).css('background', ''),
                        f.addClass(c + ' jstree-themeicon-custom').attr('rel', c),
                        g === !1 && this.show_icon(b))
                      : (f.removeClass(g).css('background', ''),
                        f
                          .addClass('jstree-themeicon-custom')
                          .css('background', "url('" + c + "') center center no-repeat")
                          .attr('rel', c),
                        g === !1 && this.show_icon(b)),
                !0)
              : !1
        ...
        (this.bind = function() {
              ...
              this.element.on(
                ...
                a.proxy(function(a, b) {
                  ...
                  for (f = 0, g = e.length; g > f; f++)
                    (c[e[f]].state.checked =
                      c[e[f]].original && c[e[f]].original.state && c[e[f]].original.state.checked),
              ...
              this.element
                  ...
                  a.proxy(function(b, c) {
                    ...
                    if (-1 !== n.indexOf('down'))
                      if (e.state[o ? 'selected' : 'checked']) {
                        ...
                        this._data[o ? 'core' : 'checkbox'].selected = this._data[
                          o ? 'core' : 'checkbox'
                        ].selected.concat(f);
                      } else
                ...
                .on(
                  ...
                  a.proxy(function(b, c) {
                    ...
                    if (-1 !== l.indexOf('down'))
                      for (
                        this._data[m ? 'core' : 'checkbox'].selected = a.vakata.array_unique(
                          this._data[m ? 'core' : 'checkbox'].selected.concat(d.children_d)
                        ),
                          h = 0,
                ...
                .on(
                  ...
                  a.proxy(function(a, b) {
                    var c = this.get_node('#'),
                      ...
                      f,
                      g;
                    for (e = 0, f = c.children_d.length; f > e; e++)
                      (g = d[c.children_d[e]]),
                        g &&
                          g.original &&
                          g.original.state &&
                          g.original.state.undetermined &&
                          (g.original.state.undetermined = !1);
                  }, this)
                )
                .on(
                  ...
                  a.proxy(function(b, c) {
                    ...
                    for (h = [], f = 0, g = this._data[j ? 'core' : 'checkbox'].selected.length; g > f; f++)
                      (-1 !== i.indexOf('down') &&
                        -1 !== a.inArray(this._data[j ? 'core' : 'checkbox'].selected[f], d.children_d)) ||
                        (-1 !== i.indexOf('up') &&
                          -1 !== a.inArray(this._data[j ? 'core' : 'checkbox'].selected[f], d.parents)) ||
              ...
              this.element
                .on(
                  ...
                  a.proxy(function(a, b) {
                    ...
                    while (c && '#' !== c.id) {
                      for (g = 0, e = 0, f = c.children.length; f > e; e++)
                        g += d[c.children[e]].state[i ? 'selected' : 'checked'];
                      if (g !== f) break;
                      (c.state[i ? 'selected' : 'checked'] = !0),
                        ...
                        h &&
                          ...
                          h
                            .attr('aria-selected', !0)
                            .children('.jstree-anchor')
                            .addClass(i ? 'jstree-clicked' : 'jstree-checked'),
          ...
          (this._undetermined = function() {
            ...
            for (
              this.element
                ...
                .each(function() {
                  var a = h.get_node(this),
                    e;
                  if (a.state.loaded)
                    for (b = 0, c = a.children_d.length; c > b; b++)
                      (e = d[a.children_d[b]]),
                        !e.state.loaded &&
                          e.original &&
                          e.original.state &&
                          e.original.state.undetermined &&
                          e.original.state.undetermined === !0 &&
                          (g.push(e.id), (g = g.concat(e.parents)));
                  else
                    a.original &&
                      a.original.state &&
                      a.original.state.undetermined &&
                      a.original.state.undetermined === !0 &&
                      (g.push(a.id), (g = g.concat(a.parents)));
                }),
                g = a.vakata.array_unique(g),
                g = a.vakata.array_remove_item(g, '#'),
              ...
              d[g[b]].state[e ? 'selected' : 'checked'] ||
                ((f = this.get_node(g[b], !0)),
                f &&
                  f.length &&
                  f
                    .children('.jstree-anchor')
          ...
          (this.redraw_node = function(b, d, e, f) {
            if ((b = c.redraw_node.apply(this, arguments))) {
              ...
              i &&
                ...
                i.insertBefore(m.cloneNode(!1), i.childNodes[0]));
            }
            return (
              e ||
                -1 === this.settings.checkbox.cascade.indexOf('undetermined') ||
          ...
          (this.activate_node = function(b, d) {
            return (
              this.settings.checkbox.tie_selection &&
                (this.settings.checkbox.whole_node || a(d.target).hasClass('jstree-checkbox')) &&
                (d.ctrlKey = !0),
              this.settings.checkbox.tie_selection ||
              (!this.settings.checkbox.whole_node && !a(d.target).hasClass('jstree-checkbox'))
                ? c.activate_node.call(this, b, d)
                : this.is_disabled(b)
                  ? !1
                  : (this.is_checked(b) ? this.uncheck_node(b, d) : this.check_node(b, d),
          ...
          (this.check_all = function() {
            ...
            for (
              this._data.checkbox.selected = this._model.data['#'].children_d.concat(),
                b = 0,
                c = this._data.checkbox.selected.length;
              c > b;
              b++
            )
              this._model.data[this._data.checkbox.selected[b]] &&
                (this._model.data[this._data.checkbox.selected[b]].state.checked = !0);
          ...
          (this.is_checked = function(a) {
            return this.settings.checkbox.tie_selection
              ? this.is_selected(a)
              : ((a = this.get_node(a)), a && '#' !== a.id ? a.state.checked : !1);
          }),
        ...
        (this.bind = function() {
          ...
          (this.show_contextmenu = function(c, d, e, f) {
            ...
            (g.show_at_node || d === b || e === b) &&
              ((j = i.offset()), (d = j.left), (e = j.top + this._data.core.li_height)),
        ...
        a(document)
          .on('touchmove.vakata.jstree', function(a) {
            n &&
              ...
              (Math.abs(o - a.pageX) > 50 || Math.abs(p - a.pageY) > 50) &&
              clearTimeout(n);
          })
        ...
        (a.vakata.context = {
          ...
          _execute: function(b) {
            return (
              ...
              b &&
              (!b._disabled ||
                (a.isFunction(b._disabled) && !b._disabled({ item: b, reference: c.reference, element: c.element }))) &&
              b.action
                ? b.action.call(null, {
                    item: b,
                    reference: c.reference,
                  ...
                  ? (c.items.push(d),
                    ...
                    (e +=
                      ...
                      (a.isFunction(d._disabled) &&
                        d._disabled({ item: d, reference: c.reference, element: c.element }))
          ...
          _show_submenu: function(c) {
            if (((c = a(c)), c.length && c.children('ul').length)) {
              ...
              b
                ? c[e - (g + 10 + c.outerWidth()) < 0 ? 'addClass' : 'removeClass']('vakata-context-left')
                : c[e + g + 10 > i ? 'addClass' : 'removeClass']('vakata-context-right'),
              ...
              a.proxy(function(b) {
                if (
                  ...
                  (!this.settings.dnd.touch ||
                    ('selected' === this.settings.dnd.touch && !a(b.currentTarget).hasClass('jstree-clicked')))
                )
                  return !0;
                ...
                return (
                  ...
                  (this.settings.dnd.is_draggable === !0 ||
                    (a.isFunction(this.settings.dnd.is_draggable) &&
                      this.settings.dnd.is_draggable.call(this, d > 1 ? this.get_selected(!0) : [c])))
      ...
      a(function() {
        ...
        a(document)
          ...
          .on('dnd_move.vakata.jstree', function(f, g) {
            if (
              (d && clearTimeout(d),
              g && g.data && g.data.jstree && (!g.event.target.id || 'jstree-marker' !== g.event.target.id))
            ) {
              ...
              if (h && h._data && h._data.dnd)
                if (
                  (e.attr(
                    'class',
                    'jstree-' + h.get_theme() + (h.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '')
                  ),
                  g.helper
                    .children()
                    .attr(
                      ...
                      'jstree-' +
                        ...
                        h.get_theme_variant() +
                        ' ' +
                        (h.settings.core.themes.responsive ? ' jstree-dnd-responsive' : '')
                    )
                    .find('.jstree-copy')
                    .first()
                    [
                      g.data.origin &&
                      (g.data.origin.settings.dnd.always_copy ||
                        (g.data.origin.settings.dnd.copy && (g.event.metaKey || g.event.ctrlKey)))
                        ? 'show'
                        : 'hide'
                    ](),
                  (g.event.target !== h.element[0] && g.event.target !== h.get_container_ul()[0]) ||
                    0 !== h.get_container_ul().children().length)
                ) {
                  if (
                    ((i = a(g.event.target).closest('.jstree-anchor')),
                    i &&
                      i.length &&
                      i.parent().is('.jstree-closed, .jstree-open, .jstree-leaf') &&
                      ((j = i.offset()),
                      (k = g.event.pageY - j.top),
                      (n = i.height()),
                      (q =
                        n / 3 > k
                          ? ['b', 'i', 'a']
                          : k > n - n / 3
                            ...
                            : k > n / 2
                              ? ['i', 'a', 'b']
                              : ['i', 'b', 'a']),
                      a.each(q, function(f, k) {
                        switch (k) {
                          case 'b':
                            (l = j.left - 6), (m = j.top), (o = h.get_parent(i)), (p = i.parent().index());
                            break;
                          case 'i':
                            (x = h.settings.dnd.inside_pos),
                              (y = h.get_node(i.parent())),
                              (l = j.left - 2),
                              (m = j.top + n / 2 + 1),
                              (o = y.id),
                              (p =
                                'first' === x ? 0 : 'last' === x ? y.children.length : Math.min(x, y.children.length));
                            break;
                          case 'a':
                            (l = j.left - 6), (m = j.top + n), (o = h.get_parent(i)), (p = i.parent().index() + 1);
                        }
                        for (r = !0, s = 0, t = g.data.nodes.length; t > s; s++)
                          if (
                            ((u =
                              g.data.origin &&
                              (g.data.origin.settings.dnd.always_copy ||
                            ...
                            'move_node' === u &&
                              ...
                              g.data.origin &&
                              g.data.origin === h &&
                              o === h.get_parent(g.data.nodes[s]) &&
                              ((w = h.get_node(o)), v > a.inArray(g.data.nodes[s], w.children) && (v -= 1)),
                            (r =
                              r &&
                              ((h && h.settings && h.settings.dnd && h.settings.dnd.check_while_dragging === !1) ||
                                h.check(
                                  u,
                                  g.data.origin && g.data.origin !== h
                                    ? g.data.origin.get_node(g.data.nodes[s])
                                    : g.data.nodes[s],
                                  o,
                                  v,
                                  {
                        ...
                        return (
                          'i' === k &&
                            i.parent().is('.jstree-closed') &&
                            h.settings.dnd.open_timeout &&
                            (d = setTimeout(
                              (function(a, b) {
                                return function() {
                                  a.open_node(b);
          ...
          .on('dnd_stop.vakata.jstree', function(f, g) {
            if ((d && clearTimeout(d), g && g.data && g.data.jstree)) {
              ...
              var h,
                ...
                j = [];
              if (b) {
                for (h = 0, i = g.data.nodes.length; i > h; h++)
                  (j[h] = g.data.origin ? g.data.origin.get_node(g.data.nodes[h]) : g.data.nodes[h]),
                    g.data.origin && (j[h].instance = g.data.origin);
                for (
                  b.ins[
                    g.data.origin &&
                    (g.data.origin.settings.dnd.always_copy ||
                  ...
                  j[h].instance && (j[h].instance = null);
              } else
                (h = a(g.event.target).closest('.jstree')),
                  h.length &&
                    c &&
                    c.error &&
                    'check' === c.error &&
                    ((h = h.jstree(!0)), h && h.settings.core.error.call(this, c));
            }
          })
                ...
                c.helper
                  ...
                  [
                    ...
                    (c.data.origin.settings.dnd.always_copy ||
                      (c.data.origin.settings.dnd.copy && (b.metaKey || b.ctrlKey)))
                      ? 'show'
                      : 'hide'
                  ]();
          });
        ...
        a.vakata.dnd = {
          ...
          _clean: function() {
            b.helper && b.helper.remove(),
              ...
              a(document).off('mousemove.vakata.jstree touchmove.vakata.jstree', a.vakata.dnd.drag),
              a(document).off('mouseup.vakata.jstree touchend.vakata.jstree', a.vakata.dnd.stop);
          },
          _scroll: function(c) {
          ...
          start: function(c, d, e) {
            'touchstart' === c.type &&
              ...
              (c.target = document.elementFromPoint(
            ...
            return (
              ...
              a(document).on('mousemove.vakata.jstree touchmove.vakata.jstree', a.vakata.dnd.drag),
              a(document).on('mouseup.vakata.jstree touchend.vakata.jstree', a.vakata.dnd.stop),
              !1
            );
          },
          drag: function(c) {
            if (
                ...
                if (
                  !(
                    Math.abs(c.pageX - b.init_x) >
                      (b.is_touch ? a.vakata.dnd.settings.threshold_touch : a.vakata.dnd.settings.threshold) ||
              ...
              return (
                  ...
                  .each(function() {
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (e.top + d.height() - c.pageY < a.vakata.dnd.settings.scroll_proximity && (b.scroll_t = 1),
                        c.pageY - e.top < a.vakata.dnd.settings.scroll_proximity && (b.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - c.pageX < a.vakata.dnd.settings.scroll_proximity && (b.scroll_l = 1),
                        c.pageX - e.left < a.vakata.dnd.settings.scroll_proximity && (b.scroll_l = -1)),
                ...
                b.scroll_e ||
                  ...
                  (j = d.scrollTop()),
                  (k = d.scrollLeft()),
                  f > g && c.pageY - j < a.vakata.dnd.settings.scroll_proximity && (b.scroll_t = -1),
                  f > g && g - (c.pageY - j) < a.vakata.dnd.settings.scroll_proximity && (b.scroll_t = 1),
                  h > i && c.pageX - k < a.vakata.dnd.settings.scroll_proximity && (b.scroll_l = -1),
                  h > i && i - (c.pageX - k) < a.vakata.dnd.settings.scroll_proximity && (b.scroll_l = 1),
                  (b.scroll_t || b.scroll_l) && (b.scroll_e = d)),
                b.scroll_e && a.vakata.dnd._scroll(!0),
                b.helper &&
                  ((l = parseInt(c.pageY + a.vakata.dnd.settings.helper_top, 10)),
                  (m = parseInt(c.pageX + a.vakata.dnd.settings.helper_left, 10)),
                  f && l + 25 > f && (l = f - 50),
                  h && m + b.helper_w > h && (m = h - (b.helper_w + 2)),
                  b.helper.css({ left: m + 'px', top: l + 'px' })),
        ...
        (this.bind = function() {
          ...
          (this.search = function(c, d, e) {
            ...
            var f = this.settings.search,
              ...
              l;
            return (
              this._data.search.res.length && this.clear_search(),
              e === b && (e = f.show_only_matches),
              d || g === !1
                ? ((this._data.search.str = c),
                  ...
                  (h = new a.vakata.search(c, !0, { caseSensitive: f.case_sensitive, fuzzy: f.fuzzy })),
                  a.each(this._model.data, function(a, b) {
                    b.text &&
                      ((f.search_callback && f.search_callback.call(this, c, b)) ||
                        (!f.search_callback && h.search(b.text).isMatch)) &&
                      (!f.search_leaves_only || (b.state.loaded && 0 === b.children.length)) &&
                      (i.push(a), (j = j.concat(b.parents)));
                  }),
                  i.length &&
                    ((j = a.vakata.array_unique(j)),
                    this._search_open(j),
                    (this._data.search.dom = a(
                      this.element[0].querySelectorAll(
                        '#' +
                    ...
                    (this._data.search.res = i),
                    this._data.search.dom.children('.jstree-anchor').addClass('jstree-search')),
                  void this.trigger('search', {
          ...
          (this._search_open = function(b) {
            ...
            a.each(b.concat([]), function(d, e) {
              ...
              e &&
                e.length &&
                c.is_closed(e) &&
                (c._data.search.opn.push(e[0].id),
                c.open_node(
                  e,
                  function() {
                    c._search_open(b);
      ...
      (function(a) {
        a.vakata.search = function(a, b, c) {
          ...
          return (
            ...
            (k = function(b) {
              if (((b = c.caseSensitive ? b : b.toLowerCase()), a === b || -1 !== b.indexOf(a)))
              ...
              for (
                -1 !== n &&
                  ((m = Math.min(j(0, n), m)), (n = b.lastIndexOf(a, d + g)), -1 !== n && (m = Math.min(j(0, n), m))),
                  n = -1,
                  e = 0;
                g > e;
                e++
                ...
                for (
                  ...
                  if (
                    ...
                    (u[k] =
                      0 === e
                        ? ((u[k + 1] << 1) | 1) & v
                        : (((u[k + 1] << 1) | 1) & v) | (((r[k + 1] | r[k]) << 1) | 1) | r[k + 1]),
                    u[k] & h && ((w = j(e, k - 1)), m >= w))
                  ) {
      ...
      (a.jstree.plugins.sort = function(b, c) {
        (this.bind = function() {
          ...
          (this.sort = function(b, c) {
            ...
            if (
              ((b = this.get_node(b)),
              b && b.children && b.children.length && (b.children.sort(a.proxy(this.settings.sort, this)), c))
            )
      ...
      (a.jstree.plugins.types = function(c, d) {
        (this.init = function(a, c) {
          ...
          if (c && c.types && c.types['default'])
            for (e in c.types)
              if ('default' !== e && '#' !== e && c.types.hasOwnProperty(e))
                for (f in c.types['default'])
                  c.types['default'].hasOwnProperty(f) &&
                    c.types[e][f] === b &&
                    (c.types[e][f] = c.types['default'][f]);
              ...
              a.proxy(function(a, c) {
                ...
                for (g = 0, h = e.length; h > g; g++)
                  (i = 'default'),
                    d[e[g]].original &&
                      d[e[g]].original.type &&
                      f[d[e[g]].original.type] &&
                      (i = d[e[g]].original.type),
                    d[e[g]].data &&
                      d[e[g]].data.jstree &&
                      d[e[g]].data.jstree.type &&
                      f[d[e[g]].data.jstree.type] &&
                      (i = d[e[g]].data.jstree.type),
                    (d[e[g]].type = i),
          ...
          (this.get_type = function(b, c) {
            return (
              (b = this.get_node(b)), b ? (c ? a.extend({ type: b.type }, this.settings.types[b.type]) : b.type) : !1
            );
          }),
      ...
      (a.jstree.plugins.unique = function(c, d) {
        (this.check = function(b, c, e, f, g) {
          ...
          switch ((j || (h = h.toLowerCase()), b)) {
            ...
            case 'move_node':
              return (
                (l = c.parent === e.id || -1 === a.inArray(h, i)),
                l ||
                  (this._data.core.last_error = {
                    error: 'check',
                    plugin: 'unique',
