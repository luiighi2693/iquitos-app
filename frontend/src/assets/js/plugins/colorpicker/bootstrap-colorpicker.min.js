    ...
    (this.value = { h: 0, s: 0, b: 0, a: 1 }),
      ...
      a &&
        (void 0 !== a.toLowerCase
          ? ((a += ''), '#' === a.charAt(0) || (3 !== a.length && 6 !== a.length) || (a = '#' + a), this.setColor(a))
  ...
  b.prototype = {
      ...
      return (
        a.each(this.stringParsers, function(a, e) {
          var f = e.re.exec(b),
            ...
            h = e.format || 'rgba';
          return g
            ? ((d = h.match(/hsla?/) ? c.RGBtoHSB.apply(c, c.HSLtoRGB.apply(c, g)) : c.RGBtoHSB.apply(c, g)),
              (c.origFormat = h),
              !1)
            : !0;
        }),
    ...
    toRGB: function(a, b, c, d) {
      ...
      return (
        ...
        (f += [h, i, i, h, 0, 0][a]),
        (g += [0, 0, h, i, i, h][a]),
        { r: Math.round(255 * e), g: Math.round(255 * f), b: Math.round(255 * g), a: d || this.value.a }
      );
    },
  ...
  (d.version = '2.0.0-beta'),
    ...
    (d.prototype = {
      ...
      show: function(b) {
        return this.isDisabled()
          ...
          : (this.picker.addClass('colorpicker-visible').removeClass('colorpicker-hidden'),
            ...
            this.options.inline === !1 && a(window.document).on({ 'mousedown.colorpicker': a.proxy(this.hide, this) }),
      ...
      update: function(a) {
        ...
        return (
          (this.getValue(!1) !== !1 || a === !0) && (this.updateInput(b), this.updateData(b)), this.updatePicker(), b
        );
      },
      setValue: function(a) {
        (this.color = new b(a)),
