...
(function(a) {
  ...
  (function() {
    ...
    var b,
      ...
      r = String,
      s = 'split',
      t = 'click dblclick mousedown mousemove mouseout mouseover mouseup touchstart touchmove touchend touchcancel'[s](
        q
      ),
      ...
      _ = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi,
      ...
      (function(b) {
        (a[b] = cl[b] = function(c, d) {
          a.is(c, 'function') &&
            ...
            this.events.push({ name: b, f: c, unbind: ch(this.shape || this.node || h.doc, b, c, d || this) }));
          return this;
        }),
        ...
        r = function(b, e) {
          ...
          if (!s) {
            ...
            (k = k.replace(/[\(\)\s,\xb0#]/g, '_')),
              b.gradient && k != b.gradient.id && (p.defs.removeChild(b.gradient), delete b.gradient);
            if (!b.gradient) {
              (s = q(j + 'Gradient', { id: k })),
                (b.gradient = s),
                q(
          ...
          if (d.type == 'path') {
            ...
            if (r != 'none') {
              ...
              a._g.doc.getElementById(A)
                ? p[A]++
                : (h.defs.appendChild(q(q('path'), { 'stroke-linecap': 'round', d: o[r], id: A })), (p[A] = 1));
              ...
              C
                ...
                : ((C = q(q('marker'), {
                  ...
                  (D = q(q('use'), {
                    'xlink:href': '#' + A,
                    transform:
                      (f ? 'rotate(180 ' + x / 2 + ' ' + y / 2 + ') ' : l) + 'scale(' + x / z + ',' + y / z + ')',
                  ...
                  if (!G.error)
                    ...
                    if ('opacity' in k || 'fill-opacity' in k) {
                      ...
                      if (H) {
                        ...
                        q(I[I.length - 1], {
                          'stop-opacity':
                            ('opacity' in k ? k.opacity : 1) * ('fill-opacity' in k ? k['fill-opacity'] : 1)
                        });
                      }
                    }
        ...
        y = function(d, f) {
          if (d.type == 'text' && !!(f[b]('text') || f[b]('font') || f[b]('font-size') || f[b]('x') || f[b]('y'))) {
            var g = d.attrs,
              h = d.node,
              i = h.firstChild
                ? e(a._g.doc.defaultView.getComputedStyle(h.firstChild, l).getPropertyValue('font-size'), 10)
                : 10;
            if (f[b]('text')) {
              g.text = f.text;
      ...
      (z.prototype = A),
        ...
        (A.blur = function(b) {
          ...
          if (+b !== 0) {
            ...
            c._blur && (c._blur.parentNode.removeChild(c._blur), delete c._blur, delete c.attrs.blur),
    ...
    (function(a) {
        ...
        B = function(e, i) {
          ...
          if (
            ...
            if (
              ...
              Q.on = !0;
            (i.stroke == 'none' || i.stroke === null || Q.on == null || i.stroke == 0 || i['stroke-width'] == 0) &&
              (Q.on = !1);
            ...
            (P = h(g(P, 0), 1)),
              ...
              i['stroke-linecap'] &&
                (Q.endcap =
                  i['stroke-linecap'] == 'butt' ? 'flat' : i['stroke-linecap'] == 'square' ? 'square' : 'round');
      ...
      (D.prototype = E),
        ...
        (E.scale = function(a, b, e, f) {
          ...
          (a = c(a).split(k)),
            a.length - 1 &&
              ((b = d(a[1])), (e = d(a[2])), (f = d(a[3])), isNaN(e) && (e = null), isNaN(f) && (f = null)),
            (a = d(a[0])),
            b == null && (b = a),
            f == null && (e = f);
          if (e == null || f == null) var g = this.getBBox(1);
