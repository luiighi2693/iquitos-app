...
!(function(a) {
  ...
  function c(a, b, d) {
    for (var e in b)
      e in a
        ? 'string' == typeof a[e] || a[e] instanceof String || 'string' == typeof b[e] || b[e] instanceof String
          ? d && (a[e] = b[e])
          : c(a[e], b[e], d)
        : (a[e] = b[e]);
    return a;
  ...
  function g(a, b) {
    'function' == typeof a && ((b = a), (a = {})),
      ...
      Y.extend(U, a),
      delete U.fixLng,
      U.functions && (delete U.functions, Y.extend(Y, a.functions)),
      'string' == typeof U.ns && (U.ns = { namespaces: [U.ns], defaultNs: U.ns }),
      'string' == typeof U.fallbackNS && (U.fallbackNS = [U.fallbackNS]),
      ('string' == typeof U.fallbackLng || 'boolean' == typeof U.fallbackLng) && (U.fallbackLng = [U.fallbackLng]),
      (U.interpolationPrefixEscaped = Y.regexEscape(U.interpolationPrefix)),
      (U.interpolationSuffixEscaped = Y.regexEscape(U.interpolationSuffix)),
      U.lng || (U.lng = Y.detectLanguage()),
      (Q = Y.toLanguages(U.lng)),
      (L = Q[0]),
      Y.log('currentLng set to: ' + L),
      U.useCookie &&
        Y.cookie.read(U.cookieName) !== L &&
        Y.cookie.create(U.cookieName, L, U.cookieExpirationTime, U.cookieDomain),
      U.detectLngFromLocalStorage &&
    ...
    if ((M && M.Deferred && (d = M.Deferred()), !U.resStore)) {
      ...
      for (var f = 0, g = U.preload.length; g > f; f++)
        for (var h = Y.toLanguages(U.preload[f]), i = 0, j = h.length; j > i; i++) e.indexOf(h[i]) < 0 && e.push(h[i]);
      return (
        N.sync.load(e, U, function(a, e) {
  ...
  function j(a, b, c, d, e) {
    'string' != typeof b ? ((c = b), (b = U.ns.defaultNs)) : U.ns.namespaces.indexOf(b) < 0 && U.ns.namespaces.push(b),
      (O[a] = O[a] || {}),
      (O[a][b] = O[a][b] || {}),
      d ? Y.deepExtend(O[a][b], c, e) : Y.extend(O[a][b], c),
  ...
  function m(a, b) {
    'string' != typeof b && (b = U.ns.defaultNs),
      (O[a] = O[a] || {}),
      (O[a][b] = {}),
      U.useLocalStorage && S._storeLocal(O);
  }
  function n(a, b, c, d) {
    'string' != typeof b
      ? ((resource = b), (b = U.ns.defaultNs))
      : U.ns.namespaces.indexOf(b) < 0 && U.ns.namespaces.push(b),
      (O[a] = O[a] || {}),
      (O[a][b] = O[a][b] || {});
    for (var e = c.split(U.keyseparator), f = 0, g = O[a][b]; e[f]; )
  ...
  function r(a, b) {
    ...
    for (var e = 0, f = U.preload.length; f > e; e++)
      for (var g = Y.toLanguages(U.preload[e]), h = 0, i = g.length; i > h; h++) d.indexOf(g[h]) < 0 && d.push(g[h]);
    ...
    j.length
      ? N.sync._fetch(j, c, function(c, d) {
          var e = a.length * j.length;
          Y.each(a, function(a, c) {
            U.ns.namespaces.indexOf(c) < 0 && U.ns.namespaces.push(c),
              Y.each(j, function(a, f) {
                (O[f] = O[f] || {}),
                  (O[f][c] = d[f][c]),
                  e--,
                  0 === e && b && (U.useLocalStorage && N.sync._storeLocal(O), b());
              });
          });
        })
      : b && b();
  ...
  function x() {
    function a(a, b, c) {
      if (0 !== b.length) {
        ...
        var f;
        if ('html' === d)
          (f = U.defaultValueFromContent ? M.extend({ defaultValue: a.html() }, c) : c), a.html(M.t(b, f));
        else if ('text' === d)
          (f = U.defaultValueFromContent ? M.extend({ defaultValue: a.text() }, c) : c), a.text(M.t(b, f));
        else if ('prepend' === d)
          (f = U.defaultValueFromContent ? M.extend({ defaultValue: a.html() }, c) : c), a.prepend(M.t(b, f));
        else if ('append' === d)
          (f = U.defaultValueFromContent ? M.extend({ defaultValue: a.html() }, c) : c), a.append(M.t(b, f));
        else if (0 === d.indexOf('data-')) {
          var g = d.substr('data-'.length);
          f = U.defaultValueFromContent ? M.extend({ defaultValue: a.data(g) }, c) : c;
          var h = M.t(b, f);
          a.data(g, h), a.attr(d, h);
        } else (f = U.defaultValueFromContent ? M.extend({ defaultValue: a.attr(d) }, c) : c), a.attr(d, M.t(b, f));
      }
    }
    function b(b, c) {
      ...
      if ((d || 'undefined' == typeof d || d === !1 || (d = b.text() || b.val()), d)) {
        ...
        if (
          (f && (e = b.find(f) || b),
          c || U.useDataAttrOptions !== !0 || (c = b.data('i18n-options')),
          (c = c || {}),
          d.indexOf(';') >= 0)
        ) {
          var g = d.split(';');
        ...
        b.indexOf(';') === b.length - 1 && (b = b.substr(0, b.length - 2)),
          'html' === d
            ...
            : 'text' === d
              ? (a.textContent = F(b, c))
              : 'prepend' === d
                ? a.insertAdjacentHTML(F(b, c), 'afterbegin')
                : 'append' === d
                  ? a.insertAdjacentHTML(F(b, c), 'beforeend')
                  : a.setAttribute(d, F(b, c));
      }
    }
    function b(b, c) {
  ...
  function A(a, b) {
    var c = ',',
      ...
      f = Y.extend({}, b);
    for (
      delete f.postProcess, delete f.isFallbackLookup;
      -1 != a.indexOf(U.reusePrefix) && (P++, !(P > U.maxRecursion));
  ...
  function I(a, b) {
    if (
      ('undefined' != typeof b && 'object' != typeof b
        ? 'sprintf' === U.shortcutFunction
          ? (b = H.apply(null, arguments))
          : 'defaultValue' === U.shortcutFunction && (b = { defaultValue: b })
        : (b = b || {}),
      'object' == typeof U.defaultVariables && (b = Y.extend({}, U.defaultVariables, b)),
      void 0 === a || null === a || '' === a)
    )
      return '';
    'number' == typeof a && (a = String(a)), 'string' == typeof a && (a = [a]);
    var c = a[0];
    if (a.length > 1) for (var d = 0; d < a.length && ((c = a[d]), !E(c, b)); d++);
    var e,
      f = G(c, b),
      g = J(c, b),
    ...
    c.indexOf(h) > -1 && ((e = c.split(h)), (j = e[0]), (c = e[1])),
      void 0 === g &&
        U.sendMissing &&
        'function' == typeof U.missingKeyHandler &&
        (b.lng ? U.missingKeyHandler(i[0], j, c, f, i) : U.missingKeyHandler(U.lng, j, c, f, i));
    var k;
    (k =
      'string' == typeof U.postProcess && '' !== U.postProcess
        ? [U.postProcess]
        : 'array' == typeof U.postProcess || 'object' == typeof U.postProcess
          ? U.postProcess
          : []),
      'string' == typeof b.postProcess && '' !== b.postProcess
        ? (k = k.concat([b.postProcess]))
        : ('array' == typeof b.postProcess || 'object' == typeof b.postProcess) && (k = k.concat(b.postProcess)),
      void 0 !== g &&
        k.length &&
    ...
    var l = f;
    return (
      f.indexOf(h) > -1 && ((e = f.split(h)), (l = e[1])),
      l === c && U.parseMissingKey && (f = U.parseMissingKey(f)),
      void 0 === g &&
        ((f = z(f, b)),
        (f = A(f, b)),
        k.length &&
  ...
  function J(a, b) {
    ...
    if (B(b)) {
      ...
      if (((d = F(k, c)), d != U.contextNotFound)) return z(d, { context: b.context });
    }
    if (C(b, f[0])) {
      (c = Y.extend({ lngs: [f[0]] }, b)),
        delete c.count,
        (c._origLng = c._origLng || c.lng || f[0]),
        delete c.lng,
        (c.defaultValue = U.pluralNotFound);
      var l;
        ...
        if ('string' == typeof x) (x = z(x, b)), (x = A(x, b));
          ...
          if (null === x && U.fallbackOnNull === !0) x = void 0;
            ...
            if (U.returnObjectTrees || b.returnObjectTrees) {
              ...
              U.objectTreeKeyHandler && 'function' == typeof U.objectTreeKeyHandler
                ? (x = U.objectTreeKeyHandler(a, x, v, h, b))
                : ((x = "key '" + h + ':' + a + ' (' + v + ")' returned an object instead of string."), Y.log(x));
        } else (x = x.join('\n')), (x = z(x, b)), (x = A(x, b));
    ...
    if (
      void 0 === q &&
      !b.isFallbackLookup &&
      (U.fallbackToDefaultNS === !0 || (U.fallbackNS && U.fallbackNS.length > 0))
    ) {
  ...
  function K() {
    ...
    if ('undefined' != typeof navigator) {
      if (navigator.languages) for (var f = 0; f < navigator.languages.length; f++) c.push(navigator.languages[f]);
  ...
  'undefined' != typeof module && module.exports
    ? (module.exports = N)
    : (M && (M.i18n = M.i18n || N), a.i18n && (T = a.i18n), (a.i18n = N)),
    (S = {
      load: function(a, b, c) {
        b.useLocalStorage
          ? S._loadLocal(a, b, function(d, e) {
              for (var f = [], g = 0, h = a.length; h > g; g++) e[a[g]] || f.push(a[g]);
              f.length > 0
                ? S._fetch(f, b, function(a, b) {
      ...
      _storeLocal: function(a) {
        if (window.localStorage)
          for (var b in a)
            (a[b].i18nStamp = new Date().getTime()), Y.localStorage.setItem('res_' + b, JSON.stringify(a[b]));
      },
      _fetch: function(a, b, c) {
        ...
        if (b.dynamicLoad) {
          ...
          if ('function' == typeof b.customLoad) b.customLoad(a, d.namespaces, b, f);
            ...
            var g = z(b.resGetPath, { lng: a.join('+'), ns: d.namespaces.join('+') });
            Y.ajax({
              url: g,
              cache: b.cache,
              success: function(a) {
              ...
              error: function(a, b, c) {
                Y.log('failed loading: ' + g), f('failed loading resource.json error: ' + c);
              },
              dataType: 'json',
              async: b.getAsync,
          ...
          Y.each(d.namespaces, function(d, f) {
            Y.each(a, function(a, d) {
              ...
              'function' == typeof b.customLoad ? b.customLoad(d, f, b, g) : S._fetchOne(d, f, b, g);
            });
          });
        }
      },
      _fetchOne: function(a, b, c, d) {
        var e = z(c.resGetPath, { lng: a, ns: b });
        Y.ajax({
          url: e,
          cache: c.cache,
          success: function(a) {
          ...
          error: function(a, b, c) {
            if ((b && 200 == b) || (a && a.status && 200 == a.status)) Y.error('There is a typo in: ' + e);
            else if ((b && 404 == b) || (a && a.status && 404 == a.status)) Y.log('Does not exist: ' + e);
            else {
      ...
      postMissing: function(a, b, c, d, e) {
        ...
        if ('fallback' === U.sendMissingTo && U.fallbackLng[0] !== !1)
          for (var h = 0; h < U.fallbackLng.length; h++)
            g.push({ lng: U.fallbackLng[h], url: z(U.resPostPath, { lng: U.fallbackLng[h], ns: b }) });
        else if ('current' === U.sendMissingTo || ('fallback' === U.sendMissingTo && U.fallbackLng[0] === !1))
          g.push({ lng: a, url: z(U.resPostPath, { lng: a, ns: b }) });
        else if ('all' === U.sendMissingTo)
          for (var h = 0, i = e.length; i > h; h++) g.push({ lng: e[h], url: z(U.resPostPath, { lng: e[h], ns: b }) });
        for (var j = 0, k = g.length; k > j; j++) {
          ...
          Y.ajax({
            ...
            success: function() {
              ...
              for (var a = c.split('.'), e = 0, f = O[l.lng][b]; a[e]; )
  ...
  var Z = [
    ...
    $ = {
      ...
      4: function(a) {
        return Number(
          a % 10 == 1 && a % 100 != 11 ? 0 : a % 10 >= 2 && 4 >= a % 10 && (10 > a % 100 || a % 100 >= 20) ? 1 : 2
        );
      },
      5: function(a) {
        return Number(
          0 === a ? 0 : 1 == a ? 1 : 2 == a ? 2 : a % 100 >= 3 && 10 >= a % 100 ? 3 : a % 100 >= 11 ? 4 : 5
        );
      },
      6: function(a) {
    ...
    _ = {
      rules: (function() {
        var a,
          b = {};
        for (a = Z.length; a--; ) b[Z[a][0]] = { name: Z[a][1], numbers: Z[a][2], plurals: $[Z[a][3]] };
        return b;
      })(),
      ...
      setCurrentLng: function(a) {
        if (!_.currentRule || _.currentRule.lng !== a) {
          var b = a.split('-');
          _.currentRule = { lng: a, rule: _.rules[b[0]] };
        }
      },
      needsPlural: function(a, b) {
        var c,
          d = a.split('-');
        return (
          (c = _.currentRule && _.currentRule.lng === a ? _.currentRule.rule : _.rules[d[Y.getCountyIndexOfLng(a)]]),
            ...
            if (((n = a(c[f])), 'string' === n)) o.push(c[f]);
              ...
              if (((h = c[f]), h[2]))
                for (e = d[l], g = 0; g < h[2].length; g++) {
                  if (!e.hasOwnProperty(h[2][g])) throw ca('[sprintf] property "%s" does not exist', h[2][g]);
                  e = e[h[2][g]];
                }
              else e = h[1] ? d[h[1]] : d[l++];
              if (/[^s]/.test(h[8]) && 'number' != a(e)) throw ca('[sprintf] expecting number but found %s', a(e));
              switch (h[8]) {
                case 'b':
                  e = e.toString(2);
                  break;
        ...
        (c.parse = function(a) {
          for (var b = a, c = [], d = [], e = 0; b; ) {
            if (null !== (c = /^[^\x25]+/.exec(b))) d.push(c[0]);
              ...
              if (
                null ===
                (c = /^\x25(?:([1-9]\d*)\$|\(([^\)]+)\))?(\+)?(0|'[^$])?(-)?(\d+)?(?:\.(\d+))?([b-fosuxX])/.exec(b))
              )
                throw '[sprintf] huh?';
  ...
  ba('sprintf', function(a, b, c) {
    ...
    (N.setLng = s),
    (N.preload = i),
    (N.addResourceBundle = j),
    (N.hasResourceBundle = k),
    (N.getResourceBundle = l),
    (N.addResource = n),
    (N.addResources = o),
    (N.removeResourceBundle = m),
    (N.loadNamespace = q),
    (N.loadNamespaces = r),
    (N.setDefaultNamespace = p),
    (N.t = F),
    (N.translate = F),
    (N.exists = E),
    (N.detectLanguage = Y.detectLanguage),
    (N.pluralExtensions = _),
    (N.sync = S),
    (N.functions = Y),
    (N.lng = t),
    (N.dir = u),
    (N.addPostProcessor = ba),
    (N.applyReplacement = Y.applyReplacement),
    (N.options = U),
    (N.noConflict = w);
