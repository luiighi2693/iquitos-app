              ...
              this.$results.attr('id', d),
                ...
                a.fn.mousewheel &&
                  this.$results.on('mousewheel', function(a) {
                    ...
                    e
                      ? (c.$results.scrollTop(0), a.preventDefault(), a.stopPropagation())
                      : f &&
                        (c.$results.scrollTop(c.$results.get(0).scrollHeight - c.$results.height()),
                        a.preventDefault(),
                        a.stopPropagation());
                  }),
                this.$results.on('mouseup', '.select2-results__option[aria-selected]', function(b) {
                  ...
                  return 'true' === d.attr('aria-selected')
                    ? void (c.options.get('multiple')
                        ? c.trigger('unselect', { originalEvent: b, data: e })
                        : c.trigger('close'))
                ...
                this.$results.on('mouseenter', '.select2-results__option[aria-selected]', function() {
                  ...
                  c.getHighlightedResults().removeClass('select2-results__option--highlighted'),
                    c.trigger('results:focus', { data: b, element: a(this) });
                });
            }),
        ...
        b.define('select2/data/tokenizer', ['jquery'], function(a) {
          ...
          return (
            ...
            (b.prototype.query = function(a, b, c) {
              ...
              f.term !== b.term &&
                (this.$search.length && (this.$search.val(f.term), this.$search.focus()), (b.term = f.term)),
                a.call(this, b, c);
            }),
            ...
            (e.prototype._registerDomEvents = function() {
              ...
              null != d
                ...
                : this.$element[0].addEventListener &&
                  this.$element[0].addEventListener('DOMAttrModified', b._sync, !1);
            }),
              ...
              this.on('open', function() {
                ...
                this.on('keypress', function(b) {
                  ...
                  a.isOpen()
                    ...
                    : (c === d.ENTER || c === d.SPACE || ((c === d.DOWN || c === d.UP) && b.altKey)) &&
              ...
              this.$container.remove(),
                ...
                null != this._observer
                  ...
                  : this.$element[0].removeEventListener &&
                    this.$element[0].removeEventListener('DOMAttrModified', this._sync, !1),
                (this._sync = null),
