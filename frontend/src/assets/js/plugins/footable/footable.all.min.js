    ...
    return (
      ...
      (r.redraw = function() {
        ...
        t
          ...
          .each(function() {
            ...
            if (
              ('' !== a &&
                (i.hide[a] === !1 ? l.addClass('footable-visible').show() : l.removeClass('footable-visible').hide()),
      ...
      (r.toggleDetail = function(t) {
        ...
        a.hasClass(d.detailShow)
          ? (a.removeClass(d.detailShow), i.hasClass(d.detail) && i.hide(), r.raise(s.rowCollapsed, { row: a[0] }))
    ...
    plugins: {
        ...
        if (!e.isFunction(a))
          return (
            t.footable.options.debug === !0 &&
              console.error('Validation failed, expected type "function", received type "{0}".', typeof a),
            !1
          );
        var i = new a();
        return 'string' != typeof i.name
          ? (t.footable.options.debug === !0 &&
              console.error('Validation failed, plugin does not implement a string property called "name".', i),
            !1)
          : e.isFunction(i.init)
            ? (t.footable.options.debug === !0 && console.log('Validation succeeded for plugin "' + i.name + '".', i),
              !0)
            : (t.footable.options.debug === !0 &&
                console.error(
      ...
      register: function(a, i) {
        t.footable.plugins._validate(a) &&
          (t.footable.plugins.registered.push(a), 'object' == typeof i && e.extend(!0, t.footable.options, i));
      },
      load: function(e) {
        var a,
          i,
    ...
    (a.name = 'Footable Grid'),
      (a.init = function(t) {
        ...
        if (f.cols) {
          ...
          u.data('grid', a),
            ...
            f.showIndex &&
              f.cols.unshift({ title: '#', name: 'index', data: { 'sort-ignore': !0 }, formatter: f.indexFormatter }),
            o(u, f),
            i(u),
      ...
      (a.newItem = function(t, o, i) {
        ...
        if (e.isPlainObject(t)) {
          ...
          i || (a.footable.redraw(), a.footable.raise(a.footable.options.grid.events.created, { item: t, index: o }));
        }
      }),
      ...
      (t.createNavigation = function(a) {
        ...
        if (0 !== i.length) {
          ...
          (o.control = i),
            o.pages.length > 0 &&
              (i.append(
                '<li class="footable-page-arrow"><a data-page="first" href="#first">' + a.pageInfo.firstText + '</a>'
              ),
              i.append(
              ...
              o.limit ||
                e.each(o.pages, function(e, t) {
                  t.length > 0 &&
                    i.append('<li class="footable-page"><a data-page="' + e + '" href="#">' + (e + 1) + '</a></li>');
                }),
              o.limit &&
                (i.append(
              ...
              i.append(
                '<li class="footable-page-arrow"><a data-page="next" href="#next">' + a.pageInfo.nextText + '</a></li>'
              ),
              i.append(
                '<li class="footable-page-arrow"><a data-page="last" href="#last">' + a.pageInfo.lastText + '</a></li>'
              )),
        ...
        for (i = t.pages.length - 1; i >= 0; i--)
          (o = t.pages[i]),
            i >= a &&
              ...
              o.length > 0 &&
              n.after('<li class="footable-page"><a data-page="' + i + '" href="#">' + (i + 1) + '</a></li>');
                ...
                'footable_initialized.sorting': function() {
                  ...
                  if (n.data('sort') !== !1) {
                    n.find('> thead > tr:last-child > th, > thead > tr:last-child > td').each(function() {
                      ...
                      n
                        .find(
                          '> thead > tr:last-child > th.' + r.sortable + ', > thead > tr:last-child > td.' + r.sortable
                        )
                        .unbind('click.footable')
                        .bind('click.footable', function(a) {
      ...
      (e.doSort = function(a, i) {
        ...
        if (t(o.table).data('sort') !== !1) {
          ...
          (u && u.result === !1) ||
            ...
            i ? s.removeClass(d.descending).addClass(d.sorted) : s.removeClass(d.sorted).addClass(d.descending),
            e.sort(o, r, l, i),
