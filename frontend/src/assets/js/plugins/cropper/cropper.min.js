  ...
  (H.prototype = {
    ...
    load: function() {
      var b,
        ...
        h = this.image,
        i = '';
      f.is('img') ? (c = f.prop('src')) : f.is('canvas') && this.support.canvas && (c = g.toDataURL()),
        c &&
          (this.replaced && (h.rotate = 0),
          this.defaults.checkImageOrigin && (f.prop('crossOrigin') || this.isCrossOriginURL(c)) && (i = ' crossOrigin'),
    ...
    build: function() {
      ...
      this.ready &&
        ...
        b.isDefaultPrevented() ||
          ...
          !g.resizable && this.$dragger.find('.cropper-line, .cropper-point').addClass(q),
    ...
    preview: function() {
      var b = this.image,
        ...
        f = c.left - b.left,
        g = c.top - b.top;
      this.$viewer.find('img').css({ width: I(d), height: I(e), marginLeft: -I(f), marginTop: -I(g) }),
    ...
    initCropper: function() {
      ...
      (c.naturalWidth * b.height) / c.naturalHeight - b.width >= 0
        ? ((a = { width: b.width, height: b.width / c.aspectRatio, left: 0 }), (a.top = (b.height - a.height) / 2))
        : ((a = { width: b.height * c.aspectRatio, height: b.height, top: 0 }), (a.left = (b.width - a.width) / 2)),
        this.$cropper.css({ width: I(a.width), height: I(a.height), left: I(a.left), top: I(a.top) }),
        (this.cropper = a);
    },
    initImage: function() {
      var b = this.image,
      ...
      (this.defaultImage = a.extend({}, b, d)),
        b._width !== c.width || b._height !== c.height
          ? a.extend(b, d)
          : ((b = a.extend({}, d, b)), this.replaced && ((this.replaced = f), (b.ratio = d.ratio))),
        (this.image = b),
        this.renderImage();
    },
    renderImage: function(a) {
      ...
      'zoom' === a && ((b.left -= (b.width - b.oldWidth) / 2), (b.top -= (b.height - b.oldHeight) / 2)),
        ...
        this.$clone.css({ width: I(b.width), height: I(b.height), marginLeft: I(b.left), marginTop: I(b.top) }),
    ...
    initDragger: function() {
      ...
      (b =
        ...
        c.aspectRatio
          ? (isFinite(c.maxWidth)
              ? ((b.maxWidth = K(b.maxWidth, c.maxWidth * f)), (b.maxHeight = b.maxWidth / e))
              : isFinite(c.maxHeight) &&
                ((b.maxHeight = K(b.maxHeight, c.maxHeight * f)), (b.maxWidth = b.maxHeight * e)),
            c.minWidth > 0
              ? ((b.minWidth = L(0, c.minWidth * f)), (b.minHeight = b.minWidth / e))
              : c.minHeight > 0 && ((b.minHeight = L(0, c.minHeight * f)), (b.minWidth = b.minHeight * e)))
    ...
    renderDragger: function() {
      ...
      a.width > a.maxWidth
        ...
        : a.width < a.minWidth && ((a.width = a.minWidth), (a.left = a.oldLeft)),
        a.height > a.maxHeight
          ? ((a.height = a.maxHeight), (a.top = a.oldTop))
          : a.height < a.minHeight && ((a.height = a.minHeight), (a.top = a.oldTop)),
        ...
        this.$dragger.css({ width: I(a.width), height: I(a.height), left: I(a.left), top: I(a.top) }),
        this.preview();
    },
    reset: function(b) {
      this.cropped &&
    ...
    setData: function(b, c) {
      ...
      this.built &&
        typeof b !== j &&
        ((b === g || a.isEmptyObject(b)) && (e = a.extend({}, this.defaultDragger)),
        a.isPlainObject(b) &&
          !a.isEmptyObject(b) &&
          ...
          h
            ...
            : (G(b.width) && b.width <= e.maxWidth && b.width >= e.minWidth && (e.width = b.width),
              G(b.height) && b.height <= e.maxHeight && b.height >= e.minHeight && (e.height = b.height))),
        (this.dragger = e),
        this.renderDragger());
    },
    getData: function(a) {
      ...
      return (
        this.built &&
          ((d = { x: b.left - c.left, y: b.top - c.top, width: b.width, height: b.height }),
    ...
    setAspectRatio: function(a) {
      ...
      (a = P(a)),
        (b || (!isNaN(a) && a > 0)) &&
          ((this.defaults.aspectRatio = b ? h : a), this.built && (this.initDragger(), this.renderDragger()));
    },
    ...
    getDataURL: function(b, c, d) {
      ...
      return (
        ...
        this.cropped &&
          ...
          (f.height = b.height),
          (e = f.getContext('2d')),
          'image/jpeg' === c && ((e.fillStyle = '#fff'), e.fillRect(0, 0, b.width, b.height)),
          e.drawImage(this.$clone[0], g.x, g.y, g.width, g.height, 0, 0, b.width, b.height),
          (h = f.toDataURL(c, d))),
        h
      );
    },
    ...
    rotate: function(a) {
      ...
      (a = P(a) || 0),
        this.built &&
          ...
          this.support.canvas &&
          ((this.rotated = e), (a = b.rotate = (b.rotate + a) % 360), this.replace(this.getRotatedDataURL(a), !0));
    },
    ...
    wheel: function(a) {
      ...
      this.disabled ||
        (a.preventDefault(),
        c.deltaY
          ? ((b = c.deltaY), (b = b % e === 0 ? b / e : b % d === 0 ? b / d : b / f))
          : (b = c.wheelDelta ? -c.wheelDelta / 120 : c.detail ? c.detail / 3 : 0),
        this.zoom(b * g));
    },
      ...
      switch ((s && ((t.X = t.y * s), (t.Y = t.x / s)), b)) {
        ...
        case 'ne':
          if (s) {
            ...
            t.x >= 0 ? (g > n ? (j += t.x) : t.y <= 0 && 0 >= m && (p = f)) : (j += t.x),
        ...
        case 'nw':
          if (s) {
            ...
            t.x <= 0 ? (l > 0 ? ((j -= t.x), (l += t.x)) : t.y <= 0 && 0 >= m && (p = f)) : ((j -= t.x), (l += t.x)),
              t.y <= 0 ? m > 0 && ((k -= t.y), (m += t.y)) : ((k -= t.y), (m += t.y));
          0 > k && ((b = 'se'), (k = 0), (j = 0));
          break;
        case 'sw':
          if (s) {
            ...
            t.x <= 0 ? (l > 0 ? ((j -= t.x), (l += t.x)) : t.y >= 0 && o >= h && (p = f)) : ((j -= t.x), (l += t.x)),
        ...
        case 'se':
          if (s) {
            ...
            t.x >= 0 ? (g > n ? (j += t.x) : t.y >= 0 && o >= h && (p = f)) : (j += t.x),
              t.y >= 0 ? h > o && (k += t.y) : (k += t.y);
          0 > j && ((b = 'nw'), (k = 0), (j = 0));
          break;
        case 'move':
