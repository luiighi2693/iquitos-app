!(function(a) {
  ...
  'function' == typeof define && define.amd
    ? define(['./blueimp-helper'], a)
    : ((window.blueimp = window.blueimp || {}), (window.blueimp.Gallery = a(window.blueimp.helper || window.jQuery)));
})(function(a) {
  'use strict';
  function b(a, c) {
    ...
    a.extend(b.prototype, {
            ...
            document.body.appendChild(b),
              ...
              void 0 !== b.style.backgroundSize &&
                ...
                (c.backgroundSize.contain =
                  'contain' === window.getComputedStyle(b).getPropertyValue('background-size')),
        ...
        return (
          ...
          this.initWidget() === !1
            ...
            : (this.initEventListeners(),
              ...
              void (this.options.startSlideshow && this.play()))
        );
      },
      slide: function(a, b) {
            ...
            for (
              this.options.continuous || (a = this.circle(a)),
                ...
                this.options.continuous &&
                  ((d = c),
                  (c = -this.positions[this.circle(a)] / this.slideWidth),
                  c !== d && (a = -c * this.num + a)),
                e = Math.abs(f - a) - 1;
              e;
        ...
        for (
          a.concat || (a = Array.prototype.slice.call(a)),
            ...
            this.num > 2 &&
              ...
              ((this.options.continuous = !0), this.container.removeClass(this.options.leftEdgeClass)),
      ...
      handleClose: function() {
        ...
        this.destroyEventListeners(),
          ...
          this.container
            .removeClass(a.displayClass)
            .removeClass(a.singleClass)
            .removeClass(a.leftEdgeClass)
            .removeClass(a.rightEdgeClass),
      ...
      close: function() {
        ...
        this.options.onclose && this.options.onclose.call(this),
          this.support.transition && this.options.displayTransition
            ? (this.container.on(this.support.transition.end, b), this.container.removeClass(this.options.displayClass))
            : this.handleClose();
      },
      circle: function(a) {
      ...
      animate: function(a, b, c) {
        ...
        var d = this,
          ...
          f = window.setInterval(function() {
            ...
            return g > c
              ? ((d.slidesContainer[0].style.left = b + 'px'), d.ontransitionend(), void window.clearInterval(f))
              : void (d.slidesContainer[0].style.left = (b - a) * (Math.floor((g / c) * 100) / 100) + a + 'px');
          }, 4);
      },
      ...
      onmousemove: function(a) {
        this.touchStart &&
          (((a.originalEvent || a).touches = [{ pageX: a.pageX, pageY: a.pageY }]), this.ontouchmove(a));
      },
      ...
      ontouchstart: function(a) {
        ...
        (this.touchStart = { x: b.pageX, y: b.pageY, time: Date.now() }),
        ...
        if (!(d.length > 1 || (e && 1 !== e)))
          if (
            ...
            void 0 === this.isScrolling &&
              (this.isScrolling = this.isScrolling || Math.abs(b) < Math.abs(this.touchDelta.y)),
            this.isScrolling)
          )
            ...
            for (
              a.preventDefault(),
                ...
                this.options.continuous
                  ...
                  : ((this.touchDelta.x = b /=
                      (!f && b > 0) || (f === this.num - 1 && 0 > b) ? Math.abs(b) / this.slideWidth + 1 : 1),
                    (c = [f]),
                    f && c.push(f - 1),
                    f < this.num - 1 && c.unshift(f + 1));
              c.length;
      ...
      ontouchend: function(a) {
        ...
        var b,
          ...
          m =
            ...
            ((j && Math.abs(this.touchDelta.y) > 20) || Math.abs(this.touchDelta.y) > this.slideHeight / 2);
          ...
          this.isScrolling
            ...
            : k && !l
              ? ((c = g + b),
                ...
                (f = -i * b),
                this.options.continuous
                  ? (this.move(this.circle(c), e, 0), this.move(this.circle(g - 2 * b), f, 0))
                  : c >= 0 && c < this.num && this.move(c, e, 0),
      ...
      ontransitionend: function(a) {
        ...
        (a && b !== a.target) ||
          (this.interval && this.play(), this.setTimeout(this.options.onslideend, [this.index, b]));
      },
      oncomplete: function(b) {
        ...
        d &&
          ...
          'error' === b.type
            ? (a(e).addClass(this.options.slideErrorClass), (this.elements[c] = 3))
            : (this.elements[c] = 2),
              ...
              : f(c.closeClass)
                ...
                : f(c.playPauseClass)
                  ...
                  : e === this.slidesContainer[0]
                    ...
                    : e.parentNode &&
                      e.parentNode === this.slidesContainer[0] &&
                      (this.preventDefault(b), this.toggleControls());
      },
      onclick: function(a) {
        return this.options.emulateTouchEvents &&
          this.touchDelta &&
          (Math.abs(this.touchDelta.x) > 20 || Math.abs(this.touchDelta.y) > 20)
          ? void delete this.touchDelta
          : this.handleClick(a);
      },
          ...
          k = function(b) {
            if (!d) {
              ...
              (d = !0),
                ...
                j &&
                  'load' === b.type &&
                  ((e.style.background = 'url("' + i + '") center no-repeat'), (e.style.backgroundSize = j)),
                c(b);
            }
          };
        return (
          'string' != typeof i &&
            ((i = this.getItemProperty(b, this.options.urlProperty)),
      ...
      createElement: function(b, c) {
        var d = b && this.getItemProperty(b, this.options.typeProperty),
          ...
          f = b && e.call(this, b, c);
        return (
          f || ((f = this.elementPrototype.cloneNode(!1)), this.setTimeout(c, [{ type: 'error', target: f }])),
      ...
      loadElement: function(b) {
        this.elements[b] ||
          (this.slides[b].firstChild
            ...
            : ((this.elements[b] = 1),
              a(this.slides[b]).addClass(this.options.slideLoadingClass),
              this.slides[b].appendChild(this.createElement(this.list[b], this.proxyListener))));
      },
      ...
      unloadElements: function(a) {
        ...
        for (b in this.elements)
          this.elements.hasOwnProperty(b) &&
            ((d = Math.abs(a - b)),
            d > this.options.preloadRange &&
              d + this.options.preloadRange < this.num &&
              ((c = this.slides[b]), c.removeChild(c.firstChild), delete this.elements[b]));
      },
      addSlide: function(a) {
      ...
      positionSlide: function(a) {
        ...
        (b.style.width = this.slideWidth + 'px'),
          this.support.transform &&
            ((b.style.left = a * -this.slideWidth + 'px'),
      ...
      getItemProperty: function(a, b) {
        var c = a[b];
        return (
          void 0 === c && ((c = this.getDataProperty(a, b)), void 0 === c && (c = this.getNestedProperty(a, b))), c
        );
      },
      ...
      initEventListeners: function() {
        ...
        a(window).on('resize', d),
          ...
          this.support.touch
            ? c.on('touchstart touchmove touchend touchcancel', d)
            : this.options.emulateTouchEvents &&
              this.support.transition &&
              c.on('mousedown mousemove mouseup mouseout', d),
      ...
      destroyEventListeners: function() {
        ...
        a(window).off('resize', c),
          ...
          this.support.touch
            ? b.off('touchstart touchmove touchend touchcancel', c)
            : this.options.emulateTouchEvents &&
              this.support.transition &&
              b.off('mousedown mousemove mouseup mouseout', c),
            ...
            ? ((this.slidesContainer = this.container.find(this.options.slidesContainer).first()),
              this.slidesContainer.length
                ? ((this.titleElement = this.container.find(this.options.titleElement).first()),
                  ...
                  this.support.transition && this.options.displayTransition
                    ? this.container.on(this.support.transition.end, c)
                    : this.handleOpen(),
      ...
      initOptions: function(b) {
        (this.options = a.extend({}, this.options)),
          ((b && b.carousel) || (this.options.carousel && (!b || b.carousel !== !1))) &&
            a.extend(this.options, this.carouselOptions),
  ...
  (function(a) {
    'use strict';
    'function' == typeof define && define.amd
      ? define(['./blueimp-helper', './blueimp-gallery'], a)
      : a(window.blueimp.helper || window.jQuery, window.blueimp.Gallery);
  })(function(a, b) {
    'use strict';
      ...
      a.extend(b.prototype, {
        createIndicator: function(b) {
          ...
          return (
            this.options.thumbnailIndicators &&
              ((d = b.getElementsByTagName && a(b).find('img')[0]),
              d ? (c = d.src) : g && (c = this.getItemProperty(b, g)),
              c && (e.style.backgroundImage = 'url("' + c + '")')),
            f && (e.title = f),
            e
          );
        },
        ...
        setActiveIndicator: function(b) {
          this.indicators &&
            ...
            (this.activeIndicator = a(this.indicators[b])),
      ...
      a.extend(b.prototype, {
        ...
        videoFactory: function(b, c, d) {
          ...
          if ((m.addClass(k.videoContentClass), r && (l.title = r), o.canPlayType))
            if (p && q && o.canPlayType(q)) o.src = p;
              ...
              for (; t && t.length; )
                if (
                  ((f = t.shift()),
                  (p = this.getItemProperty(f, k.urlProperty)),
                  (q = this.getItemProperty(f, k.typeProperty)),
                  p && q && o.canPlayType(q))
                ) {
                  o.src = p;
                  break;
          ...
          return (
            s &&
              ((o.poster = s),
              (e = this.imagePrototype.cloneNode(!1)),
              a(e).addClass(k.toggleClass),
              (e.src = s),
              (e.draggable = !1),
              l.appendChild(e)),
              ...
              (d || a(o))
                ...
                .on('playing', function() {
                  (h = !1),
                    ...
                    j.container.hasClass(j.options.controlsClass)
                      ? ((i = !0), j.container.removeClass(j.options.controlsClass))
                      : (i = !1);
                })
                .on('play', function() {
  ...
  (function(a) {
    'use strict';
    'function' == typeof define && define.amd
      ? define(['./blueimp-helper', './blueimp-gallery-video'], a)
      : a(window.blueimp.helper || window.jQuery, window.blueimp.Gallery);
  })(function(a, b) {
    'use strict';
      ...
      a.extend(d.prototype, {
        ...
        play: function() {
          ...
          this.playStatus || (this.listeners.play(), (this.playStatus = 1)),
            this.ready
              ? !this.hasPlayed &&
                (this.clickToPlay || (window.navigator && /iP(hone|od|ad)/.test(window.navigator.platform)))
                ? this.onPlaying()
        ...
        pause: function() {
          this.ready
            ...
            : this.playStatus && (delete this.playOnReady, this.listeners.pause(), delete this.playStatus);
        }
      }),
      a.extend(b.prototype, {
        VimeoPlayer: d,
        textFactory: function(a, b) {
          ...
          return g
            ? (void 0 === this.getItemProperty(a, f.urlProperty) && (a[f.urlProperty] = '//vimeo.com/' + g),
              (e += 1),
              this.videoFactory(a, b, new d(f.vimeoPlayerUrl, g, f.vimeoPlayerIdPrefix + e, f.vimeoClickToPlay)))
            : c.call(this, a, b);
        }
      }),
      b
  ...
  (function(a) {
    ...
    return (
      a.extend(d.prototype, {
        ...
        checkSeek: function() {
          (this.stateChange === YT.PlayerState.PAUSED || this.stateChange === YT.PlayerState.ENDED) &&
            (this.listeners.pause(), delete this.playStatus);
        },
      ...
      a.extend(b.prototype, {
        ...
        textFactory: function(a, b) {
          ...
          return f
            ? (void 0 === this.getItemProperty(a, e.urlProperty) &&
                (a[e.urlProperty] = '//www.youtube.com/watch?v=' + f),
              void 0 === this.getItemProperty(a, e.videoPosterProperty) &&
                (a[e.videoPosterProperty] = '//img.youtube.com/vi/' + f + '/maxresdefault.jpg'),
  ...
  (function(a) {
    'use strict';
    'function' == typeof define && define.amd
      ? define(['jquery', './blueimp-gallery'], a)
      : a(window.jQuery, window.blueimp.Gallery);
  })(function(a, b) {
    'use strict';
