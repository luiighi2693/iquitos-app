        ...
        function(t, e, a) {
          ...
          function y(t) {
            var e,
              ...
              o = t[2] / 100;
            return (
              (a = (2 - n) * o), (e = n * o), (e /= 1 >= a ? a : 2 - a), (e = e || 0), (a /= 2), [i, 100 * e, 100 * a]
            );
          }
          function k(t) {
            return o(x(t));
        ...
        function(t, e, a) {
          ...
          e.exports = function(t) {
            t.Radar = function(e, a) {
              return (
                (a.options = t.helpers.configMerge({ aspectRatio: 1 }, a.options)), (a.type = 'radar'), new t(e, a)
              );
            };
          };
        },
              ...
              (t.controllers.bubble = t.DatasetController.extend({
                ...
                setHoverStyle: function(a) {
                  ...
                  l.radius = r.hoverRadius
                    ? r.hoverRadius
                    : e.getValueAtIndexOrDefault(n.hoverRadius, o, i.chart.options.elements.point.hoverRadius) +
            ...
            (t.defaults.line = {
              ...
              (t.controllers.line = t.DatasetController.extend({
                ...
                draw: function(t) {
                  ...
                  for (
                    e(n.getDataset(), n.chart.options) && o.dataset.transition(l).draw(), a = 0, i = r.length;
                    i > a;
                    ++a
                  )
                    r[a].draw();
                ...
                setHoverStyle: function(t) {
                  ...
                  (o.radius =
                    n.hoverRadius ||
                    a.getValueAtIndexOrDefault(e.pointHoverRadius, i, this.chart.options.elements.point.hoverRadius)),
                    (o.backgroundColor =
                      n.hoverBackgroundColor ||
                      a.getValueAtIndexOrDefault(e.pointHoverBackgroundColor, i, a.getHoverColor(o.backgroundColor))),
                    (o.borderColor =
                      n.hoverBorderColor ||
                      a.getValueAtIndexOrDefault(e.pointHoverBorderColor, i, a.getHoverColor(o.borderColor))),
                    (o.borderWidth =
                      n.hoverBorderWidth || a.getValueAtIndexOrDefault(e.pointHoverBorderWidth, i, o.borderWidth));
                },
                removeHoverStyle: function(t) {
                  var e = this,
                  ...
                  void 0 !== i.radius && void 0 === i.pointRadius && (i.pointRadius = i.radius),
                    (r.radius =
                      o.radius || a.getValueAtIndexOrDefault(i.pointRadius, n, e.chart.options.elements.point.radius)),
              ...
              e.extend(t.Controller.prototype, {
                ...
                initToolTip: function() {
                  ...
                  e.tooltip = new t.Tooltip(
                    { _chart: e.chart, _chartInstance: e, _data: e.data, _options: e.options.tooltips },
                    e
                  );
                },
                bindEvents: function() {
        ...
        function(t, e, a) {
          ...
          e.exports = function(t) {
            function e(t, e, a) {
              ...
              return (
                'string' == typeof t
                  ? ((i = parseInt(t, 10)), -1 != t.indexOf('%') && (i = (i / 100) * e.parentNode[a]))
                  : (i = t),
                i
              );
            }
            ...
            (o.each = function(t, e, a, i) {
              ...
              (o.niceNum = function(t, e) {
                var a,
                  ...
                  n = t / Math.pow(10, i);
                return (
                  (a = e ? (1.5 > n ? 1 : 3 > n ? 2 : 7 > n ? 5 : 10) : 1 >= n ? 1 : 2 >= n ? 2 : 5 >= n ? 5 : 10),
                  a * Math.pow(10, i)
                );
              });
          ...
          e.exports = function() {
            var t = function(e, a) {
              ...
              return (
                ...
                (i.width =
                  e.canvas.width || parseInt(n.getStyle(e.canvas, 'width'), 10) || n.getMaximumWidth(e.canvas)),
                (i.height =
                  e.canvas.height || parseInt(n.getStyle(e.canvas, 'height'), 10) || n.getMaximumHeight(e.canvas)),
                ...
                draw: function() {
                  ...
                  if (i.display) {
                    ...
                    var b = n.boxWidth,
                      ...
                      k = a.isHorizontal();
                    d = k
                      ? { x: a.left + (l - s[0]) / 2, y: a.top + n.padding, line: 0 }
                    ...
                    e.each(a.legendItems, function(t, e) {
                      ...
                      k
                        ...
                        : c + S > a.bottom &&
                          ((r = d.x = r + a.columnWidths[d.line] + n.padding), (c = d.y = a.top), d.line++),
                        x(r, c, t),
                        (v[e].left = r),
                        (v[e].top = c),
                        y(r, c, t, i),
              ...
              t.plugins.register({
                beforeInit: function(e) {
                  var a = e.options,
                    i = a.legend;
                  i &&
                    ((e.legend = new t.Legend({ ctx: e.chart.ctx, options: i, chart: e })),
            ...
            (t.defaults.scale = {
              ...
              (t.Scale = t.Element.extend({
                ...
                fit: function() {
                  ...
                  if (
                    (d
                      ? (i.width = a.isFullWidth() ? a.maxWidth - a.margins.left - a.margins.right : a.maxWidth)
                      : (i.width = s ? b : 0),
              ...
              t.plugins.register({
                beforeInit: function(e) {
                  var a = e.options,
                    i = a.title;
                  i &&
                    ((e.titleBlock = new t.Title({ ctx: e.chart.ctx, options: i, chart: e })),
                  ...
                  buildTicks: function(i) {
                    ...
                    if (
                      ...
                      for (var p = 0, m = a.units[p]; p < a.units.length; ) {
                        if (
                          ((n.unitScale = 1), e.isArray(m.steps) && Math.ceil(n.scaleSizeInUnits / g) < e.max(m.steps))
                        ) {
