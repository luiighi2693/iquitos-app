d3 = (function() {
    ...
    return (
      (t.on = function(t, u) {
        ...
        return arguments.length < 2
          ? o && o.on
          : (o && ((o.on = null), (e = e.slice(0, (i = e.indexOf(o))).concat(e.slice(i + 1))), r.remove(t)),
  ...
  function b(n) {
    ...
    return function(e, r) {
      ...
      r
        ? ((t.lastIndex = 0), t.test(u) || e.setAttribute('class', y(u + ' ' + n)))
        : e.setAttribute('class', y(u.replace(t, ' ')));
    };
  }
  function _(n, t, e) {
    function r() {
  ...
  function H(n, t) {
    ...
    if (e.createSVGPoint) {
      ...
      return (
        $o ? ((r.x = t.pageX), (r.y = t.pageY)) : ((r.x = t.clientX), (r.y = t.clientY)),
  ...
  function Q(n, t, e) {
    ...
    return (
      ...
      (i = tt(i) * ha),
      ot(
        rt(3.2404542 * u - 1.5371385 * r - 0.4985314 * i),
        rt(-0.969266 * u + 1.8760108 * r + 0.041556 * i),
        rt(0.0556434 * u - 0.2040259 * r + 1.0572252 * i)
      )
    );
  }
  function nt(n, t, e) {
  ...
  function lt(n, t, e) {
    ...
    return (i = da.get(n))
      ...
      : (null != n &&
          '#' === n.charAt(0) &&
          (4 === n.length
            ? ((o = n.charAt(1)), (o += o), (a = n.charAt(2)), (a += a), (c = n.charAt(3)), (c += c))
            : 7 === n.length && ((o = n.substring(1, 3)), (a = n.substring(3, 5)), (c = n.substring(5, 7))),
          (o = parseInt(o, 16)),
          (a = parseInt(a, 16)),
          (c = parseInt(c, 16))),
        t(o, a, c));
  ...
  function ft(n, t, e) {
    ...
    var r = et((0.4124564 * n + 0.3575761 * t + 0.1804375 * e) / sa),
      u = et((0.2126729 * n + 0.7151522 * t + 0.072175 * e) / fa),
      i = et((0.0193339 * n + 0.119192 * t + 0.9503041 * e) / ha);
  ...
  function mt(n, t, e, r) {
    ...
    var i = {},
      ...
      l = null;
    return (
      !_o.XDomainRequest || 'withCredentials' in c || !/^(http(s)?:)?\/\//.test(n) || (c = new XDomainRequest()),
      'onload' in c
      ...
      (i.header = function(n, t) {
        return (
          (n = (n + '').toLowerCase()), arguments.length < 2 ? a[n] : (null == t ? delete a[n] : (a[n] = t + ''), i)
        );
      }),
  ...
  function _t() {
    for (var n, t = va, e = 1 / 0; t; )
      t.flush ? (t = n ? (n.next = t.next) : (va = t.next)) : (t.time < e && (e = t.time), (t = (n = t).next));
    return (ma = n), e;
  }
  function wt(n, t) {
  ...
  function It() {
    function n(n, u) {
      ...
      var i = Math.cos((u *= Qo)),
        ...
        c = Math.sin(u),
        l = Math.atan2(
          Math.sqrt((l = e * c - r * a) * l + (l = r * o - t * c) * l + (l = t * a - e * o) * l),
          t * o + e * a + r * c
        );
      ...
      (n.forEach(function(n) {
        if (!((t = n.length - 1) <= 0)) {
          ...
          (c.other = l),
            i.push(c),
            o.push(l),
            (c = { point: r, points: [r], other: null, visited: !1, entry: !1, subject: !0 }),
            (l = { point: r, points: [r], other: c, visited: !1, entry: !0, subject: !1 }),
            (c.other = l),
            i.push(c),
            o.push(l);
        }
      ...
      var g,
        ...
        y = {
          ...
          polygonEnd: function() {
            ...
            var n = Kt(m, p);
            g.length ? Xt(g, Gt, n, e, i) : n && (i.lineStart(), e(null, null, 1, i), i.lineEnd()),
              i.polygonEnd(),
              (g = p = null);
          },
          sphere: function() {
      ...
      if (s)
        for (var f = l[0], h = f[0], g = f[1] / 2 + Bo / 4, p = Math.sin(g), d = Math.cos(g), v = 1; ; ) {
          ...
          var m = n[0],
            ...
            w = p * M;
          if (
            (La.add(Math.atan2(w * Math.sin(b), d * x + w * Math.cos(b))),
            (i += _ ? b + (b >= 0 ? 2 : -2) * Bo : b),
            _ ^ (h >= e) ^ (m >= e))
          ) {
            var S = jt(Ct(f), Ct(n));
  ...
  function ne(n, t, e, r) {
    var u,
      i,
      o = Math.sin(n - e);
    return Math.abs(o) > Go
      ? Math.atan(
          (Math.sin(t) * (i = Math.cos(r)) * Math.sin(e) - Math.sin(r) * (u = Math.cos(t)) * Math.sin(n)) / (u * i * o)
        )
      : (t + r) / 2;
  }
  function te(n, t, e, r) {
    ...
    function e(n) {
      ...
      return {
        ...
        point: function(f, h) {
          ...
          if (
            (!e && (l = c = d) && n.lineStart(),
            d !== c && ((g = r(e, p)), (Ot(e, g) || Ot(p, g)) && ((p[0] += Go), (p[1] += Go), (d = t(p[0], p[1])))),
            d !== c)
          )
            (s = 0),
              d
    ...
    function r(n, t, e) {
      ...
      if (!(0 > M)) {
        ...
        if (
          ...
          T
            ? N
              ? (E + k > 0) ^ (b[1] < (Math.abs(b[0] - w) < Go ? E : k))
              : E <= b[1] && b[1] <= k
            : (A > Bo) ^ (w <= b[0] && b[0] <= S))
        ) {
          var q = Ht(v, (-m + x) / y);
  ...
  function re(n, t, e, r) {
    ...
    function a(u, i) {
      var o = i[0] - u[0],
        a = i[1] - u[1],
        c = [0, 1];
      return Math.abs(o) < Go && Math.abs(a) < Go
        ? n <= u[0] && u[0] <= e && t <= u[1] && u[1] <= r
        : ue(n - u[0], o, c) && ue(u[0] - e, -o, c) && ue(t - u[1], a, c) && ue(u[1] - r, -a, c)
          ? (c[1] < 1 && ((i[0] = u[0] + c[1] * o), (i[1] = u[1] + c[1] * a)),
            c[0] > 0 && ((u[0] += c[0] * o), (u[1] += c[0] * a)),
            !0)
          : !1;
    }
    return function(c) {
      ...
      function v(n, t) {
        ...
        if ((y && M.push([n, t]), k)) (x = n), (b = t), (_ = e), (k = !1), e && (c.lineStart(), c.point(n, t));
          ...
          var r = [w, S],
            u = [n, t];
          a(r, u)
            ? (E || (c.lineStart(), c.point(r[0], r[1])), c.point(u[0], u[1]), e || c.lineEnd(), (A = !1))
            : e && (c.lineStart(), c.point(n, t), (A = !1));
        }
        (w = n), (S = t), (E = e);
      }
      var m,
        ...
        q = {
          ...
          polygonEnd: function() {
            ...
            (e || u) &&
              (c.polygonStart(),
              e && (c.lineStart(), f(null, null, 1, c), c.lineEnd()),
              u && Xt(m, i, t, f, c),
              c.polygonEnd()),
              (m = y = M = null);
          }
    ...
    function e(t, i, o, a, c, l, s, f, h, g, p, d, v, m) {
      ...
      if (x > 4 * r && v--) {
        var b = a + g,
          ...
          z = T - i,
          C = M * q - y * z;
        ((C * C) / x > r || Math.abs((y * q + M * z) / x - 0.5) > 0.3 || u > a * g + c * p + l * d) &&
          (e(t, i, o, a, c, l, N, T, k, (b /= S), (_ /= S), w, v, m),
          m.point(N, T),
  ...
  function be(n) {
    ...
    return (
      ...
      (t.rotate = function(n) {
        return arguments.length
          ? ((m = (n[0] % 360) * Qo), (y = (n[1] % 360) * Qo), (M = n.length > 2 ? (n[2] % 360) * Qo : 0), r())
          : [m * na, y * na, M * na];
      }),
  ...
  function Te(n, t) {
    ...
    return function(u, i, o, a) {
      var c = o * t;
      null != u
        ? ((u = qe(e, u)), (i = qe(e, i)), (o > 0 ? i > u : u > i) && (u += o * Wo))
        : ((u = n + o * Wo), (i = n - 0.5 * c));
  ...
  function nr(n, t) {
    ...
    if (
      (e &&
        ((r += 'Q' + (i[0] - (2 * o[0]) / 3) + ',' + (i[1] - (2 * o[1]) / 3) + ',' + i[0] + ',' + i[1]),
        (u = n[1]),
        (c = 2)),
      t.length > 1)
    ) {
  ...
  function rr(n) {
    ...
    for (e.push(or(vc, i) + ',' + or(vc, o)), --r; ++r < u; )
      ...
      u = {
        bisect: function(n, t) {
          var e = { region: { l: n, r: t }, ep: { l: null, r: null } },
            ...
            o = u > 0 ? u : -u;
          return (
            (e.c = n.x * r + n.y * u + 0.5 * (r * r + u * u)),
            i > o ? ((e.a = 1), (e.b = u / r), (e.c /= r)) : ((e.b = 1), (e.a = r / u), (e.c /= u)),
            e
          );
        },
        ...
        rightOf: function(n, t) {
          ...
          if (1 === e.a) {
            ...
            if (
              ((!u && e.b < 0) || (u && e.b >= 0)
                ? (c = a = i >= e.b * o)
                : ((c = t.x + t.y * e.b > e.c), e.b < 0 && (c = !c), c || (a = 1)),
              !a)
            ) {
    ...
    for (var o, a, c, l, s, f, h, g, p, d, v, m, y, M = e.list.shift(); ; )
      if ((i.empty() || (o = i.min()), M && (i.empty() || M.y < o.y || (M.y == o.y && M.x < o.x))))
        (a = r.leftBound(M)),
          ...
          r.insert(a, f),
          (d = u.intersect(a, f)),
          d && (i.del(a), i.insert(a, d, u.distance(d, M))),
          (a = f),
  ...
  function Fr(n, t) {
    ...
    return (
      ...
      arguments.length ? (e = (t / Wo) * Math.asin(1 / n)) : ((n = 1), (e = t / 4)),
      function(r) {
  ...
  function Br(n, t) {
    ...
    return (
      a[0] != c[0] || a[1] != c[1]
        ? (r.push('translate(', null, ',', null, ')'), u.push({ i: 1, x: wr(a[0], c[0]) }, { i: 3, x: wr(a[1], c[1]) }))
        : c[0] || c[1]
          ? r.push('translate(' + c + ')')
          : r.push(''),
      l != s
        ? (l - s > 180 ? (s += 360) : s - l > 180 && (l += 360),
          u.push({ i: r.push(r.pop() + 'rotate(', null, ')') - 2, x: wr(l, s) }))
        : s && r.push(r.pop() + 'rotate(' + s + ')'),
      f != h
        ? u.push({ i: r.push(r.pop() + 'skewX(', null, ')') - 2, x: wr(f, h) })
        : h && r.push(r.pop() + 'skewX(' + h + ')'),
      g[0] != p[0] || g[1] != p[1]
        ? ((e = r.push(r.pop() + 'scale(', null, ',', null, ')')),
          u.push({ i: e - 4, x: wr(g[0], p[0]) }, { i: e - 2, x: wr(g[1], p[1]) }))
  ...
  function ui(n, t, e) {
    var r = -Math.floor(Math.log(ei(n, t)[2]) / Math.LN10 + 0.01);
    return mo.format(
      e
        ? e.replace(Aa, function(n, t, e, u, i, o, a, c, l, s) {
  ...
  function ci(n, t) {
    ...
    return (
      ...
      (e.rangePoints = function(u, i) {
        ...
        return (
          (o = r(n.length < 2 ? (c + l) / 2 : c + (s * i) / 2, s)), (a = 0), (t = { t: 'rangePoints', a: arguments }), e
        );
      }),
  ...
  function li(n, t) {
    ...
    return (
      ...
      (r.invertExtent = function(e) {
        return (
          (e = t.indexOf(e)), 0 > e ? [0 / 0, 0 / 0] : [e > 0 ? u[e - 1] : n[0], e < u.length ? u[e] : n[n.length - 1]]
        );
      }),
      (r.copy = function() {
        return li(n, t);
  ...
  function mi(n) {
    for (var t, e, r, u = -1, i = n.length; ++u < i; )
      (t = n[u]), (e = t[0]), (r = t[1] + Hc), (t[0] = e * Math.cos(r)), (t[1] = e * Math.sin(r));
    return n;
  }
  function yi(n) {
    function t(t) {
      ...
      for (
        ...
        o.call(this, (h = t[y]), y)
          ? (v.push([(g = +x.call(this, h, y)), (p = +b.call(this, h, y))]),
    ...
    return (
      ...
      (t.interpolate = function(n) {
        return arguments.length
          ? ((c = 'function' == typeof n ? (a = n) : (a = gc.get(n) || Xe).key),
            (l = a.reverse || a),
            (s = a.closed ? 'M' : 'L'),
            t)
          : c;
  ...
  function Ni(n, t, e, r) {
    ...
    if (!o) {
      var a = r.time;
      (o = i[e] = { tween: new u(), time: a, ease: r.ease, delay: r.delay, duration: r.duration }),
        ++i.count,
        mo.timer(
          function(r) {
            function u(r) {
            ...
            : 'w' in e && ('W' in e || 'U' in e)
              ? (i.setFullYear(e.y, 0, 1),
                i.setFullYear(
                  e.y,
                  0,
                  'W' in e ? ((e.w + 6) % 7) + 7 * e.W - ((i.getDay() + 5) % 7) : e.w + 7 * e.U - ((i.getDay() + 6) % 7)
                ))
  ...
  (mo.ascending = function(n, t) {
    ...
    (mo.median = function(t, e) {
      return (
        ...
        (t = t.filter(n)),
        t.length ? mo.quantile(t.sort(mo.ascending), 0.5) : void 0
      );
    }),
  ...
  (Ro.select = function(n) {
    ...
    for (var o = -1, a = this.length; ++o < a; ) {
      ...
      for (var c = -1, l = r.length; ++c < l; )
        (u = r[c])
          ? (t.push((e = n.call(u, u.__data__, c, o))), e && '__data__' in u && (e.__data__ = u.__data__))
          : t.push(null);
    }
    return p(i);
  }),
    ...
    (Ro.data = function(n, t) {
      function e(n, e) {
        ...
        if (t) {
          ...
          for (r = -1; ++r < f; )
            (v = t.call(e, (o = e[r]), r)),
              (i = m.get(v)) ? ((g[r] = i), (i.__data__ = o)) : y.has(v) || (p[r] = E(o)),
              y.set(v, o),
              m.remove(v);
    ...
    (Io.select = function(n) {
      for (var t, e, r, u, i, o = [], a = -1, c = this.length; ++a < c; ) {
        ...
        for (var l = -1, s = u.length; ++l < s; )
          (i = u[l])
            ? (t.push((r[l] = e = n.call(u.parentNode, i.__data__, l, a))), (e.__data__ = i.__data__))
            : t.push(null);
      }
      return p(o);
    }),
    ...
    (Ro.transition = function() {
      for (
        var n,
          ...
          e = Oc || ++Zc,
          r = [],
          u = Rc || { time: Date.now(), ease: Cr, delay: 0, duration: 250 },
          i = -1,
          o = this.length;
        ++i < o;
  ...
  (mo.interpolateZoom = function(n, t) {
    ...
    (mo.behavior.zoom = function() {
      ...
      function h() {
        ...
        y ? clearTimeout(y) : (z.call(this), o(n)),
          (y = setTimeout(function() {
            (y = null), c(n);
          }, 50)),
          f();
        var e = m || mo.mouse(this);
        v || (v = t(e)), r(Math.pow(2, 0.002 * ua()) * S.k), u(e, v), a(n);
      }
      function p() {
        v = null;
      }
    ...
    (mo.hcl = function(n, t, e) {
      return 1 === arguments.length
        ? n instanceof W
          ...
          : n instanceof K
            ? nt(n.l, n.a, n.b)
            : nt((n = ft((n = mo.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
        : B(+n, +t, +e);
    });
  ...
  (pa.brighter = function(n) {
    ...
    return t || e || r
      ? (t && u > t && (t = u),
        e && u > e && (e = u),
        r && u > r && (r = u),
        ot(Math.min(255, ~~(t / n)), Math.min(255, ~~(e / n)), Math.min(255, ~~(r / n))))
      : ot(u, u, u);
  }),
        ...
        (e.parseRows = function(n, t) {
          function e() {
            ...
            if (34 === n.charCodeAt(t)) {
              ...
              return (
                13 === r ? ((u = !0), 10 === n.charCodeAt(e + 2) && ++s) : 10 === r && (u = !0),
  ...
  (mo.formatPrefix = function(n, t) {
    ...
    (mo.format = function(n) {
      ...
      switch (
        (l && (l = +l.substring(1)),
        (o || ('0' === e && '=' === r)) && ((o = e = '0'), (r = '='), c && (a -= Math.floor((a - 1) / 4))),
        s)
      ) {
        case 'n':
          (c = !0), (s = 'g');
  ...
  if (Sa) {
    ...
    Ta = function(n) {
      for (var t = n.length, e = [], r = 0, u = Sa[0]; t > 0 && u > 0; )
        e.push(n.substring((t -= u), t + u)), (u = Sa[(r = (r + 1) % qa)]);
  ...
  (mo.geo.bounds = (function() {
      ...
      b = {
        ...
        polygonEnd: function() {
          Ha.polygonEnd(),
            ...
            (b.lineStart = e),
            (b.lineEnd = r),
            0 > La ? ((s = -(h = 180)), (f = -(g = 90))) : y > Go ? (g = 90) : -Go > y && (f = -90),
            (x[0] = s),
            (x[1] = h);
        }
      };
    ...
    (mo.geo.centroid = function(n) {
      ...
      var t = Va,
        ...
        u = t * t + e * e + r * r;
      return Ko > u &&
        ((t = Ia), (e = Ua), (r = Za), Go > Pa && ((t = Oa), (e = Ra), (r = Ya)), (u = t * t + e * e + r * r), Ko > u)
        ? [0 / 0, 0 / 0]
        : [Math.atan2(e, t) * na, O(r / Math.sqrt(u)) * na];
    });
  var Fa,
    Pa,
    Oa,
  ...
  (mo.geo.clipExtent = function() {
    var n,
      ...
      o = {
        ...
        extent: function(a) {
          return arguments.length
            ? ((i = re((n = +a[0][0]), (t = +a[0][1]), (e = +a[1][0]), (r = +a[1][1]))),
              u && ((u.valid = !1), (u = null)),
              o)
            : [[n, t], [e, r]];
        }
      ...
      return (
        ...
        (n.translate = function(t) {
          ...
          return (
            (e = i
              .translate(t)
              .clipExtent([[s - 0.455 * l, f - 0.238 * l], [s + 0.455 * l, f + 0.238 * l]])
              .stream(c).point),
            (r = o
              .translate([s - 0.307 * l, f + 0.201 * l])
              .clipExtent([[s - 0.425 * l + Go, f + 0.12 * l + Go], [s - 0.214 * l - Go, f + 0.234 * l - Go]])
              .stream(c).point),
            (u = a
              .translate([s - 0.205 * l, f + 0.212 * l])
              .clipExtent([[s - 0.214 * l + Go, f + 0.166 * l + Go], [s - 0.115 * l - Go, f + 0.234 * l - Go]])
              .stream(c).point),
            n
          );
        }),
  ...
  (mo.geo.transform = function(n) {
    ...
    (mo.geo.path = function() {
      ...
      return (
        ...
        (n.context = function(n) {
          return arguments.length
            ? ((i = null == (r = n) ? new se() : new ve(n)), 'function' != typeof a && i.pointRadius(a), t())
            : r;
        }),
    ...
    (mo.geo.rotation = function(n) {
      ...
      return (
        (n = Ee((n[0] % 360) * Qo, n[1] * Qo, n.length > 2 ? n[2] * Qo : 0)),
        (t.invert = function(t) {
    ...
    (mo.geo.graticule = function() {
      ...
      function t() {
        return mo
          .range(Math.ceil(i / v) * v, u, v)
          .map(h)
          .concat(mo.range(Math.ceil(l / m) * m, c, m).map(g))
          .concat(
            mo
      ...
      return (
        ...
        (n.precision = function(t) {
          return arguments.length
            ? ((y = +t), (s = ze(a, o, 90)), (f = Ce(r, e, y)), (h = ze(l, c, 90)), (g = Ce(i, u, y)), n)
            : y;
        }),
    ...
    (mc.clip = function(n) {
      for (var t, e, r, u, i, o, a = dr(n), c = -1, l = this.length - dr(this), s = this[l - 1]; ++c < l; ) {
        for (t = n.slice(), n.length = 0, u = this[c], i = t[(r = t.length - a) - 1], e = -1; ++e < r; )
          (o = t[e]),
            gr(o, s, u) ? (gr(i, s, u) || n.push(pr(i, o, s, u)), n.push(o)) : gr(i, s, u) && n.push(pr(i, o, s, u)),
            (i = o);
        a && n.push(n[0]), (s = u);
      }
      return n;
    ...
    (mo.geom.voronoi = function(n) {
      function t(n) {
        ...
        if (
          (vr(t, function(n) {
            var t, e, r, u, i, o;
            1 === n.a && n.b >= 0 ? ((t = n.ep.r), (e = n.ep.l)) : ((t = n.ep.l), (e = n.ep.r)),
              1 === n.a
                ? ((i = t ? t.y : -f), (r = n.c - n.b * i), (o = e ? e.y : f), (u = n.c - n.b * o))
                : ((r = t ? t.x : -f), (i = n.c - n.a * r), (u = e ? e.x : f), (o = n.c - n.a * u));
            var c = [r, i],
              l = [u, o];
  ...
  (mo.geom.quadtree = function(n, t, e, r, u) {
        ...
        if (!isNaN(e) && !isNaN(r))
          if (n.leaf) {
            var c = n.x,
              s = n.y;
            if (null != c)
              if (Math.abs(c - e) + Math.abs(s - r) < 0.01) l(n, t, e, r, u, i, o, a);
              else {
                var f = n.point;
    ...
    return (o = arguments.length)
      ? ((a = mr), (c = yr), 3 === o && ((u = e), (r = t), (e = t = 0)), i(n))
      : ((i.x = function(n) {
    ...
    (mo.layout.force = function() {
      ...
      return (
        (a.tick = function() {
          ...
          for (e = -1; ++e < b; )
            (a = v[e]),
              a.fixed
                ? ((a.x = a.px), (a.y = a.py))
                : ((a.x -= (a.px - (a.px = a.x)) * s), (a.y -= (a.py - (a.py = a.y)) * s));
        ...
        (a.alpha = function(n) {
          return arguments.length
            ? ((n = +n),
              r ? (r = n > 0 ? n : 0) : n > 0 && (c.start({ type: 'start', alpha: (r = n) }), mo.timer(a.tick)),
              a)
            : r;
        }),
        (a.start = function() {
          ...
          return (
            e ||
              (e = mo.behavior
                .drag()
                .origin(dt)
                .on('dragstart.force', nu)
                .on('drag.force', t)
                .on('dragend.force', tu)),
            arguments.length
              ? (this.on('mouseover.force', eu)
                  .on('mouseout.force', ru)
                  .call(e),
                void 0)
              : e
          );
          ...
          if (t) {
            for (
              ...
              (c = _u(c)),
                ...
                u > 0 && (qu(zu(a, n, r), n, u), (l += u), (s += u)),
                (f += a._tree.mod),
                (l += i._tree.mod),
                (h += c._tree.mod),
                (s += o._tree.mod);
            a && !wu(o) && ((o._tree.thread = a), (o._tree.mod += f - s)),
              i && !_u(c) && ((c._tree.thread = i), (c._tree.mod += l - h), (r = n));
          }
          return r;
        }
    ...
    (mo.layout.treemap = function() {
      ...
      return (
        ...
        (i.padding = function(n) {
          ...
          return (
            (f =
              null == (s = n) ? Vu : 'function' == (r = typeof n) ? t : 'number' === r ? ((n = [n, n, n, n]), e) : e),
            i
          );
        }),
        (i.round = function(n) {
  ...
  (mo.scale.pow = function() {
    ...
    (mo.scale.sqrt = function() {
      return mo.scale.pow().exponent(0.5);
    }),
        ...
        return c >= Fc
          ...
          : n
            ? 'M' +
              ...
              n * f +
              'Z'
            : 'M' + i * s + ',' + i * f + 'A' + i + ',' + i + ' 0 ' + l + ',1 ' + i * h + ',' + i * g + 'L0,0' + 'Z';
      }
      var t = gi,
        e = pi,
        r = di,
    ...
    (mo.svg.chord = function() {
      function n(n, a) {
        ...
        return (
          ...
          (e(c, l)
            ? u(c.r, c.p1, c.r, c.p0)
            : u(c.r, c.p1, l.r, l.p0) + r(l.r, l.p1, l.a1 - l.a0) + u(l.r, l.p1, c.r, c.p0)) +
          'Z'
        );
      }
      function t(n, t, e, r) {
  ...
  (Uc.call = Ro.call),
    ...
    (Uc.select = function(n) {
      ...
      for (var o = -1, a = this.length; ++o < a; ) {
        ...
        for (var c = this[o], l = -1, s = c.length; ++l < s; )
          (r = c[l]) && (e = n.call(r, r.__data__, l, o))
            ? ('__data__' in r && (e.__data__ = r.__data__), Ni(e, l, u, r.__transition__[u]), t.push(e))
            : t.push(null);
      }
      return Ei(i, u);
    }),
    ...
    (Uc.ease = function(n) {
      ...
      return arguments.length < 1
        ...
        : ('function' != typeof n && (n = mo.ease.apply(mo, arguments)),
          N(this, function(e) {
  ...
  var Vc = 'bottom',
    Xc = { top: 1, right: 1, bottom: 1, left: 1 };
    ...
    function n(i) {
      i.each(function() {
        ...
        var s,
          f = mo.transition(i),
          h = mo.transition(o);
        c && ((s = Bu(c)), h.attr('x', s[0]).attr('width', s[1] - s[0]), e(f)),
          l && ((s = Bu(l)), h.attr('y', s[0]).attr('height', s[1] - s[0]), r(f)),
          t(f);
      });
    }
    function t(n) {
    ...
    function u() {
      ...
      function m(n, t, e) {
        ...
        return (
          ...
          N
            ? (u = (r += f) + v)
            : (M && (f = Math.max(c, Math.min(l, 2 * M[e] - r))), r > f ? ((u = r), (r = f)) : (u = f)),
          g[0] != r || g[1] != u ? (e ? (o = null) : (i = null), (g[0] = r), (g[1] = u), !0) : void 0
        );
      }
      function y() {
        v(),
