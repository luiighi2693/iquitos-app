!(function(a) {
  ...
  function e(b) {
    var c = this;
    (c.d3 = a.d3 ? a.d3 : 'undefined' != typeof require ? require('d3') : void 0),
      (c.api = b),
      ...
      m.each(function() {
        function m(a, c) {
          ...
          return '[object Array]' === Object.prototype.toString.call(i)
            ? i
            : ((!c || 0 >= c) && (c = X ? 95 : b.isCategory ? Math.ceil(F(G[1]) - F(G[0])) - 12 : 110), d(j, i + ''));
        }
        function n(a, b) {
          var c = U.h;
  ...
  var h,
    i,
    j,
    k = { version: '0.4.11-rc4' };
  (k.generate = function(a) {
    return new d(a);
  }),
    (k.chart = { fn: d.prototype, internal: { fn: e.prototype, axis: { fn: f.prototype } } }),
    (h = k.chart.fn),
    ...
    (i.initParams = function() {
      ...
      (a.clipId = 'c3-' + +new Date() + '-clip'),
        ...
        (a.dataTimeFormat = c.data_xLocaltime ? b.time.format : b.time.format.utc),
        ...
        (a.yOrient = c.axis_rotated ? (c.axis_y_inner ? 'top' : 'bottom') : c.axis_y_inner ? 'right' : 'left'),
        (a.y2Orient = c.axis_rotated ? (c.axis_y2_inner ? 'bottom' : 'top') : c.axis_y2_inner ? 'left' : 'right'),
        (a.subXOrient = c.axis_rotated ? 'left' : 'bottom'),
        (a.isLegendRight = 'right' === c.legend_position),
        (a.isLegendInset = 'inset' === c.legend_position),
        (a.isLegendTop = 'top-left' === c.legend_inset_anchor || 'top-right' === c.legend_inset_anchor),
        (a.isLegendLeft = 'top-left' === c.legend_inset_anchor || 'bottom-left' === c.legend_inset_anchor),
        (a.legendStep = 0),
        (a.legendItemWidth = 0),
    ...
    (i.initWithData = function(a) {
      ...
      (d.axis = new f(d)),
        ...
        d.selectChart.empty() &&
          ((d.selectChart = e.select(document.createElement('div')).style('opacity', 0)),
          d.observeInserted(d.selectChart),
          (h = !1)),
        d.selectChart.html('').classed('c3', !0),
        (d.data.xs = {}),
        (d.data.targets = d.convertDataToTargets(a)),
        g.data_filter && (d.data.targets = d.data.targets.filter(g.data_filter)),
        g.data_hide && d.addHiddenTargetIds(g.data_hide === !0 ? d.mapToIds(d.data.targets) : g.data_hide),
        g.legend_hide && d.addHiddenLegendIds(g.legend_hide === !0 ? d.mapToIds(d.data.targets) : g.legend_hide),
        ...
        d.updateSvgSize(),
        (c = d.main = d.svg.append('g').attr('transform', d.getTranslate('main'))),
    ...
    (i.updateSizes = function() {
      ...
      (a.currentWidth = a.getCurrentWidth()),
        ...
        (a.width2 = b.axis_rotated ? a.margin.left - a.rotated_padding_left - a.rotated_padding_right : a.width),
        (a.height2 = b.axis_rotated ? a.height : a.currentHeight - a.margin2.top - a.margin2.bottom),
        ...
        a.hasType('gauge') && (a.arcHeight += a.height - a.getGaugeLabelHeight()),
        a.updateRadius && a.updateRadius(),
        a.isLegendRight && f && (a.margin3.left = a.arcWidth / 2 + 1.1 * a.radiusExpanded);
    }),
    ...
    (i.redraw = function(a, b) {
      ...
      if (
        ...
        m && K.legend_show ? H.updateLegend(H.mapToIds(H.data.targets), a, b) : o && H.updateDimension(!0),
        H.isCategorized() && 0 === P.length && H.x.domain([0, H.axes.x.selectAll('.tick').size()]),
        P.length
          ? (H.updateXDomain(P, i, j, k), K.axis_x_tick_values || (B = H.axis.updateXAxisTickValues(P)))
        ...
        !K.axis_y_tick_values &&
          K.axis_y_tick_count &&
          H.yAxis.tickValues(H.axis.generateTickValues(H.y.domain(), K.axis_y_tick_count)),
        !K.axis_y2_tick_values &&
          K.axis_y2_tick_count &&
          H.y2Axis.tickValues(H.axis.generateTickValues(H.y2.domain(), K.axis_y2_tick_count)),
        H.axis.redraw(b, O),
      ...
      (q = H.generateDrawArea ? H.generateDrawArea(L, !1) : void 0),
        ...
        c && (H.subY.domain(H.getYDomain(P, 'y')), H.subY2.domain(H.getYDomain(P, 'y2'))),
        H.updateXgridFocus(),
        ...
        I.selectAll('.' + l.selectedCircles)
          ...
          .selectAll('circle')
          .remove(),
        K.interaction_enabled && !a.flow && n && (H.redrawEventRect(), H.updateZoom && H.updateZoom()),
        H.updateCircleY(),
    ...
    (i.updateAndRedraw = function(a) {
      ...
      (a = a || {}),
        ...
        (a.withTransitionForTransform = w(a, 'withTransitionForTransform', a.withTransition)),
        c.updateSizes(),
        (a.withLegend && d.legend_show) ||
          ((b = c.axis.generateTransitions(a.withTransitionForAxis ? d.transition_duration : 0)),
          c.updateScales(),
          c.updateSvgSize(),
    ...
    (i.xv = function(a) {
      ...
      return (
        b.isTimeSeries()
          ...
          : b.isCategorized() && 'string' == typeof a.value && (c = b.config.axis_x_categories.indexOf(a.value)),
        Math.ceil(b.x(c))
      );
    }),
    (i.yv = function(a) {
    ...
    (i.transformMain = function(a, b) {
      var c,
        ...
        e,
        f = this;
      b && b.axisX ? (c = b.axisX) : ((c = f.main.select('.' + l.axisX)), a && (c = c.transition())),
        b && b.axisY ? (d = b.axisY) : ((d = f.main.select('.' + l.axisY)), a && (d = d.transition())),
        b && b.axisY2 ? (e = b.axisY2) : ((e = f.main.select('.' + l.axisY2)), a && (e = e.transition())),
        (a ? f.main.transition() : f.main).attr('transform', f.getTranslate('main')),
        c.attr('transform', f.getTranslate('x')),
        d.attr('transform', f.getTranslate('y')),
        e.attr('transform', f.getTranslate('y2')),
        f.main.select('.' + l.chartArcs).attr('transform', f.getTranslate('arc'));
    }),
    ...
    (i.bindResize = function() {
      ...
      if (
        ...
        var d = a.onresize;
        d ? (d.add && d.remove) || ((d = b.generateResize()), d.add(a.onresize)) : (d = b.generateResize()),
    ...
    (i.parseDate = function(b) {
      ...
      return (
        ...
        (!c || isNaN(+c)) && a.console.error("Failed to parse x '" + b + "' to Date object"),
        c
      );
    }),
    ...
    (i.updateScales = function() {
      ...
      (a.xMin = b.axis_rotated ? 1 : 0),
        ...
        (a.x = a.getX(a.xMin, a.xMax, c ? void 0 : a.x.orgDomain(), function() {
        ...
        (a.subY = a.getY(a.subYMin, a.subYMax, c ? b.axis_y_default : a.subY.domain())),
        (a.subY2 = a.getY(a.subYMin, a.subYMax, c ? b.axis_y2_default : a.subY2.domain())),
        ...
        (a.xAxis = a.axis.getXAxis(a.x, a.xOrient, a.xAxisTickFormat, a.xAxisTickValues, b.axis_x_tick_outer)),
        (a.subXAxis = a.axis.getXAxis(a.subX, a.subXOrient, a.xAxisTickFormat, a.xAxisTickValues, b.axis_x_tick_outer)),
        (a.yAxis = a.axis.getYAxis(a.y, a.yOrient, b.axis_y_tick_format, a.yAxisTickValues, b.axis_y_tick_outer)),
        (a.y2Axis = a.axis.getYAxis(a.y2, a.y2Orient, b.axis_y2_tick_format, a.y2AxisTickValues, b.axis_y2_tick_outer)),
        c || (a.brush && a.brush.scale(a.subX), b.zoom_enabled && a.zoom.scale(a.x)),
      ...
      return (
        ...
        0 === s.length
          ...
          : (isNaN(x) && (x = 0),
            ...
            (e = Math.abs(y - x)),
            (f = g = h = 0.1 * e),
            'undefined' != typeof z && ((i = Math.max(Math.abs(x), Math.abs(y))), (y = z + i), (x = z - i)),
            C
    ...
    (i.getXDomainPadding = function(a) {
      ...
      return (
        ...
        'object' == typeof g.axis_x_padding && v(g.axis_x_padding)
          ...
          : (d = e = 'number' == typeof g.axis_x_padding ? g.axis_x_padding : c),
        { left: d, right: e }
      );
    }),
    (i.getXDomain = function(a) {
      ...
      return (
        d - e !== 0 ||
          b.isCategorized() ||
          (b.isTimeSeries()
            ? ((d = new Date(0.5 * d.getTime())), (e = new Date(1.5 * e.getTime())))
            : ((d = 0 === d ? 1 : 0.5 * d), (e = 0 === e ? -1 : 1.5 * e))),
        (d || 0 === d) && (g = b.isTimeSeries() ? new Date(d.getTime() - f.left) : d - f.left),
        (e || 0 === e) && (h = b.isTimeSeries() ? new Date(e.getTime() + f.right) : e + f.right),
        [g, h]
      );
    }),
    (i.updateXDomain = function(a, b, c, d, e) {
      ...
      return (
        ...
        b &&
          (f.x.domain(e ? e : !f.brush || f.brush.empty() ? f.orgXDomain : f.brush.extent()),
          g.zoom_enabled && f.zoom.scale(f.x).updateScaleExtent()),
    ...
    (i.convertValuesToStep = function(a) {
      ...
      return (
        ...
        (c[a.length + 1] = { x: c[a.length].x + 1, value: c[a.length].value, id: c[a.length].id }),
        c
      );
    }),
    ...
    (i.convertJsonToData = function(a, b) {
      ...
      return (
        b
          ? (b.x ? ((c = b.value.concat(b.x)), (e.config.data_x = b.x)) : (c = b.value),
            f.push(c),
            a.forEach(function(a) {
              var b = [];
          ...
          d.isCustomX() || d.isTimeSeries()
            ? g.indexOf(f) >= 0
              ...
              : e.data_x
                ...
                : v(e.data_xs) && (d.data.xs[c] = d.getXValuesOfXKey(f, d.data.targets))
              ...
              .map(function(a, g) {
                ...
                return (
                  d.isCustomX() &&
                    ...
                    0 === c &&
                    i &&
                    (0 === g && (e.axis_x_categories = []), e.axis_x_categories.push(i)),
    ...
    (i.load = function(a, b) {
      ...
      a &&
        ...
        c.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0, withLegend: !0 }),
        b.done && b.done();
    }),
        ...
        a && 0 !== a.length
          ? (c.svg
            ...
            void a.forEach(function(a) {
              (c.withoutFadeIn[a] = !1),
                c.legend && c.legend.selectAll('.' + l.legendItem + c.getTargetSelectorSuffix(a)).remove(),
    ...
    (i.redrawEventRect = function() {
      var a,
        ...
        f = c.main
          .select('.' + l.eventRects)
          .style('cursor', d.zoom_enabled ? (d.axis_rotated ? 'ns-resize' : 'ew-resize') : null)
      ...
      f.selectAll('.' + l.eventRect).remove(),
        ...
        e
          ? ((a = c.eventRect.data([0])), c.generateEventRectsForMultipleXs(a.enter()), c.updateEventRect(a))
    ...
    (i.generateEventRectsForSingleX = function(a) {
      ...
      a.append('rect')
        ...
        .style('cursor', d.data_selection_enabled && d.data_selection_grouped ? 'pointer' : null)
        ...
        .on('mousemove', function(a) {
          ...
          b.dragging ||
            ...
            (!d.tooltip_grouped || (d.data_selection_enabled && !d.data_selection_grouped)) &&
              b.main
                .selectAll('.' + l.shape + '-' + f)
                .each(function() {
                  c.select(this).classed(l.EXPANDED, !0),
                    d.data_selection_enabled && g.style('cursor', d.data_selection_grouped ? 'pointer' : null),
                    d.tooltip_grouped ||
                      (b.hideXGridFocus(),
                      b.hideTooltip(),
                      d.data_selection_grouped || (b.unexpandCircles(f), b.unexpandBars(f)));
                })
                .filter(function(a) {
                ...
                .each(function(a) {
                  d.data_selection_enabled &&
                    (d.data_selection_grouped || d.data_selection_isselectable(a)) &&
                    g.style('cursor', 'pointer'),
                    d.tooltip_grouped ||
                      (b.showTooltip([a], this),
                      b.showXGridFocus([a]),
                      d.point_focus_expand_enabled && b.expandCircles(f, a.id, !0),
            ...
            b.isStepType(a) &&
              ...
              b.main.selectAll('.' + l.shape + '-' + e).each(function(a) {
                (d.data_selection_grouped || b.isWithinShape(this, a)) &&
                  (b.toggleShape(this, a, e), b.config.data_onclick.call(b.api, a, this));
              });
          }
        })
        .call(
          ...
          if (!c.dragging && !c.hasArcType(i)) {
            if (
              ...
              !c.mouseover ||
                ...
                (e.data_onmouseout.call(c.api, c.mouseover), (c.mouseover = void 0)),
              !f)
            )
              return void b();
            (g = c.isScatterType(f) || !e.tooltip_grouped ? [f] : c.filterByX(i, f.x)),
              (h = g.map(function(a) {
                return c.addName(a);
              })),
              c.showTooltip(h, this),
              e.point_focus_expand_enabled && c.expandCircles(f.index, f.id, !0),
              c.expandBars(f.index, f.id, !0),
              c.showXGridFocus(h),
              (c.isBarType(f.id) || c.dist(f, a) < e.point_sensitivity) &&
                (c.svg.select('.' + l.eventRect).style('cursor', 'pointer'),
                c.mouseover || (e.data_onmouseover.call(c.api, f), (c.mouseover = f)));
          }
        })
        .on('click', function() {
          var a,
              ...
              c.main
                ...
                .each(function() {
                  (e.data_selection_grouped || c.isWithinShape(this, b)) &&
                    (c.toggleShape(this, b, b.index), c.config.data_onclick.call(c.api, b, this));
                }));
        })
        .call(
          ...
          : 'y' !== a || c.axis_y_show
            ? 'y2' !== a || c.axis_y2_show
              ? ('x' === a &&
                  ...
                  (d = 30 + b.axis.getMaxTickWidth(a) * Math.cos((Math.PI * (90 - c.axis_x_tick_rotate)) / 180)),
                d + (b.axis.getLabelPositionById(a).isInner ? 0 : 10) + ('y2' === a ? -10 : 0))
    ...
    (i.getShapeIndices = function(a) {
      var b,
        ...
        g = 0;
      return (
        d.filterTargetsToShow(d.data.targets.filter(a, d)).forEach(function(a) {
      ...
      return (
        d.isTargetToShow(b.id)
          ? 'circle' === a.nodeName
            ...
            : 'path' === a.nodeName && (c = e.classed(l.bar) ? d.isWithinBar(a) : !0)
          : (c = !1),
        c
      );
    }),
    ...
    (i.updateTargetsForLine = function(a) {
      ...
      (b = d.main
        ...
        a.forEach(function(a) {
          d.main
            .selectAll('.' + l.selectedCircles + d.getTargetSelectorSuffix(a.id))
          ...
          return (
            c.isLineType(a)
              ? d.data_regions[a.id]
                ...
                : (c.isStepType(a) && (h = c.convertValuesToStep(h)), (f = e.interpolate(c.getInterpolate(a))(h)))
    ...
    (i.generateGetLinePoints = function(a, b) {
      ...
      return function(a, b) {
        var e = i.call(c, a.id)(0),
          ...
          l = g(a);
        return (
          d.axis_rotated && ((0 < a.value && e > l) || (a.value < 0 && l > e)) && (l = e),
          [[k, l - (e - j)], [k, l - (e - j)], [k, l - (e - j)], [k, l - (e - j)]]
        );
      };
    }),
      ...
      if (q(d))
        for (g = 0; g < d.length; g++)
          (z[g] = {}),
            p(d[g].start)
              ? (z[g].start = a[0].x)
              : (z[g].start = u.isTimeSeries() ? u.parseDate(d[g].start) : d[g].start),
            p(d[g].end)
              ? (z[g].end = a[a.length - 1].x)
              : (z[g].end = u.isTimeSeries() ? u.parseDate(d[g].end) : d[g].end);
      for (
        s = v.axis_rotated
          ? function(a) {
              return c(a.value);
          ...
          i = u.isTimeSeries()
            ? function(a, d, e, g) {
                ...
                return (
                  (h = v.axis_rotated
                    ? [[c(k(e)), b(l)], [c(k(e + g)), b(m)]]
                    : [[b(l), c(k(e))], [b(m), c(k(e + g))]]),
                  f(h)
                );
              }
            : function(a, d, e, g) {
                ...
                return (
                  (h = v.axis_rotated
                    ? [[c(k(e), !0), b(j(e))], [c(k(e + g), !0), b(j(e + g))]]
                    : [[b(j(e), !0), c(k(e))], [b(j(e + g), !0), c(k(e + g))]]),
                  f(h)
                );
              },
          g = 0;
    ...
    (i.generateDrawArea = function(a, b) {
      ...
      return (
        ...
        function(a) {
          ...
          return (
            c.isAreaType(a)
              ? (c.isStepType(a) && (f = c.convertValuesToStep(f)), (b = e.interpolate(c.getInterpolate(a))(f)))
              : (f[0] && ((g = c.x(f[0].x)), (h = c.getYScale(a.id)(f[0].value))),
    ...
    (i.redrawCircle = function(a, b, c) {
      ...
      return [
        (c ? this.mainCircle.transition(Math.random().toString()) : this.mainCircle)
          .style('opacity', this.opacityForCircle.bind(this))
          .style('fill', this.color)
          .attr('cx', a)
          .attr('cy', b),
        (c ? d.transition(Math.random().toString()) : d).attr('cx', a).attr('cy', b)
      ];
    }),
    ...
    (i.getCircles = function(a, b) {
      var c = this;
      return (b ? c.main.selectAll('.' + l.circles + c.getTargetSelectorSuffix(b)) : c.main).selectAll(
        '.' + l.circle + (m(a) ? '-' + a : '')
      );
    }),
    ...
    (i.getBars = function(a, b) {
      var c = this;
      return (b ? c.main.selectAll('.' + l.bars + c.getTargetSelectorSuffix(b)) : c.main).selectAll(
        '.' + l.bar + (m(a) ? '-' + a : '')
      );
    }),
    ...
    (i.generateGetBarPoints = function(a, b) {
      ...
      return function(a, b) {
        var d = j.call(c, a.id)(0),
          ...
          l = h(a);
        return (
          c.config.axis_rotated && ((0 < a.value && d > l) || (a.value < 0 && l > d)) && (l = d),
          [[k, e], [k, l - (d - e)], [k + f, l - (d - e)], [k + f, e]]
        );
      };
    }),
    ...
    (i.getXForText = function(a, b, c) {
      ...
      return (
        f.config.axis_rotated
          ? ((e = f.isBarType(b) ? 4 : 6), (d = a[2][1] + e * (b.value < 0 ? -1 : 1)))
          : (d = f.hasType('bar') ? (a[2][0] + a[0][0]) / 2 : a[0][0]),
        null === b.value && (d > f.width ? (d = f.width - g.width) : 0 > d && (d = 4)),
        d
      );
    }),
        ...
        e.config.axis_rotated
          ...
          : ((d = a[2][1]),
            b.value < 0 || (0 === b.value && !e.hasPositiveValue)
              ? ((d += f.height),
                e.isBarType(b) && e.isSafari() ? (d -= 3) : !e.isBarType(b) && e.isChrome() && (d += 3))
              : (d += e.isBarType(b) ? -3 : -6)),
        null !== b.value ||
          e.config.axis_rotated ||
          (d < f.height ? (d = f.height) : d > this.height && (d = this.height - 4)),
        d
      );
    }),
    ...
    (i.isLineType = function(a) {
      var b = this.config,
        c = o(a) ? a : a.id;
      return (
        !b.data_types[c] || ['line', 'spline', 'area', 'area-spline', 'step', 'area-step'].indexOf(b.data_types[c]) >= 0
      );
    }),
    ...
    (i.updateGrid = function(a) {
      ...
      e.grid.style('visibility', e.hasArcType() ? 'hidden' : 'visible'),
        ...
        e.ygridLines
          ...
          .transition()
          .duration(a)
          .attr('x', g.axis_rotated ? e.xGridTextX.bind(e) : e.yGridTextX.bind(e))
          .attr('y', d)
          .text(function(a) {
            return a.text;
          })
    ...
    (i.redrawGrid = function(a) {
      ...
      return [
        (a ? e.transition() : e)
          ...
          .style('opacity', 1),
        (a ? f.transition() : f)
          .attr('x', c.axis_rotated ? b.yGridTextX.bind(b) : b.xGridTextX.bind(b))
          .attr('y', d)
          .text(function(a) {
            return a.text;
          })
    ...
    (i.removeGridLines = function(a, b) {
      ...
      c.main
        ...
        .style('opacity', 0)
        .remove(),
        b ? (d.grid_x_lines = d.grid_x_lines.filter(f)) : (d.grid_y_lines = d.grid_y_lines.filter(f));
    }),
      ...
      if (
        ...
        if (b.isTimeSeries() && o(c.tooltip_init_x)) {
          for (
            ...
            a < b.data.targets[0].values.length && b.data.targets[0].values[a].x - c.tooltip_init_x !== 0;
            a++
          );
          c.tooltip_init_x = a;
        }
    ...
    (i.getTooltipContent = function(a, b, c, d) {
      ...
      if (0 === l.data_groups.length)
        ...
        a.sort(function(a, b) {
          return a.value > 0 && b.value > 0
            ? p
              ? q.indexOf(a.id) - q.indexOf(b.id)
              : q.indexOf(b.id) - q.indexOf(a.id)
            : p
              ? a.value - b.value
              : b.value - a.value;
        });
      ...
      for (f = 0; f < a.length; f++)
        if (
          ...
          (h = o(a[f].value, a[f].ratio, a[f].id, a[f].index)),
          void 0 !== h)
        ) {
          if (null === a[f].name) continue;
          (i = n(a[f].name, a[f].ratio, a[f].id, a[f].index)),
            (j = k.levelColor ? k.levelColor(a[f].value) : d(a[f].id)),
            (e += "<tr class='" + k.CLASS.tooltipName + '-' + k.getTargetSelectorSuffix(a[f].id) + "'>"),
            (e += "<td class='name'><span style='background-color:" + j + "'></span>" + i + '</td>'),
    ...
    (i.tooltipPosition = function(a, b, c, d) {
      ...
      return (
        m
          ? ((f = (j.width - (j.isLegendRight ? j.getLegendWidth() : 0)) / 2 + n[0]), (h = j.height / 2 + n[1] + 20))
          : ((e = j.getSvgLeft(!0)),
            k.axis_rotated
              ? ((f = e + n[0] + 100),
                (g = f + b),
    ...
    (i.showTooltip = function(a, b) {
      ...
      0 !== j.length &&
        g.tooltip_show &&
        (f.tooltip
          .html(g.tooltip_contents.call(f, a, f.axis.getXAxisTickFormat(), f.getYFormat(h), f.color))
          .style('display', 'block'),
    ...
    (i.initLegend = function() {
      ...
      return (
        ...
        (a.legend = a.svg.append('g').attr('transform', a.getTranslate('legend'))),
        a.config.legend_show
          ? void a.updateLegendWithDefaults()
          : (a.legend.style('visibility', 'hidden'), void (a.hiddenLegendIds = a.mapToIds(a.data.targets)))
      );
    }),
      ...
      var c = this,
        ...
        e = {
          top: c.isLegendTop
            ...
            : c.currentHeight - a - c.getCurrentPaddingBottom() - d.legend_inset_y,
          left: c.isLegendLeft
            ? c.getCurrentPaddingLeft() + d.legend_inset_x + 0.5
            : c.currentWidth - b - c.getCurrentPaddingRight() - d.legend_inset_x + 0.5
        };
      c.margin3 = {
    ...
    (i.getLegendHeight = function() {
      ...
      return (
        a.config.legend_show &&
          (b = a.isLegendRight ? a.currentHeight : Math.max(20, a.legendItemHeight) * (a.legendStep + 1)),
        b
      );
    }),
    ...
    (i.hideLegend = function(a) {
      var b = this,
        c = b.config;
      c.legend_show && u(a) && ((c.legend_show = !1), b.legend.style('visibility', 'hidden')),
    ...
    (i.updateLegend = function(a, b, c) {
      function d(a, b) {
        return (
          y.legendItemTextBox[b] || (y.legendItemTextBox[b] = y.getTextRect(a.textContent, l.legendItem, a)),
          y.legendItemTextBox[b]
        );
      }
      function e(b, c, e) {
        function f(a, b) {
          b || ((g = (o - G - n) / 2), E > g && ((g = (o - n) / 2), (G = 0), M++)),
            (L[a] = M),
      ...
      (a = a.filter(function(a) {
        ...
        y.isLegendInset && ((M = z.legend_inset_step ? z.legend_inset_step : a.length), y.updateLegendStep(M)),
        y.isLegendRight
          ? ((f = function(a) {
              return C * L[a];
            }),
        ...
        (p = y.legend
          ...
          .on('click', function(a) {
            z.legend_item_onclick
              ...
              : y.d3.event.altKey
                ...
                : (y.api.toggle(a), y.isTargetToShow(a) ? y.api.focus(a) : y.api.revert());
          })
          .on('mouseover', function(a) {
          ...
          .on('mouseout', function(a) {
            z.legend_item_onmouseout
              ...
              : (y.d3.select(this).classed(l.legendItemFocused, !1), y.api.revert());
          })),
        p
          .append('text')
          .text(function(a) {
        ...
        (r ? v.transition() : v)
          ...
          .attr('x2', n)
          .attr('y2', o),
        x && (r ? x.transition() : x).attr('height', y.getLegendHeight() - 12).attr('width', C * (M + 1) + 10),
        y.legend.selectAll('.' + l.legendItem).classed(l.legendItemHidden, function(a) {
    ...
    (i.xForTitle = function() {
      ...
      return (a =
        d.indexOf('right') >= 0
          ? b.currentWidth -
            b.getTextRect(b.title.node().textContent, b.CLASS.title, b.title.node()).width -
            c.title_padding.right
          : d.indexOf('center') >= 0
            ? (b.currentWidth - b.getTextRect(b.title.node().textContent, b.CLASS.title, b.title.node()).width) / 2
            : c.title_padding.left);
    }),
    (i.yForTitle = function() {
      var a = this;
      return (
        a.config.title_padding.top + a.getTextRect(a.title.node().textContent, a.CLASS.title, a.title.node()).height
      );
    }),
    ...
    (f.prototype.getXAxis = function(a, b, c, d, e, f, h) {
      ...
      return (
        ...
        i.isCategorized() &&
          (l.tickCentered(j.axis_x_tick_centered), u(j.axis_x_tick_culling) && (j.axis_x_tick_culling = !1)),
        l
      );
    }),
    (f.prototype.updateXAxisTickValues = function(a, b) {
      ...
      return (
        (e.axis_x_tick_fit || e.axis_x_tick_count) &&
          (c = this.generateTickValues(d.mapTargetsToUniqueXs(a), e.axis_x_tick_count, d.isTimeSeries())),
    ...
    (f.prototype.getYAxis = function(a, b, c, d, e, f) {
      var h = { withOuterTick: e, withoutTransition: f },
        ...
        l = g(j, h)
          ...
          .tickFormat(c);
      return (
        i.isTimeSeriesY() ? l.ticks(j.time[k.axis_y_tick_time_value], k.axis_y_tick_time_interval) : l.tickValues(d), l
      );
    }),
    ...
    (f.prototype.getLabelOptionByAxisId = function(a) {
      var b,
        ...
        d = c.config;
      return (
        'y' === a ? (b = d.axis_y_label) : 'y2' === a ? (b = d.axis_y2_label) : 'x' === a && (b = d.axis_x_label), b
      );
    }),
        ...
        : (h.svg &&
            ...
            'y' === a
              ? ((d = h.y.copy().domain(h.getYDomain(c, 'y'))),
                (e = this.getYAxis(d, h.yOrient, i.axis_y_tick_format, h.yAxisTickValues, !1, !0)))
              : 'y2' === a
                ? ((d = h.y2.copy().domain(h.getYDomain(c, 'y2'))),
                  (e = this.getYAxis(d, h.y2Orient, i.axis_y2_tick_format, h.y2AxisTickValues, !1, !0)))
                : ((d = h.x.copy().domain(h.getXDomain(c))),
                  (e = this.getXAxis(d, h.xOrient, h.xAxisTickFormat, h.xAxisTickValues, !1, !0, !0)),
    ...
    (i.updateRadius = function() {
      ...
      (a.radiusExpanded = Math.min(a.arcWidth, a.arcHeight) / 2),
        ...
        (a.innerRadius = a.hasType('donut') || a.hasType('gauge') ? a.radius * a.innerRadiusRatio : 0);
    }),
    ...
    (i.transformForArcLabel = function(a) {
      ...
      return (
        h &&
          ...
          (d = isNaN(b[1]) ? 0 : b[1]),
          (e = Math.sqrt(c * c + d * d)),
          (f = g.radius && e ? ((36 / g.radius > 0.375 ? 1.175 - 36 / g.radius : 0.8) * g.radius) / e : 0),
          (i = 'translate(' + c * f + ',' + d * f + ')')),
        i
      );
    }),
      ...
      return g.shouldShowArcLabel()
        ? ((b = g.updateAngle(a)),
          ...
          g.hasType('gauge') || g.meetsArcLabelThreshold(d)
            ? ((f = g.getArcLabelFormat()), f ? f(c, d, e) : g.defaultArcValueFormat(c, d))
            : '')
        : '';
    }),
    (i.expandArc = function(b) {
      ...
      return d.transiting
        ? void (c = a.setInterval(function() {
            d.transiting ||
              (a.clearInterval(c), d.legend.selectAll('.c3-legend-item-focused').size() > 0 && d.expandArc(b));
          }, 10))
        : ((b = d.mapToTargetIds(b)),
          void d.svg.selectAll(d.selectorTargets(b, '.' + l.chartArc)).each(function(a) {
    ...
    (i.shouldExpand = function(a) {
      var b = this,
        c = b.config;
      return (
        (b.isDonutType(a) && c.donut_expand) || (b.isGaugeType(a) && c.gauge_expand) || (b.isPieType(a) && c.pie_expand)
      );
    }),
    ...
    (i.redrawArc = function(a, b, c) {
      ...
      (d = h
        ...
        h.select('.' + l.chartArcsTitle).style('opacity', e.hasType('donut') || e.hasType('gauge') ? 1 : 0),
        e.hasType('gauge') &&
          ...
          e.arcs
            ...
            .attr('dx', -1 * (e.innerRadius + (e.radius - e.innerRadius) / 2) + 'px')
            .attr('dy', '1.2em')
    ...
    (i.toggleShape = function(a, b, c) {
      ...
      f.data_selection_enabled &&
        ...
        (f.data_selection_multiple ||
          d.main
            .selectAll('.' + l.shapes + (f.data_selection_grouped ? d.getTargetSelectorSuffix(b.id) : ''))
            .selectAll('.' + l.shape)
            .each(function(a, b) {
              var c = e.select(this);
    ...
    (i.updateTargetsForSubchart = function(a) {
      ...
      h.subchart_show &&
        ...
        g
          ...
          .attr(h.axis_rotated ? 'width' : 'height', h.axis_rotated ? f.width2 : f.height2));
    }),
    ...
    (i.redrawBarForSubchart = function(a, b, c) {
      (b ? this.contextBar.transition(Math.random().toString()).duration(c) : this.contextBar)
        .attr('d', a)
        .style('opacity', 1);
    }),
    ...
    (i.redrawLineForSubchart = function(a, b, c) {
      (b ? this.contextLine.transition(Math.random().toString()).duration(c) : this.contextLine)
        .attr('d', a)
        .style('opacity', 1);
    }),
    ...
    (i.redrawAreaForSubchart = function(a, b, c) {
      (b ? this.contextArea.transition(Math.random().toString()).duration(c) : this.contextArea)
        .attr('d', a)
        .style('fill', this.color)
        .style('opacity', this.orgAreaOpacity);
    }),
    (i.redrawSubchart = function(a, b, c, d, e, f, g) {
      ...
      k.context.style('visibility', m.subchart_show ? 'visible' : 'hidden'),
        m.subchart_show &&
          (l.event && 'zoom' === l.event.type && k.brush.extent(k.x.orgDomain()).update(),
          a &&
    ...
    (i.transformContext = function(a, b) {
      var c,
        d = this;
      b && b.axisSubX ? (c = b.axisSubX) : ((c = d.context.select('.' + l.axisX)), a && (c = c.transition())),
      ...
      (b.zoom = c.behavior
        ...
        .on('zoomstart', function() {
          (a = c.event.sourceEvent),
            (b.zoom.altDomain = c.event.sourceEvent.altKey ? b.x.orgDomain() : null),
        ...
        .on('zoomend', function() {
          ...
          (e && a.clientX === e.clientX && a.clientY === e.clientY) ||
            (b.redrawEventRect(), b.updateZoom(), d.zoom_onzoomend.call(b.api, b.x.orgDomain()));
        })),
      ...
      return function(a) {
        ...
        return (
          d[c] instanceof Function
            ...
            : d[c]
              ? (b = d[c])
              : (g.indexOf(c) < 0 && g.push(c), (b = e[g.indexOf(c) % e.length]), (d[c] = b)),
  ...
  (h.focus = function(a) {
    ...
    (h.show = function(a, b) {
      ...
      (a = d.mapToTargetIds(a)),
        ...
        d.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0, withLegend: !0 });
    }),
    (h.hide = function(a, b) {
      var c,
        d = this.internal;
    ...
    (h.zoom.range = function(a) {
      return arguments.length
        ? (q(a.max) && this.domain.max(a.max), void (q(a.min) && this.domain.min(a.min)))
    ...
    (h.load = function(a) {
      ...
      return (
        ...
        'categories' in a && b.isCategorized() && (c.axis_x_categories = a.categories),
        'axes' in a &&
        ...
        'cacheIds' in a && b.hasCaches(a.cacheIds)
          ...
          : void ('unload' in a
              ? b.unload(b.mapToTargetIds('boolean' == typeof a.unload && a.unload ? null : a.unload), function() {
                  b.loadFromArgs(a);
                })
              : b.loadFromArgs(a))
      );
    ...
    (h.unload = function(a) {
      var b = this.internal;
      (a = a || {}),
        a instanceof Array ? (a = { ids: a }) : 'string' == typeof a && (a = { ids: [a] }),
        ...
        j.data.targets.forEach(function(a) {
          ...
          for (c = 0; c < b.length; c++)
            if (a.id === b[c].id) {
              for (
                e = !0,
                  a.values[a.values.length - 1] && (o = a.values[a.values.length - 1].index + 1),
                  n = b[c].values.length,
                  d = 0;
                n > d;
                d++
        ...
        j.data.targets.length &&
          b.forEach(function(a) {
            ...
            for (b = j.data.targets[0].values[0].index; o > b; b++)
              c.push({ id: a.id, index: b, x: j.isTimeSeries() ? j.getOtherTargetX(b) : b, value: null });
            a.values.forEach(function(a) {
            ...
            : 1 !== b.data.targets[0].values.length
              ...
              : b.isTimeSeries()
                ? ((x = b.getValueOnIndex(b.data.targets[0].values, 0)),
                  (y = b.getValueOnIndex(b.data.targets[0].values, b.data.targets[0].values.length - 1)),
                  (e = b.x(x.x) - b.x(y.x)))
                : (e = t(g) / 2),
          (u = t(z) / t(g)),
        ...
        d.main
          ...
          .each(function(g, h) {
            ...
            i.classed(l.line) ||
              i.classed(l.area) ||
              (m && n
                ? f.data_selection_isselectable(g) && !o && k(!0, i.classed(l.SELECTED, !0), g, h)
      ...
      e.data_selection_enabled &&
        c.main
          ...
          .each(function(f, g) {
            ...
            h.classed(l.line) ||
              h.classed(l.area) ||
              (k && m && e.data_selection_isselectable(f) && n && j(!1, h.classed(l.SELECTED, !1), f, g));
          });
    }),
    ...
    (h.x = function(a) {
      ...
      return (
        arguments.length &&
          (b.updateTargetX(b.data.targets, a), b.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })),
        b.data.xs
      );
    }),
    (h.xs = function(a) {
      ...
      return (
        arguments.length &&
          (b.updateTargetXs(b.data.targets, a), b.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 })),
        b.data.xs
      );
    }),
    (h.axis = function() {}),
    ...
    (h.axis.max = function(a) {
      ...
      return arguments.length
        ? ('object' == typeof a
            ? (m(a.x) && (c.axis_x_max = a.x), m(a.y) && (c.axis_y_max = a.y), m(a.y2) && (c.axis_y2_max = a.y2))
    ...
    (h.axis.min = function(a) {
      ...
      return arguments.length
        ? ('object' == typeof a
            ? (m(a.x) && (c.axis_x_min = a.x), m(a.y) && (c.axis_y_min = a.y), m(a.y2) && (c.axis_y2_min = a.y2))
    ...
    (h.axis.range = function(a) {
      return arguments.length
        ? (q(a.max) && this.axis.max(a.max), void (q(a.min) && this.axis.min(a.min)))
    ...
    (h.tooltip.show = function(a) {
      ...
      a.mouse && (c = a.mouse),
        a.data
          ? d.isMultipleX()
            ? ((c = [d.x(a.data.x), d.getYScale(a.data.id)(a.data.value)]), (b = null))
