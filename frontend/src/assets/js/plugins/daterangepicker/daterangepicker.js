...
(function(root, factory) {
  ...
  var DateRangePicker = function(element, options, cb) {
    ...
    this.parentEl =
      typeof options === 'object' && options.parentEl && $(options.parentEl).length
        ? $(options.parentEl)
        : $(this.parentEl);
  ...
  DateRangePicker.prototype = {
    ...
    clickDate: function(e) {
      ...
      if (cal.hasClass('left')) {
        ...
        if (typeof this.dateLimit === 'object') {
          var minDate = moment(endDate)
            .subtract(this.dateLimit)
            .startOf('day');
    ...
    updateCalendars: function() {
      ...
      this.container
        .find('.calendar.left')
        .empty()
        .html(this.renderCalendar(this.leftCalendar.calendar, this.startDate, this.minDate, this.maxDate, 'left'));
      this.container
        .find('.calendar.right')
        .empty()
        .html(
