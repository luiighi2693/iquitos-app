    ...
    (function() {
      ...
      return (
        (o.prototype.addSteps = function(t) {
          var e, o, n;
          for (e = 0, o = t.length; e < o; e++) (n = t[e]), this.addStep(n);
          return this;
        }),
        ...
        (o.prototype.start = function(t) {
          ...
          return (
            ...
            null === this._current &&
              ((e = this._makePromise(null != this._options.onStart ? this._options.onStart(this) : void 0)),
        ...
        (o.prototype.end = function() {
          ...
          return (
            (o = (function(o) {
              return function(n) {
                if (
                  (t(e).off('click.tour-' + o._options.name),
                  t(e).off('keyup.tour-' + o._options.name),
                  o._setState('end', 'yes'),
                  (o._inited = !1),
                  (o._force = !1),
                  o._clearTimer(),
                  null != o._options.onEnd)
                )
                  return o._options.onEnd(o);
              };
            })(this)),
        ...
        (o.prototype.restart = function() {
          return (
            this._removeState('current_step'), this._removeState('end'), this._removeState('redirect_to'), this.start()
          );
        }),
        (o.prototype.pause = function() {
          var t;
          return (t = this.getStep(this._current)) && t.duration
            ? ((this._paused = !0),
        ...
        (o.prototype.hideStep = function(e, o) {
          ...
          if ((s = this.getStep(e)))
            return (
              this._clearTimer(),
              (r = this._makePromise(null != s.onHide ? s.onHide(this, e) : void 0)),
              (i = (function(n) {
                return function(i) {
                  var r, a;
                  if (
                    ((r = t(s.element)).data('bs.popover') || (r = t('body')),
                    r
                      .popover('dispose')
                      .removeClass(
                        'tour-' + n._options.name + '-element tour-' + n._options.name + '-' + e + '-element'
                      )
                      .removeData('bs.popover'),
                    s.reflex &&
                      t(s.reflexElement)
                        .removeClass('tour-step-element-reflex')
                        .off(n._reflexEvent(s.reflex) + '.tour-' + n._options.name),
                    s.backdrop &&
                      (((a = null != o && n.getStep(o)) && a.backdrop && a.backdropElement === s.backdropElement) ||
                        n._hideOverlayElement(s)),
                    null != s.onHidden)
                  )
                    return s.onHidden(n);
                };
              ...
              '[object Number]' === {}.toString.call(n) && n > 0
                ? (this._debug('Wait ' + n + ' milliseconds to hide the step ' + (this._current + 1)),
                  window.setTimeout(
                    (function(t) {
                      return function() {
        ...
        (o.prototype.showStep = function(t) {
          ...
          return this.ended()
            ...
            : (a = this.getStep(t)) &&
              ((s = t < this._current),
              (n = this._makePromise(null != a.onShow ? a.onShow(this, t) : void 0)),
              ...
              !a.redirect ||
                !this._isRedirect(a.host, o, e.location) ||
                (this._redirect(a, t, o), this._isJustPathHashDifferent(a.host, o, e.location)))
              ? ((r = (function(e) {
                  return function(o) {
                    if (e._isOrphan(a)) {
                      if (!1 === a.orphan)
                    ...
                    if ((a.autoscroll ? e._scrollIntoView(t) : e._showPopoverAndOverlay(t), a.duration))
                      return e.resume();
                  };
                })(this)),
                (i = a.delay.show || a.delay),
                '[object Number]' === {}.toString.call(i) && i > 0
                  ? (this._debug('Wait ' + i + ' milliseconds to show the step ' + (this._current + 1)),
                    window.setTimeout(
                      (function(t) {
                        return function() {
        ...
        (o.prototype._setState = function(t, e) {
          ...
          if (this._options.storage) {
            o = this._options.name + '_' + t;
            try {
              this._options.storage.setItem(o, e);
            } catch (t) {
              t.code === DOMException.QUOTA_EXCEEDED_ERR &&
                this._debug('LocalStorage quota exceeded. State storage failed.');
            }
            return this._options.afterSetState(o, e);
          }
        ...
        (o.prototype._getState = function(t) {
          ...
          return (
            this._options.storage
              ? ((e = this._options.name + '_' + t), (o = this._options.storage.getItem(e)))
        ...
        (o.prototype._isRedirect = function(t, e, o) {
          ...
          return (
            !(
              ...
              '' === t ||
              !(
                ('[object RegExp]' === {}.toString.call(t) && !t.test(o.origin)) ||
                ('[object String]' === {}.toString.call(t) && this._isHostDifferent(t, o))
              )
            ) ||
            ...
            null != e &&
              ...
              (('[object RegExp]' === {}.toString.call(e) && !e.test(n)) ||
                ('[object String]' === {}.toString.call(e) && this._isPathDifferent(e, n))))
          );
        }),
        ...
        (o.prototype._redirect = function(o, n, i) {
          var r;
          return t.isFunction(o.redirect)
            ? o.redirect.call(this, i)
            : ((r = '[object String]' === {}.toString.call(o.host) ? '' + o.host + i : i),
              this._debug('Redirect to ' + r),
              this._getState('redirect_to') !== '' + n
                ? (this._setState('redirect_to', '' + n), (e.location.href = r))
                : (this._debug('Error redirection loop to ' + i),
        ...
        (o.prototype._isOrphan = function(e) {
          return (
            null == e.element ||
            !t(e.element).length ||
            (t(e.element).is(':hidden') && 'http://www.w3.org/2000/svg' !== t(e.element)[0].namespaceURI)
          );
        }),
        ...
        (o.prototype._showPopoverAndOverlay = function(t) {
          var e;
          if (this.getCurrentStep() === t && !this.ended())
            return (
              (e = this.getStep(t)).backdrop && this._showOverlayElement(e),
              this._showPopover(e, t),
              null != e.onShown && e.onShown(this),
        ...
        (o.prototype._showPopover = function(e, o) {
          ...
          return (
            ...
            (n = t(e.element)).addClass(
              'tour-' + this._options.name + '-element tour-' + this._options.name + '-' + o + '-element'
            ),
            e.options && t.extend(r, e.options),
            e.reflex &&
              !i &&
              t(e.reflexElement)
                .addClass('tour-step-element-reflex')
                .off(this._reflexEvent(e.reflex) + '.tour-' + this._options.name)
                .on(
            ...
            n
              ...
              .popover('show'),
            t(n.data('bs.popover').getTipElement()).attr('id', e.id)
          );
        }),
        (o.prototype._template = function(e, o) {
          ...
          return (
            (h = e.template),
            this._isOrphan(e) && '[object Boolean]' !== {}.toString.call(e.orphan) && (h = e.orphan),
            (a = t(t.isFunction(h) ? h(o, e) : h)),
        ...
        (o.prototype._scrollIntoView = function(e) {
          var o, n, i, r, s, a, h, p;
          if (((h = this.getStep(e)), !(o = t(h.element)).length)) return this._showPopoverAndOverlay(e);
          switch (
            ((n = t(window)), (s = o.offset().top), (r = o.outerHeight()), (p = n.height()), (a = 0), h.placement)
          ) {
            case 'top':
              a = Math.max(0, s - p / 2);
              break;
            case 'left':
            case 'right':
              a = Math.max(0, s + r / 2 - p / 2);
              break;
            case 'bottom':
              a = Math.max(0, s + r - p / 2);
          }
          return (
            this._debug('Scroll into view. ScrollTop: ' + a + '. Element offset: ' + s + '. Window height: ' + p + '.'),
            (i = 0),
            t('body, html')
              .stop(!0, !0)
              .animate(
            ...
            t(e)
              ...
              .on(
                ...
                function(e) {
                  ...
                  return (
                    e.preventDefault(),
                    (n = t(this)).text(o._paused ? n.data('pause-text') : n.data('resume-text')),
        ...
        (o.prototype._showBackground = function(o, n) {
          var i, r, s, a, h, p, u, l, c;
          for (
            s = t(e).height(), c = t(e).width(), l = [], a = 0, h = (u = ['top', 'bottom', 'left', 'right']).length;
            a < h;
            a++
          )
            switch (
              ((p = u[a]),
              (i = null != (r = this.backdrops)[p] ? r[p] : (r[p] = t('<div>', { class: 'tour-backdrop ' + p }))),
              t(o.backdropContainer).append(i),
              p)
            ) {
              case 'top':
                l.push(
                  i
                    .height(n.offset.top > 0 ? n.offset.top : 0)
                    .width(c)
                    .offset({ top: 0, left: 0 })
                );
                break;
              case 'bottom':
                l.push(
                  i
                    .offset({ top: n.offset.top + n.height, left: 0 })
                    .height(s - (n.offset.top + n.height))
                    .width(c)
                );
                break;
              case 'left':
                l.push(
                  i
                    .offset({ top: n.offset.top, left: 0 })
                    .height(n.height)
                    .width(n.offset.left > 0 ? n.offset.left : 0)
                );
                break;
              case 'right':
                l.push(
                  i
                    .offset({ top: n.offset.top, left: n.offset.left + n.width })
                    .height(n.height)
                    .width(c - (n.offset.left + n.width))
                );
                break;
              default:
                l.push(void 0);
        ...
        (o.prototype._getParams = function(t, e) {
          ...
          for (s = {}, o = 0, n = (r = r[1].split('&')).length; o < n; o++)
            s[(i = (i = r[o]).split('='))[0]] = i[1] || '';
          return s;
        }),
        (o.prototype._equal = function(t, e) {
          ...
          if ('[object Object]' === {}.toString.call(t) && '[object Object]' === {}.toString.call(e)) {
            ...
            for (n in t) if (((a = t[n]), !this._equal(e[n], a))) return !1;
            return !0;
          }
          if ('[object Array]' === {}.toString.call(t) && '[object Array]' === {}.toString.call(e)) {
            if (t.length !== e.length) return !1;
            for (n = o = 0, i = t.length; o < i; n = ++o) if (((a = t[n]), !this._equal(a, e[n]))) return !1;
            return !0;
          }
          return t === e;
        }),
